...
!(function (t) {
  ...
  var a = function (e) {
    ...
    u = tinymce.util.Tools.resolve("tinymce.util.URI"),
          ...
          return (
            i.length &&
              (function f(e, t, n) {
                ...
                e: for (;;) {
                  if (
                    ((g[l.nodeName] || p[l.nodeName] || b(l)) && u++,
                    3 === l.nodeType &&
                      (!o && l.length + u >= c.end
                        ? ((o = l), (a = c.end - u))
                        : r && s.push(l),
                ...
                (function t(o) {
                  ...
                  return function (e) {
                    ...
                    for (
                      var l = m(o.data.substring(e.startNodeIndex), a),
                        d = 0,
            ...
            d.send({
              ...
              success: function (e) {
                ...
                if (t) t.error ? o(t.error) : r(t);
                  ...
                  var n = a.translate("Server response wasn't proper JSON.");
                  o(n);
                }
              },
              error: function () {
  ...
  function k(e, t, n) {
    e.dom.select("span.mce-spellchecker-word").length || y(e, t, n);
  }
  function N(e) {
  ...
  var y = function (e, t, n) {
      ...
      if (
        (v(e, n).reset(), e.selection.moveToBookmark(r), n.set(null), t.get())
      )
        return t.set(!1), o(e), !0;
    },
    ...
    w = {
      ...
      addToDictionary: function (t, e, n, r, o, i, a) {
        t.setProgressState(!0),
          x(
            ...
            i,
            function () {
              t.setProgressState(!1), t.dom.remove(a, !0), k(t, n, r);
            },
            function (e) {
              t.notificationManager.open({ text: e, type: "error" }),
                t.setProgressState(!1);
      ...
      ignoreWord: function (t, e, n, r, o, i) {
        t.selection.collapse(),
          i
            ? l.each(t.dom.select("span.mce-spellchecker-word"), function (e) {
    ...
    E = function (n, e, r, t, o, i) {
      ...
      var c = (function (e, t) {
          ...
          return (
            l.each(t, function (e) {
              n.push({ selectable: !0, text: e.name, data: e.value });
            }),
            n
          );
        })(
          0,
          (function (e) {
            return l.map(g(e).split(","), function (e) {
      ...
      1 < c.length
        ? n.ui.registry.addSplitButton("spellchecker", u)
        : n.ui.registry.addToggleButton("spellchecker", s),
        ...
        update: function (e) {
          ...
          if (0 < n.length) {
            ...
            return (
              ...
              (function (t, e, n, r, o, i, a, c) {
                var s = [],
                  u = n.get().suggestions[a];
                return (
                  l.each(u, function (e) {
                    s.push({
                      text: e,
                  ...
                  n.get().hasDictionarySupport &&
                    ...
                    s.push({
                      ...
                      onAction: function () {
                        w.addToDictionary(t, e, r, o, i, a, c);
                      },
                    })),
                  s.push.apply(s, [
                    { type: "separator" },
                    {
                      text: "Ignore",
                      onAction: function () {
                        w.ignoreWord(t, r, o, a, c);
                      },
                    },
                    {
                      text: "Ignore all",
                      onAction: function () {
                        w.ignoreWord(t, r, o, a, c, !0);
                      },
                    },
                  ]),
                  s
                );
              })(o, i, a, c, s, u, t.getAttribute("data-mce-word"), n)
            );
          }
        },
      });
