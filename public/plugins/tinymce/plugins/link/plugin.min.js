...
!(function (c) {
    ...
    var e,
      ...
      u = function (n) {
        return n.filter(function (n) {
          return -1 === Q.inArray(o, n);
        });
      },
      c = t ? (0 < (e = u((e = i))).length ? e.concat(o) : o) : u(i);
    return 0 < c.length ? ((r = c), Q.trim(r.sort().join(" "))) : "";
  }
  function L(n, t) {
    return (
    ...
    return o !== undefined
      ? (function (t, n) {
          return U(n, function (n) {
            return $.some(n).filter(function (n) {
              return n.value === t;
            });
          });
        })(o, e).map(function (n) {
          return {
            url: { value: n.value, meta: { text: i ? t : n.text, attach: u } },
            text: i ? t : n.text,
          };
        })
      : $.none();
  ...
  var K,
    ...
    $ = {
      ...
      none: t,
      from: function (n) {
        return null === n || n === undefined ? O : H(n);
      },
    },
    ...
    tn = function (o, i, u) {
      o.undoManager.transact(function () {
        var n = o.selection.getNode(),
          t = L(o, n),
          e = D(u);
        if (!(0 < v(o).length) && !1 === x(o)) {
          var r = F(e.rel, "_blank" === e.target);
          e.rel = r || null;
        }
        $.from(e.target).isNone() && (e.target = p(o)),
          (e.href = (function (n, t) {
            return ("http" !== t && "https" !== t) || j(n) ? n : t + "://" + n;
          })(e.href, d(o))),
          u.href === i.href && i.attach(),
          t
            ? (o.focus(),
              (function (n, t, e, r) {
                e.each(function (n) {
            ...
            : (function (t, n, e, r) {
                Y(n)
                  ...
                  : e.fold(
                      ...
                      function (n) {
                        t.insertContent(
                          t.dom.createHTML("a", r, t.dom.encode(n))
                        );
                      }
                    );
              })(o, n, u.text, e);
      ...
      return {
        onChange: function (n, t) {
          return "url" === t.name
            ...
            : N(["anchor", "link"], t.name)
            ? e(n(), t)
            : ("text" === t.name && o.set(n().text), $.none());
        },
      };
    },
    hn = function () {
  ...
  (K = undefined),
    ...
    (W = undefined),
    (function (n) {
      "object" == typeof B && void 0 !== V
        ? (V.exports = n())
        : "function" == typeof K && K.amd
        ? K([], n)
      ...
      return (function l(i, u, c) {
        ...
        for (var f = "function" == typeof W && W, n = 0; n < c.length; n++)
          a(c[n]);
        return a;
      })(
        {
  ...
  function wn(n, t, e) {
    ...
    return null !== r && 0 < r.length ? $.some(r) : $.none();
  }
  function xn(n, t) {
    return n.dom.getParent(t, "a[href]");
  }
  function kn(n) {
    return xn(n, n.selection.getStart());
  }
  function bn(n, t) {
    if (t) {
      var e = on(t);
  ...
  var _n = gn.exports.boltExport,
        ...
        function (e) {
          return Cn(function (t) {
            !(function (t, n, e) {
              ...
              Nn.setEditorTimeout(t, function () {
    ...
    In = function (n) {
      ...
      return 0 < e.length
        ? $.some([{ text: "None", value: "" }].concat(e))
        : $.none();
    },
    Sn = function (n) {
      var t = y(n);
      return 0 < t.length ? sn.sanitize(t) : $.none();
    },
    jn = tinymce.util.Tools.resolve("tinymce.util.XHR"),
    Fn = function (t) {
      function e(n) {
      ...
      return Cn(function (t) {
        ...
        return n.bind(sn.sanitizeWith(e)).map(function (n) {
    ...
    Ln = function (n, t) {
      ...
      if (0 < e.length) {
        var r = t.is("_blank");
        return (!1 === x(n)
          ? sn.sanitizeWith(function (n) {
              return fn(sn.getValue(n), r);
            })
          : sn.sanitize)(e);
      }
      return $.none();
    ...
    Dn = function (n) {
      var t = g(n);
      return f(t)
        ? sn.sanitize(t).orThunk(function () {
            return $.some(Rn);
          })
        : !1 === t
        ? $.none()
    ...
    Un = function (e, r) {
      return Fn(e).map(function (n) {
        var t = (function (n, t) {
          var e = n.dom,
            r = un(n.selection.getContent())
              ? $.some(an(n.selection, t))
              : $.none(),
            o = t ? $.some(e.getAttrib(t, "href")) : $.none(),
            i = t ? $.from(e.getAttrib(t, "target")) : $.none(),
            u = wn(e, t, "rel"),
            c = wn(e, t, "class");
          return {
            url: o,
          ...
          return (function (n, t, e) {
                ...
                return {
                  url: {
                    ...
                    meta: {
                      ...
                      original: { value: n.anchor.url.getOr("") },
                    },
                  },
            ...
            return {
              ...
              body: {
                ...
                items: I([
                  ...
                  (function (n) {
                    ...
                    c.anchor.map(sn.createUi("anchor", "Anchors")),
                    c.rels.map(sn.createUi("rel", "Rel")),
                    c.targets.map(sn.createUi("target", "Open link in...")),
                    c.link.map(sn.createUi("link", "Link list")),
                    c.classes.map(sn.createUi("linkClass", "Class")),
                  ]),
                ]),
              },
              buttons: [
              ...
              onChange: function (t, n) {
                var e = n.name;
                u.onChange(t.getData, { name: e }).each(function (n) {
                  t.setData(n);
                });
              },
              onSubmit: t,
            ...
            (function (i, u, c) {
              return function (n) {
                var e = n.getData();
                if (!e.url.value) return en(i), void n.close();
                function t(t) {
                  return $.from(e[t]).filter(function (n) {
    ...
    Kn = function (e) {
      e.on("click", function (n) {
        var t = xn(e, n.target);
        t && o.metaKeyPressed(n) && (n.preventDefault(), bn(e, t));
      }),
        e.on("keydown", function (n) {
          ...
          t &&
            ...
            (n.preventDefault(), bn(e, t));
        });
    },
    Bn = function (e) {
      return function (t) {
        function n(n) {
          return t.setActive(!e.readonly && !!cn(e, n.element));
        }
        return (
          e.on("NodeChange", n),
          function () {
    ...
    Vn = function (e) {
      return function (t) {
        t.setDisabled(!rn(e.dom.getParents(e.selection.getStart())));
        function n(n) {
          return t.setDisabled(!rn(n.parents));
        }
        return (
          e.on("NodeChange", n),
          function () {
    ...
    Jn = function (t) {
      t.ui.registry.addContextMenu("link", {
        update: function (n) {
          return rn(t.dom.getParents(n, "a")) ? "link unlink openlink" : "link";
        },
      });
    },
    Xn = function (i) {
      function n(n) {
        ...
        return n.setDisabled(!cn(i, t)), function () {};
      }
        ...
        commands: [
          {
            ...
            onSetup: function (n) {
              var t = i.selection.getNode();
              return n.setActive(!!cn(i, t)), Bn(i)(n);
            },
            onAction: function (n) {
              var t = cn(i),
                e = n.getValue();
              if (t)
                ...
                var r = { href: e, attach: function () {} },
                  o = un(i.selection.getContent())
                    ? $.some(an(i.selection, t))
                        .filter(function (n) {
                          return 0 < n.length;
                        })
                        .or($.from(e))
  ...
  !(function Qn() {
    r.add("link", function (n) {
      $n(n), Gn(n), Jn(n), Xn(n), Kn(n), Wn(n), Hn(n);
    });
  })();
})(window);
