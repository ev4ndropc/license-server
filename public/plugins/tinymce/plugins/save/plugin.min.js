...
!(function () {
  ...
  var n = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    u = function (n) {
      var e;
      if (((e = o.DOM.getParent(n.id, "form")), !a(n) || n.isDirty())) {
        if ((n.save(), c(n)))
          ...
          ? (n.setDirty(!1),
            (e.onsubmit && !e.onsubmit()) ||
              ("function" == typeof e.submit
                ? e.submit()
                : t(n, "Error: Form submit field collision.")),
            n.nodeChanged())
          : t(n, "Error: No form element found.");
      }
    },
    l = function (n) {
      var e = i.trim(n.startContent);
      r(n) ? n.execCallback("save_oncancelcallback", n) : n.resetContent(e);
    },
    s = function (n) {
