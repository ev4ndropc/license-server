...
!(function () {
  ...
  function q(t) {
    for (var n = ot, e = rt.length, r = 0; r < e; ++r) {
      var o = rt[r];
      if (o && o.test(t)) {
        n = r;
        break;
  ...
  function I(t, n) {
    var e = (function (t, n) {
      var e;
      for (e = n; e < t.length && !ut.test(t[e]); e++);
      return e;
    })(t, n + 1);
    return "://" ===
      t
  ...
  var tt,
    ...
    rt = (nt(Array.from) && Array.from, F),
    ot = B,
    ut = /^\s+$/,
    it = N,
    ct = function (t, n, e) {
      e = a(a({}, { includeWhitespace: !1, includePunctuation: !1 }), e);
      ...
      return (function (t, n, e, r) {
        for (var o, u, i, c, a, f, s, l = [], g = [], p = 0; p < e.length; ++p)
          if (
            ...
            var d = n[p];
            if (
              (r.includeWhitespace || !ut.test(d)) &&
              (r.includePunctuation || !it.test(d))
            ) {
              var h = p - g.length + 1,
                y = p + 1,
                C = n.slice(h, y).join("");
    ...
    at = tinymce.util.Tools.resolve("tinymce.dom.TreeWalker"),
    ft = tinymce.util.Tools.resolve("tinymce.util.Delay");
  !(function st(e) {
    void 0 === e && (e = 300),
      u.add("wordcount", function (t) {
        var n = (function (t) {
          return {
            body: {
              getWordCount: V(t),
              getCharacterCount: L(t, J),
              getCharacterCountWithoutSpaces: L(t, K),
            },
            selection: {
              getWordCount: Q(t, H),
              getCharacterCount: Q(t, J),
              getCharacterCountWithoutSpaces: Q(t, K),
            },
            getCount: V(t),
          };
        })(t);
