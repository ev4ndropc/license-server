...
!(function (t) {
        ...
        : (function (r, t, o) {
            r.undoManager.transact(function () {
              ...
              r.insertContent(
                ...
                (e = (function (e) {
                  return e.dom.select("*[data-mce-id]")[0];
                })(r)).removeAttribute("data-mce-id"),
                (n = r.dom.select("td,th", e)),
                r.selection.setCursorLocation(n[0], 0);
            });
          })(e, n, r);
    },
    c = function (e, n, r) {
      ...
      (o = (t = e.editorUpload.blobCache).create(
        (function (e) {
          ...
          return e + "_" + Math.floor(1e9 * Math.random()) + ++i + String(n);
        })("mceu"),
        r,
        n
      )),
  ...
  var b = function (r) {
    ...
    w = {
      ...
      none: n,
      from: function (e) {
        return null === e || e === undefined ? h : b(e);
      },
    },
    E = function (e) {
    ...
    T = {
      fromHtml: function (e, n) {
        ...
        if (((r.innerHTML = e), !r.hasChildNodes() || 1 < r.childNodes.length))
          throw (
            (t.console.error("HTML does not have a single root node", e),
            new Error("HTML must have a single root node"))
          );
        return E(r.childNodes[0]);
      },
      ...
      fromPoint: function (e, n, r) {
        var t = e.dom();
        return w.from(t.elementFromPoint(n, r)).map(E);
      },
    },
    S =
  ...
  function M(e, n, r, t, o) {
    return e(r, t) ? w.some(r) : C(o) && o(r) ? w.none() : n(r, t, o);
  }
  function R(e, n, r) {
  ...
  function j(e, n, r) {
    for (var t = e.dom(), o = C(r) ? r : l(!1); t.parentNode; ) {
      t = t.parentNode;
      var i = T.fromDom(t);
  ...
  var X,
    z = function (e, n) {
      return R(e, n, t.Node.DOCUMENT_POSITION_CONTAINED_BY);
    },
    G = function (e) {
      function n() {
        return r;
    ...
    te = {
      unknown: function () {
        return re({ current: undefined, version: $.unknown() });
      },
      nu: re,
      windows: l(Q),
      ios: l("iOS"),
    ...
    oe = function (e, r) {
      return P(e, r).map(function (e) {
        var n = $.detect(e.versionRegexes, r);
    ...
    ce = [
      ...
      },
      {
        ...
        search: function (e) {
          return F(e, "chrome") && !F(e, "chromeframe");
        },
      },
      {
        name: "IE",
      ...
      },
      {
        ...
        search: function (e) {
          return (F(e, "safari") || F(e, "mobile/")) && F(e, "applewebkit");
        },
      },
    ],
    ae = [
      ...
      { name: "Solaris", search: U("sunos"), versionRegexes: [] },
      { name: "FreeBSD", search: U("freebsd"), versionRegexes: [] },
    ],
    se = { browsers: l(ce), oses: l(ae) },
    fe = G(
      (function (e, n) {
        var r = se.browsers(),
          t = se.oses(),
          o = oe(r, e).fold(K.unknown, K.nu),
          i = ie(t, e).fold(te.unknown, te.nu);
        return {
          browser: o,
          os: i,
          ...
          function (e, n, r) {
            return (
              ...
              (function (e, n) {
                ...
                return _(e) ? n : D(e) ? (!1 === e ? "" : n) : e;
              })(e.getParam(n, r), r)
            );
          }),
      }),
    me = function (e) {
      return le.getToolbarItemsOr(
        e,
      ...
      0 < e.trim().length &&
        o.ui.registry.addContextToolbar("quickblock", {
          predicate: function (e) {
            ...
            var r = T.fromDom(e),
              t = o.schema.getTextBlockElements();
