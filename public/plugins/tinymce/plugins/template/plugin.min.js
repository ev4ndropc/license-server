...
!(function () {
  ...
  function l(e, t) {
    ...
    p.each(r.select("*", t), function (n) {
      p.each(o, function (e, t) {
        r.hasClass(n, t) && "function" == typeof o[t] && o[t](n);
      });
    });
  }
  function s(e, t) {
  ...
  var r,
    ...
    o = tinymce.util.Tools.resolve("tinymce.util.XHR"),
    m = function (e) {
    ...
    x = function (t, e, n) {
      ...
      (n = i(n, h(t))),
        (r = a.create("div", null, n)),
        (o = a.select(".mceTmpl", r)) &&
          0 < o.length &&
          (r = a.create("div", null)).appendChild(o[0].cloneNode(!0)),
        p.each(a.select("*", r), function (e) {
          s(e, m(t).replace(/\s+/g, "|")) && (e.innerHTML = T(t, b(t))),
            s(e, d(t).replace(/\s+/g, "|")) && (e.innerHTML = T(t, O(t))),
            s(e, g(t).replace(/\s+/g, "|")) && (e.innerHTML = u);
        }),
        l(t, r),
  ...
  function H(e) {
    return e.replace(/["'<>&]/g, function (e) {
      return (function (e, t) {
        return B(e, t) ? L.from(e[t]) : L.none();
      })(E, e).getOr(e);
    });
  }
  function k(t) {
  ...
  var I,
    ...
    L = {
      ...
      none: n,
      from: function (e) {
        return null === e || e === undefined ? w : J(e);
      },
    },
    Y =
      ((I = "function"),
          ...
          return L.from(
            p.map(t, function (e, t) {
              ...
              return {
                ...
                text: e.title,
                value: {
                  url: n(e) ? L.from(e.url) : L.none(),
                  content: n(e) ? L.none() : L.from(e.content),
                  description: e.description,
                },
              };
            })
          );
        var e = i.translate("No templates defined.");
        return i.notificationManager.open({ text: e, type: "info" }), L.none();
      })().each(function (n) {
        function u(e, t) {
          return {
            ...
            onSubmit: (function (n) {
              return function (t) {
                var e = t.getData();
                a(n, e.template).each(function (e) {
                  l(e).then(function (e) {
                    x(i, !1, e), t.close();
                  });
                });
            ...
            var r = (function (t, e) {
              ...
              o = [
                ...
                },
                {
                  type: "htmlpanel",
                  html:
                    '<p aria-live="polite">' + H(t.value.description) + "</p>",
                },
                {
                  label: "Preview",
                  type: "iframe",
              ...
              a = { template: t.text, preview: r };
            e.unblock(), e.redial(u(o, a)), e.focus("template");
          },
          t = i.windowManager.open(u([], { template: "", preview: "" }));
        t.block("Loading..."),
          l(n[0]).then(function (e) {
            r(t, n[0], e);
          });
      });
    },
