...
!(function () {
  ...
  function e(n) {
    return function (t) {
      function e() {
        return t.setDisabled(n.readonly || !v.hasHeaders(n));
      }
      return (
        e(),
  ...
  var t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    l = tinymce.util.Tools.resolve("tinymce.util.I18n"),
    ...
    o = function (t) {
      ...
      for (
        i += (function (t, e) {
          var n = "</" + t + ">";
          return "<" + t + ' contenteditable="true">' + u.DOM.encode(e) + n;
        })(d(t), l.translate("Table of Contents")),
          e = 0;
        e < c.length;
        e++
      ) {
        if (
          (((o = c[e]).element.id = o.id),
          (r = c[e + 1] && c[e + 1].level),
          a === o.level)
        )
          i += "<li>";
        else for (n = a; n < o.level; n++) i += "<ul><li>";
        if (
          ((i += '<a href="#' + o.id + '">' + o.title + "</a>"),
          r !== o.level && r)
        )
          for (n = o.level; r < n; n--) i += "</li></ul><li>";
        else (i += "</li>"), r || (i += "</ul>");
        a = o.level;
      }
      return i;
    ...
    v = {
      ...
      insertToc: function (t) {
        ...
        !(function (t, e) {
          return (
            !e.length ||
            0 < t.dom.getParents(e[0], ".mce-offscreen-selection").length
          );
        })(t, n)
          ? r(t)
          : t.insertContent(
      ...
      t.ui.registry.addButton("toc", {
        ...
        t.ui.registry.addContextToolbar("toc", {
          ...
          predicate: (function (e) {
            return function (t) {
              return t && e.dom.is(t, "." + c(e)) && e.getBody().contains(t);
            };
          })(t),
          scope: "node",
          position: "node",
