...
!(function (f) {
  ...
  var n,
    ...
    u = function (t) {
      return (
        ...
        ("undefined" != typeof f.window.console &&
  ...
  var P,
    ...
    F = {
      ...
      none: e,
      from: function (t) {
        return null === t || t === undefined ? v : S(t);
      },
    },
    I =
      ((P = "function"),
  ...
  (T = undefined),
    ...
    (function (t) {
      ...
      return (function l(i, u, a) {
        ...
        for (var c = "function" == typeof k && k, t = 0; t < a.length; t++)
          s(a[t]);
        return s;
      })(
        {
                    ...
                    ? ((r._handled = !0),
                      i._immediateFn(function () {
                        ...
                        if (null !== t) {
                          ...
                          u(o.promise, e);
                        } else (1 === r._state ? u : a)(o.promise, r._value);
                      }))
                    : r._deferreds.push(o);
                }
                function u(t, e) {
  ...
  var H = A.exports.boltExport,
    ...
    G = tinymce.util.Tools.resolve("tinymce.util.VK"),
    X = "x-tinymce/html",
    Y = "\x3c!-- " + X + " --\x3e",
    Z = function (t) {
      return Y + t;
    ...
    et = tinymce.util.Tools.resolve("tinymce.html.Entities"),
    nt = function (t) {
    ...
    ot = tinymce.util.Tools.resolve("tinymce.html.DomParser"),
    it = tinymce.util.Tools.resolve("tinymce.html.Node"),
    ut = tinymce.util.Tools.resolve("tinymce.html.Schema"),
    at = tinymce.util.Tools.resolve("tinymce.html.Serializer"),
    st = {
  ...
  var lt = {
    ...
    createIdGenerator: function ce(t) {
      var e = 0;
      return function () {
        return t + e++;
      };
    ...
    isMsEdge: function () {
      return -1 !== f.navigator.userAgent.indexOf(" Edge/");
    },
  };
  function ft(e) {
    var n, t;
    ...
    return (
      K.each(t, function (t, e) {
        switch (e) {
          ...
          case "font-weight":
          case "font-style":
            return void ("normal" !== t && (a[e] = t));
          case "mso-element":
            if (/^(comment|comment-list)$/i.test(t)) return void o.remove();
        }
        0 !== e.indexOf("mso-comment")
          ? 0 !== e.indexOf("mso-") &&
            ("all" === st.getRetainStyleProps(n) || (r && r[e])) &&
            (a[e] = t)
          : o.remove();
      }),
      /(bold)/i.test(a["font-weight"]) &&
        (delete a["font-weight"], o.wrap(new it("b", 1))),
      /(italic)/i.test(a["font-style"]) &&
        (delete a["font-style"], o.wrap(new it("i", 1))),
  ...
  function gt(t, e, n, r) {
    var o = s(t, e, n, r);
    return t.hasEventListeners("PastePostProcess") && !o.isDefaultPrevented()
      ? (function (t, e, n, r) {
          var o = t.dom.create("div", { style: "display:none" }, e),
            i = c(t, o, n, r);
          return pt(i.node.innerHTML, i.isDefaultPrevented());
        })(t, o.content, n, r)
      : pt(o.content, o.isDefaultPrevented());
  }
  function ht(t, e) {
    return (
      t.insertContent(
        (function (t, e) {
          var n = t.dom.create("body", {}, e);
          return (
            K.each(n.querySelectorAll("meta"), function (t) {
              return t.parentNode.removeChild(t);
            }),
            n.innerHTML
          );
        })(t, e),
        { merge: st.shouldMergeFormats(t), paste: !0 }
      ),
      !0
    );
  }
  ...
  function _t(n) {
    return (function (t, e, n) {
      ...
      function (t, e) {
        return (function (t) {
          return -1 !== " \f\t\x0B".indexOf(t);
        })(e) || "\xa0" === e
          ? t.pcIsSpace ||
            "" === t.str ||
            t.str.length === n.length - 1 ||
            (function (t, e) {
              return e < t.length && 0 <= e && xt(t[e]);
            })(n, t.str.length + 1)
  ...
  function kt(t) {
    return Ct(t, "text/html") || Ct(t, "text/plain");
  }
  function St(e, t, n) {
    var r = (function (t) {
      return "paste" === t.type;
                    ...
                    o =
                      t.settings.images_reuse_filename && e.blob.name
                        ? (function (t, e) {
                            ...
                            return n ? t.dom.encode(n[1]) : null;
                          })(t, e.blob.name)
                        : r,
                    i = new f.Image();
                  if (
                    ...
                    (function (t, e) {
                      return (
                        !t.images_dataimg_filter || t.images_dataimg_filter(e)
                      );
                    })(t.settings, i))
                  ) {
                    var u,
                      a = t.editorUpload.blobCache,
                      s = void 0;
                    (u = a.findFirst(function (t) {
                      return t.base64() === n;
                    }))
                      ? (s = u)
                      : ((s = a.create(r, e.blob, n, o)), a.add(s)),
                      Pt(t, '<img src="' + s.blobUri() + '">', !1);
                  } else Pt(t, '<img src="' + e.uri + '">', !1);
                })(e, t);
              });
          }),
          !0
  ...
  function Ft(t) {
    return (
      (G.metaKeyPressed(t) && 86 === t.keyCode) ||
  ...
  function It(u, a, i) {
    ...
    function l(t, e, n, r) {
      ...
      Ct(t, "text/html")
        ...
        : ((o = a.getHtml()),
          (r = r || Q(o)),
          a.isDefaultContent(o) && (n = !0)),
        (o = lt.trimHtml(o)),
        a.remove(),
        (i = !1 === r && nt(o)),
        (o.length && !i) || (n = !0),
        n && (o = Ct(t, "text/plain") && i ? t["text/plain"] : lt.innerText(o)),
        a.isDefaultContent(o)
          ? e ||
    ...
    u.on("keydown", function (t) {
      function e(t) {
        Ft(t) && !t.isDefaultPrevented() && a.remove();
      }
      if (Ft(t) && !t.isDefaultPrevented()) {
        if (
          (s = t.shiftKey && 86 === t.keyCode) &&
          V.webkit &&
          -1 !== f.navigator.userAgent.indexOf("Version/")
        )
          return;
        if (
          ...
          return t.preventDefault(), void m(u, !0);
        a.remove(),
          a.create(),
          u.once("keyup", e),
      ...
      u.on("paste", function (t) {
        var e = c.isSet(),
          n = (function (t, e) {
            var n = Dt(e.clipboardData || t.getDoc().dataTransfer);
            return lt.isMsEdge() ? K.extend(n, { "text/html": "" }) : n;
          })(u, t),
          r = "text" === i.get() || s,
          o = Ct(n, tt());
        (s = !1),
          ...
          (function (t) {
            ...
            return (
              -1 !== f.navigator.userAgent.indexOf("Android") &&
              e &&
              e.items &&
              0 === e.items.length
            );
            ...
            ? a.remove()
            : kt(n) || !St(u, t, a.getLastRng() || u.selection.getRng())
            ? (e || t.preventDefault(),
              !V.ie ||
                (e && !t.ieFake) ||
                Ct(n, "text/html") ||
                (a.create(),
                u.dom.bind(a.getEl(), "paste", function (t) {
                  t.stopPropagation();
                }),
                u.getDoc().execCommand("Paste", !1, null),
                (n["text/html"] = a.getHtml())),
              Ct(n, "text/html")
                ? (t.preventDefault(),
                  (o = o || Q(n["text/html"])),
                  l(n, e, r, o))
    ...
    return {
      ...
      getHtml: function () {
        return (function (n) {
          ...
          var r, t, o, i, u;
          for (
            t = K.grep(Et(n).childNodes, function (t) {
              ...
              o = (i = n.dom.select("div[id=mcepastebin]", r)).length - 1;
            0 <= o;
            o--
          )
            (u = n.dom.create("div")), r.insertBefore(u, i[o]), e(u, i[o]);
  ...
  function Bt(a) {
    return function (t, e) {
      var n = Z(t),
        ...
        o = a.dom.create("div", { contenteditable: "true" }, n);
      a.dom.setStyles(r, {
        position: "fixed",
        top: "0",
        left: "-3000px",
      ...
      var i = a.selection.getRng();
      o.focus();
      var u = a.dom.createRng();
  ...
  function Wt(t, e) {
    return Zt.getCaretRangeFromPoint(e.clientX, e.clientY, t.getDoc());
  }
  function Ut(t, e) {
  ...
  var zt = {
      preProcess: function (t, e) {
        return st.shouldUseDefaultFilters(t)
          ? (function (r, t) {
              ...
              var n = st.getWordValidElements(r),
                i = ut({ valid_elements: n, valid_children: "-li[p]" });
              K.each(i.elements, function (t) {
                t.attributes["class"] ||
                  ((t.attributes["class"] = {}),
              ...
              u.addAttributeFilter("style", function (t) {
                for (var e, n = t.length; n--; )
                  (e = t[n]).attr("style", mt(r, o, e, e.attr("style"))),
                    "span" === e.name &&
                      e.parent &&
                      !e.attributes.length &&
                      e.unwrap();
              ...
              return (
                ...
                (t = at({ validate: r.settings.validate }, i).serialize(a))
              );
            })(t, e)
          : e;
      },
      isWordContent: function le(t) {
        return (
    ...
    Vt = function (t, e, n) {
      var r = zt.isWordContent(e),
        o = r ? zt.preProcess(t, e) : e;
      return gt(t, o, n, r);
    },
    qt = function (t, e) {
      !1 === st.isSmartPasteEnabled(t)
        ? ht(t, e)
        : (function (e, n) {
            K.each([bt, wt, ht], function (t) {
              return !0 !== t(e, n, ht);
            });
          })(t, e);
    },
    Kt = lt.createIdGenerator("mceclip"),
    Gt = function (t) {
    ...
    Yt = function (t) {
      t.on(
        ...
        t.on(
          ...
          (function (e) {
            return function (t) {
              $t(e) && Nt(t, Ht(e), Bt(e), Mt);
            };
          })(t)
        );
    },
    Zt = tinymce.util.Tools.resolve("tinymce.dom.RangeUtils"),
    Jt = function (i, u, a) {
      st.shouldBlockDrop(i) &&
        i.on("dragend dragover draggesture dragdrop drop drag", function (t) {
        ...
        i.on("drop", function (t) {
          ...
          if (((n = Wt(i, t)), !t.isDefaultPrevented() && !a.get())) {
            ...
            if (
              ...
              var o = e["mce-internal"] || e["text/html"] || e["text/plain"];
              o &&
                (t.preventDefault(),
                q.setEditorTimeout(i, function () {
                  i.undoManager.transact(function () {
                    e["mce-internal"] && i.execCommand("Delete"),
                      Ut(i, n),
                      (o = lt.trimHtml(o)),
                      e["text/html"] ? u.pasteHtml(o, r) : u.pasteText(o);
                  });
                }));
            }
          }
        ...
        i.on("dragover dragend", function (t) {
          st.shouldPasteDataImages(i) &&
            ...
            "dragend" === t.type && a.set(!1);
        });
    },
    Qt = function (t) {
      var e = t.plugins.paste,
        n = st.getPreProcess(t);
      n &&
        t.on("PastePreProcess", function (t) {
          n.call(e, e, t);
        });
      var r = st.getPostProcess(t);
      r &&
  ...
  function ee(t, e) {
    ...
    var n = [];
    K.each(t.schema.getBlockElements(), function (t, e) {
      n.push(e);
    });
    var r = new RegExp(
      "(?:<br>&nbsp;[\\s\\r\\n]+|<br>)*(<\\/?(" +
  ...
  function ne(t, e, n, r) {
    if (r || n) return e;
    var c,
      o = st.getWebkitStyles(t);
    if (!1 === st.shouldRemoveWebKitStyles(t) || "all" === o) return e;
    if ((o && (c = o.split(/[, ]/)), c)) {
      var l = t.dom,
  ...
  !(function fe() {
    r.add("paste", function (t) {
      if (!1 === u(t)) {
        var e = d(!1),
          n = d(st.isPasteAsTextEnabled(t) ? "text" : "html"),
          r = jt(t, n),
          o = ie(t);
        return ue(t, r), p(t, r), Qt(t), Yt(t), Jt(t, r, e), a(r, o);
      }
    });
  })();
})(window);
