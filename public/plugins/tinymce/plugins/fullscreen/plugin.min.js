...
!(function (l) {
    ...
    var r = e.dom(),
      ...
      o =
        ...
        (function (e) {
          ...
          return (
            n !== undefined && null !== n && n.ownerDocument.body.contains(n)
          );
        })(e)
          ? t
          : ue(r, n);
  ...
  function R(e, n) {
    ...
    return (function (e) {
      return (
        (e.nodeType !== Ce && e.nodeType !== De) || 0 === e.childElementCount
      );
    })(r)
      ? []
  ...
  var B,
        ...
        ? ((V = (function () {
          ...
          }, 50)),
          {
            bind: function (e) {
              V.set(e),
                j(),
                je.addEventListener("resize", j),
                je.addEventListener("scroll", j);
            },
            unbind: function () {
              V.on(function () {
                je.removeEventListener("scroll", j),
                  je.removeEventListener("resize", j);
              }),
                V.clear();
            },
          })
    ...
    ze = function (e, n) {
      ...
      if (
        ((r = t.style), (o = e.getContentAreaContainer().firstChild.style), s)
      )
