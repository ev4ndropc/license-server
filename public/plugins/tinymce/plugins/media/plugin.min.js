...
!(function () {
              ...
              start: function (e, t) {
                if (
                  ...
                  ("iframe" !== e &&
                    ...
                    "video" !== e &&
                    "audio" !== e) ||
                    (i.type || (i.type = e), (i = re.extend(t.map, i))),
                  "script" === e)
                ) {
                  var r = v(n, t.map.src);
                  if (!r) return;
  ...
  var $,
    ...
    q =
      ...
      function () {
        ...
        for (var r = {}, n = 0; n < e.length; n++) {
          var i = e[n];
          for (var o in i) I.call(i, o) && (r[o] = $(r[o], i[o]));
        }
        return r;
      }),
                  ...
                  start: function (e, t, r) {
                    switch (e) {
                      ...
                      case "iframe":
                        i.height !== undefined &&
                          i.width !== undefined &&
                          y(t, { width: i.width, height: i.height });
                    }
                    if (o)
                      switch (e) {
                        case "video":
                          y(t, { poster: i.poster, src: "" }),
                            i.source2 && y(t, { src: "" });
                          break;
                        case "iframe":
                          y(t, { src: i.source1 });
            ...
            return new ce(function (t, e) {
              function r(e) {
                return (
                  ...
                  t({ url: n.source1, html: e.html ? e.html : i(n) })
                );
              }
    ...
    ve = function (n) {
      ...
      var u = { title: "Advanced", name: "advanced", items: c },
        s = [o, a];
      0 < c.length && s.push(u);
      var l = { type: "tabpanel", tabs: s },
        ...
        t.on("ObjectResized", function (e) {
          ...
          r.getAttribute("data-mce-object") &&
            ...
            r.setAttribute(
              "data-mce-html",
              escape(
                de(t, { width: String(e.width), height: String(e.height) })
              )
            ));
        });
    },
