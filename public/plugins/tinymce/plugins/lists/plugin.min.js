...
!(function (r) {
  ...
  function H(e, n) {
    return (function (e, n) {
      for (
        var t = n !== undefined && null !== n ? n : Rn, r = 0;
  ...
  function z(e, n) {
    ...
    if (
      ...
      o &&
        ...
        zn(n.firstChild, s) || a.appendChild(r)),
      n)
    )
      for (; (t = n.firstChild); ) {
        var c = t.nodeName;
    ...
    return (
      O(r).each(function (e) {
        !(function (e, n) {
          ...
          (function (e, n) {
            K(e.list) !== n.listType && (e.list = J(e.list, n.listType)),
  ...
  function ne(e, n, t) {
    var r = (function (e, n, t) {
      for (var r, o, i, u = [], s = 0; s < t; s++)
        u.push(
          ...
          (o = n.listType),
          void 0,
          (i = { list: bn.fromTag(o, r), item: bn.fromTag("li", r) }),
          M(i.list, i.item),
          i)
        );
      return u;
    ...
    return (
      (function (e) {
        for (var n = 1; n < e.length; n++) Z(e[n - 1], e[n]);
      })(r),
      (function (e, n) {
      ...
      (function (e, n) {
        ...
        !(function (e, n) {
          (e.listType = n.listType),
            (e.listAttributes = nt({}, n.listAttributes));
        })(n, e);
      });
    });
  }
  ...
  function le(t, e, r) {
    var n = (function (e, n) {
      var t = Ge(!1);
      return g(e, function (e) {
        return { sourceList: e, entries: tt(0, n, t, e) };
      });
    })(e, de(t));
    p(n, function (e) {
      !(function (e, n) {
  ...
  function pe(e, n) {
    if (Mn(e)) return { container: e, offset: n };
  ...
  function ve(e, n) {
    ...
    if (t.length || r.length) {
      ...
      le(e, t, n),
        ...
        e.selection.setRng(ut(e.selection.getRng())),
        e.nodeChanged(),
        (o = !0);
    }
    return o;
    ...
    !(function (e, n, t) {
      ...
      (function (e, n, t) {
        Ce(n, t["list-attributes"]),
          Pn.each(e.select("li", n), function (e) {
  ...
  function Le(e, n, t, r) {
    ...
    for (
      o = n[t ? "startContainer" : "endContainer"],
        ...
        !t && qn(o.nextSibling) && (o = o.nextSibling);
      o.parentNode !== r;
  ...
  function Te(r, o, i) {
    ...
    var e,
      ...
      s = r.dom;
    "false" !== s.getContentEditable(r.selection.getNode()) &&
      ("DL" === (o = o.toUpperCase()) && (u = "DT"),
      (e = ct(n)),
      Pn.each(
        (function (t, e, r) {
          for (
          ...
          return (
            Pn.each(a, function (e) {
              if (Vn(t, e)) return i.push(e), void (o = null);
              if (u.isBlock(e) || qn(e))
                return qn(e) && u.remove(e), void (o = null);
              var n = e.nextSibling;
              st.isBookmarkNode(e) && (Vn(t, n) || (!n && e.parentNode === r))
                ? (o = null)
                : (o ||
                    ((o = u.create("p")),
  ...
  function we(e, n) {
    ...
    "LI" === r.nodeName &&
      ...
      ((t = r.previousSibling) && "LI" === t.nodeName
        ? (t.appendChild(n), Xn(e, r) && gt.remove(r))
        : gt.setStyle(r, "listStyleType", "none")),
      Un(r) &&
        (t = r.previousSibling) &&
        "LI" === t.nodeName &&
        t.appendChild(n);
  ...
  function Re(n, e, t) {
    var r,
      ...
      i = e.parentNode;
    if (Qn(n, e) && Qn(n, t)) {
      Un(t.lastChild) && (o = t.lastChild),
        i === t.lastChild &&
          qn(i.previousSibling) &&
          n.remove(i.previousSibling),
        (r = t.lastChild) && qn(r) && e.hasChildNodes() && n.remove(r),
        Xn(n, t, !0) && n.$(t).empty(),
        xe(n, e, t),
        o && t.appendChild(o);
  ...
  function _e(e, n) {
    ...
    if (u) {
      ...
      if (!c && !n && 0 === a.startOffset && 0 === a.endOffset)
        return (
          e.undoManager.transact(function () {
            ye(e);
          }),
            ...
            return (
              e.undoManager.transact(function () {
                !(function (e, n, t) {
                  ...
                  mt.mergeWithAdjacentLists(t, s.parentNode),
      ...
      : (function (e) {
          ...
          return (
            !!(
              ...
              0 < Jn.getSelectedListItems(e).length
            ) &&
            (e.undoManager.transact(function () {
  ...
  var Fe,
    ...
    gn = {
      unknown: function () {
        return mn({ current: undefined, version: en.unknown() });
      },
      nu: mn,
      windows: l(cn),
      ios: l("iOS"),
    ...
    bn = {
      fromHtml: function (e, n) {
        ...
        if (((t.innerHTML = e), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (
            (r.console.error("HTML does not have a single root node", e),
    ...
    nt =
      ...
      function () {
        ...
        for (var t = {}, r = 0; r < e.length; r++) {
          var o = e[r];
          for (var i in o) et.call(o, i) && (t[i] = je(t[i], o[i]));
        }
        return t;
      }),
    tt = function (n, t, r, e) {
    ...
    it = function (e, n, t) {
      var r, o, i, u, s, a;
      for (
        i = ot.select('span[data-mce-type="bookmark"]', n),
          s = z(e, t),
          (r = ot.createRng()).setStartAfter(t),
          r.setEndAfter(n),
      ...
      e.dom.isEmpty(o) || ot.insertAfter(o, n),
        ot.insertAfter(s, n),
        Xn(e.dom, t.parentNode) &&
          ((a = t.parentNode),
          Pn.each(i, function (e) {
            a.parentNode.insertBefore(e, t.parentNode);
          }),
          ot.remove(a)),
        ot.remove(t),
        Xn(e.dom, n) && ot.remove(n);
    },
    ut = function (e) {
      var n = e.cloneRange(),
    ...
    ct = function (o) {
      function e(e) {
        ...
        (t = o[e ? "startContainer" : "endContainer"]),
          ...
          1 === t.nodeType &&
            ((n = at.create("span", { "data-mce-type": "bookmark" })),
            t.hasChildNodes()
              ? ((r = Math.min(r, t.childNodes.length - 1)),
                e
                  ? t.insertBefore(n, t.childNodes[r])
                  : at.insertAfter(n, t.childNodes[r]))
              : t.appendChild(n),
            (t = n),
            (r = 0)),
    ...
    vt = function (n) {
      n.on("keydown", function (e) {
        e.keyCode === An.BACKSPACE
          ? Pe(n, !1) && e.preventDefault()
          : e.keyCode === An.DELETE && Pe(n, !0) && e.preventDefault();
      });
    },
    ht = Pe,
    Nt = function (n) {
