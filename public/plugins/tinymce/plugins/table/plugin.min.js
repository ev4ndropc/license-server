...
!(function (f) {
  ...
  function pe(e) {
    return (
      (e.nodeType !== Nn && e.nodeType !== In) || 0 === e.childElementCount
    );
  }
  function he(e) {
  ...
  var Pe = function (t) {
    ...
    $e =
      (f.Node.ATTRIBUTE_NODE, f.Node.CDATA_SECTION_NODE, f.Node.COMMENT_NODE),
    ...
    en =
      ...
      "undefined" != typeof f.window ? f.window : Function("return this;")(),
      function (e) {
    ...
    on = {
      fromHtml: function (e, n) {
        ...
        if (((t.innerHTML = e), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (
            (f.console.error("HTML does not have a single root node", e),
    ...
    hn = {
      unknown: function () {
        return pn({ current: undefined, version: mn.unknown() });
      },
      nu: pn,
      edge: D("Edge"),
      chrome: D("Chrome"),
    ...
    Sn = {
      unknown: function () {
        return Cn({ current: undefined, version: mn.unknown() });
      },
      nu: Cn,
      windows: D(vn),
      ios: D("iOS"),
    ...
    Dn = [
      ...
      { name: "Linux", search: de("linux"), versionRegexes: [] },
      { name: "Solaris", search: de("sunos"), versionRegexes: [] },
      { name: "FreeBSD", search: de("freebsd"), versionRegexes: [] },
    ],
    An = { browsers: D(On), oses: D(Dn) },
    En = R(
      (function (e, n) {
        var t = An.browsers(),
          r = An.oses(),
  ...
  var it = function (e, n, t) {
      ...
      return g(n, function (e) {
        var n = e,
          t = ve(n)
            .map(function (e) {
              var n = en(e);
              return "tfoot" === n || "thead" === n || "tbody" === n
                ? n
                : "tbody";
            })
            .getOr("tbody"),
      ...
      generate: function (e) {
        ...
        p(e, function (e, c) {
          ...
          p(e.cells(), function (e) {
            for (var n = 0; l[ot(c, n)] !== undefined; ) n++;
            for (
              var t = Hn(e.element(), e.rowspan(), e.colspan(), c, n), r = 0;
              r < e.colspan();
              r++
            )
        ...
        var r = _n(t, f);
        return { grid: D(r), access: D(l), all: D(n) };
      },
    ...
    pt = function (e, n) {
      ...
      return (
        ...
        (function (e, n, t, r) {
          for (
            var o, i, u, c = n.grid().columns(), a = n.grid().rows(), l = 0;
            l < a;
            l++
          )
            for (var f = !1, s = 0; s < c; s++) {
              if (
                ...
                mt.getAt(n, l, s).filter(r).isNone()
                  ? ((o = f),
                    void 0,
                    (i = e[l].element()),
                    (u = on.fromTag("td")),
        ...
        (function (e, n) {
          ...
          p(t, Wn),
            (n.minCol() !== n.maxCol() && n.minRow() !== n.maxRow()) ||
              p(ut.firstLayer(e, "th,td"), function (e) {
  ...
  function kt(e, n, t) {
    var r = mt.findItem(e, n, kn),
      o = mt.findItem(e, t, kn);
    return r.bind(function (n) {
      return o.map(function (e) {
        return (function (e, n) {
          return Yn(
            Math.min(e.row(), n.row()),
            Math.min(e.column(), n.column()),
            Math.max(e.row() + e.rowspan() - 1, n.row() + n.rowspan() - 1),
            Math.max(e.column() + e.colspan() - 1, n.column() + n.colspan() - 1)
          );
        })(n, e);
      });
    });
  }
  var Bt = (function Jf(t, r) {
      var n = function (e) {
    ...
    Wt = {
        ...
        return {
          ...
          cell: function (e) {
            ...
            return (
              ...
              ue(t, "height"),
              1 !== e.colspan() && ue(e.element(), "width"),
              i(e.element(), t),
              t
            );
          },
      ...
      paste: function (e) {
        return { row: Nt(e), cell: Dt, replace: Et, gap: Dt };
      },
    },
    _t = function (e, n) {
      var t = n.column(),
    ...
    Lt = function (e, n) {
      for (var t = !0, r = b(It, n), o = n.startRow(); o <= n.finishRow(); o++)
    ...
    jt = kt,
    zt = function (n, e, t) {
      return kt(n, e, t).bind(function (e) {
        return Lt(n, e);
      });
    },
    Ht = function (r, e, o, i) {
      return mt.findItem(r, e, kn).bind(function (e) {
    ...
    Yt = function (e, n, t, r, o) {
      var i = qt(e),
        u = kn(e, t) ? Me.some(n) : Ut(i, n),
        c = kn(e, o) ? Me.some(r) : Ut(i, r);
  ...
  function $t() {
    return {
      up: D({ selector: Jn, closest: et, predicate: $n, all: be }),
      down: D({ selector: Be, predicate: Kn }),
      styles: D({ get: oe, getRaw: ie, set: te, remove: ue }),
      attrs: D({
        get: V,
        set: U,
        remove: Y,
  ...
  function Jt(e, n, t) {
    ...
    return C(r, b(e.eq, t)).map(function (e) {
      return { before: D(r.slice(0, e)), after: D(r.slice(e + 1)) };
    });
  }
  function Qt(e, n) {
    return b(e.eq, n);
  ...
  function Zt(n, e, t, r) {
    ...
    return { firstpath: D(c), secondpath: D(a), shared: D(l) };
  }
  function er(e) {
    return Jn(e, "table");
  }
  function nr(c, a, r) {
    function l(n) {
      return function (e) {
        return (r !== undefined && r(e)) || kn(e, n);
      };
    }
    return kn(c, a)
      ? Me.some(sr.create({ boxes: Me.some([c]), start: c, finish: a }))
      : er(c).bind(function (u) {
          return er(a).bind(function (i) {
            if (kn(u, i))
              return Me.some(
                sr.create({ boxes: Gt(u, c, a), start: c, finish: a })
              );
            if (Bn(u, i)) {
              var e =
                0 < (n = Ie(a, "td,th", l(u))).length ? n[n.length - 1] : a;
              return Me.some(
                sr.create({ boxes: Yt(u, c, u, a, i), start: c, finish: e })
              );
            }
            if (Bn(i, u)) {
              var n,
                t = 0 < (n = Ie(c, "td,th", l(i))).length ? n[n.length - 1] : c;
              return Me.some(
                sr.create({ boxes: Yt(i, c, u, a, i), start: c, finish: t })
              );
            }
            return fr
              .ancestors(c, a)
              ...
              .bind(function (e) {
                return et(e, "table", r).bind(function (e) {
                  var n = Ie(a, "td,th", l(e)),
                    t = 0 < n.length ? n[n.length - 1] : a,
                    r = Ie(c, "td,th", l(e)),
                    o = 0 < r.length ? r[r.length - 1] : c;
                  return Me.some(
                    sr.create({ boxes: Yt(e, c, u, a, i), start: o, finish: t })
                  );
                });
              });
          });
  ...
  var or = B("left", "right"),
    ...
    ar = {
      ...
      ancestors: Zt,
      breakToLeft: function (t, r, o) {
        return Jt(t, r, o).map(function (e) {
          var n = t.create().clone(r);
          return (
            t.insert().appendAll(n, e.before().concat([o])),
            t.insert().appendAll(r, e.after()),
            t.insert().before(r, n),
            or(n, r)
          );
        });
      },
      breakToRight: function (t, r, e) {
        return Jt(t, r, e).map(function (e) {
          var n = t.create().clone(r);
          return (
            t.insert().appendAll(n, e.after()), t.insert().after(r, n), or(r, n)
          );
        });
      },
            ...
            : i
                ...
                .bind(function (r) {
                  return c(i, r, e).map(function (e) {
                    var n = [{ first: e.left, second: e.right }],
                      t = u(r) ? r : e.left();
      ...
      return Zn(e, n).bind(function (t) {
        return Zn(e, r).bind(function (n) {
          return fr.sharedOne(er, [t, n]).map(function (e) {
            return { first: D(t), last: D(n), table: D(e) };
          });
        });
      });
    },
      ...
      return pr(o, e, n).bind(function (t) {
        ...
        return n.bind(function (n) {
          return r.bind(function (e) {
            return kn(n, e) ? Kt(t.table(), t.first(), t.last()) : Me.none();
          });
        });
      });
    },
    ...
    Tr = function (t, e) {
      return Rr.cata(
        ...
        function (n, e) {
          return 0 === n.length
            ? Me.none()
            : vr(t, Cr.firstSelectedSelector(), Cr.lastSelectedSelector()).bind(
                function (e) {
                  return 1 < n.length
                    ? Me.some({ bounds: D(e), cells: D(n) })
                    : Me.none();
                }
              );
        },
    ...
    Or = function (e, n) {
      ...
      return 0 < t.length &&
        A(t, function (e) {
          return (
            (G(e, "rowspan") && 1 < parseInt(V(e, "rowspan"), 10)) ||
            (G(e, "colspan") && 1 < parseInt(V(e, "colspan"), 10))
          );
        })
        ? Me.some(t)
        : Me.none();
    ...
    Nr = {
      registerEvents: function (c, e, a, l) {
        c.on("BeforeGetContent", function (n) {
          ...
          c.on("BeforeSetContent", function (u) {
            !0 === u.selection &&
              !0 === u.paste &&
              Me.from(c.dom.getParent(c.selection.getStart(), "th,td")).each(
                function (e) {
                  var i = on.fromDom(e);
  ...
  function jr(e) {
    ...
    return n ? Lr(n, e, kr, _r) : kr(e);
  }
  function zr(e) {
    return ie(e, "width").fold(
      function () {
  ...
  var Qr = Ir("height", function (e) {
      var n = e.dom();
      return ee(e) ? n.getBoundingClientRect().height : n.offsetHeight;
    }),
    Zr = Ir("width", function (e) {
      return e.dom().offsetWidth;
    }),
    eo = me(),
    no = function (e) {
      return eo.browser.isIE() || eo.browser.isEdge()
        ? (function (e) {
            ...
            return "border-box" === oe(e, "box-sizing")
              ? i
              : i - n - t - (r + o);
          })(e)
        : Wr(e, "height", kr(e));
    ...
    uo = {
      ...
      setPixelWidth: function (e, n) {
        te(e, "width", n + "px");
      },
      setPercentageWidth: function (e, n) {
        te(e, "width", n + "%");
      },
      setHeight: _r,
      ...
      getGenericWidth: function (e) {
        return zr(e).bind(function (e) {
          var n = to.exec(e);
          return null !== n
            ? Me.some({ width: D(parseFloat(n[1])), unit: D(n[3]) })
            : Me.none();
        });
      },
      setGenericWidth: function (e, n, t) {
        te(e, "width", n + t);
      },
  ...
  function Ao(n, t) {
    ...
    var e = n[t].fold(
        ...
        function (e) {
          return Me.some({ value: e, delta: 0 });
        }
      ),
      r = n[t + 1].fold(
        function () {
        ...
        function (e) {
          return Me.some({ value: e, delta: 1 });
        }
      );
  ...
  function ko(e, n, t, r, o, i) {
    ...
    })(e, 0 < t.length ? o.positions(t, n) : [], u, Mr(n)),
      (function (e, n, r, o) {
        Io(e, n, function (e, n) {
      ...
      return a(u, e)
        .map(function (e) {
          var n = (function (e, n) {
            ...
            t = c(n, e, kn, s(o)),
            r = _o(t.grid(), o);
          return { grid: D(r), cursor: t.cursor };
        })
        .fold(
          function () {
            return Me.none();
  ...
  function Ho(n, e) {
    var t = g(e.selection(), function (e) {
      ...
      r = vo(t);
    return 0 < r.length
      ? Me.some({ cells: r, generators: e.generators, clipboard: e.clipboard })
      : Me.none();
  }
  function Fo(n, e) {
    var t = g(e.selection(), function (e) {
  ...
  function Yo(e, n, t, r) {
    return (
      pu.getCellElement(e[n], t) !== undefined &&
      0 < n &&
      r(pu.getCellElement(e[n - 1], t), pu.getCellElement(e[n], t))
    );
  }
  function Ko(e, n, t) {
  ...
  function Zo(e, n, t, r, o) {
    ...
    return g(i, function (e, n) {
      return e.filter(d(Hu.hasColspan)).fold(
        function () {
          var e = Ao(u, n);
          return r(e);
        },
  ...
  function ni(e, n, t, r) {
    ...
    return g(o, function (e, n) {
      return e.filter(d(Hu.hasRowspan)).fold(
        function () {
          var e = Ao(i, n);
          return r(e);
        },
  ...
  function ki(e, n, t, r) {
    e.fire("ObjectResizeStart", { target: n, width: t, height: r });
  }
  function Bi(e, n, t, r) {
    e.fire("ObjectResized", { target: n, width: t, height: r });
  }
  function Pi(n, e) {
    function t(e) {
  ...
  function Li(e, n, t) {
    ...
    Wi(i, t),
      ...
      Nc(e, o),
      Ic(e, o),
      t.halign && Ac(e, o, t.halign),
      t.valign && Ec(e, o, t.valign);
  }
  function ji(t, e, r) {
    var o = t.dom;
    Dc.each(e, function (e) {
      r.celltype &&
        e.nodeName.toLowerCase() !== r.celltype &&
        (e = o.rename(e, r.celltype));
      var n = qc.ifTruthy(o, e);
      Wi(n, r),
        Ri(t) && _i(n, r),
        r.halign && Ac(t, e, r.halign),
        r.valign && Ec(t, e, r.valign);
    });
  }
  function zi(e, n, t) {
    var r = t.getData();
  ...
  function Hi(t, e, r, n) {
    ...
    t.undoManager.transact(function () {
      Dc.each(e, function (e) {
        i.type !== e.parentNode.nodeName.toLowerCase() &&
          (function (e, n, t) {
        ...
        var n = u(o, e);
        n.setAttrib("scope", i.scope),
          n.setAttrib("class", i["class"]),
          n.setStyle("height", yi(i.height)),
          Ti(t) &&
            (function (e, n) {
              e.setStyle("background-color", n.backgroundcolor),
                e.setStyle("border-color", n.bordercolor),
          ...
          i.align !== r.align && (Nc(t, e), Ac(t, e, i.align));
      }),
        t.focus();
    });
  }
    ...
    for (var c = [], a = 0; a < e; a++) {
      for (var l = on.fromTag("tr"), f = 0; f < n; f++) {
        ...
        f < r && U(s, "scope", "row"),
          a < t && U(s, "scope", "col"),
          Mn(s, on.fromTag("br")),
          o.percentages && te(s, "width", 100 / n + "%"),
          Mn(l, s);
      }
      c.push(l);
    }
    ...
    e.close(),
      ...
      t.undoManager.transact(function () {
        ...
        !(function (e, n, t) {
          ...
          if (
            ((o["class"] = t["class"]),
            (i.height = yi(t.height)),
            r.getAttrib(n, "width") && !Di(e)
              ? (o.width = (function (e) {
                  return e ? e.replace(/px$/, "") : "";
                })(t.width))
              : (i.width = yi(t.width)),
            Di(e)
              ? ((i["border-width"] = yi(t.border)),
                (i["border-spacing"] = yi(t.cellspacing)))
              : ((o.border = t.border),
                (o.cellpadding = t.cellpadding),
                (o.cellspacing = t.cellspacing)),
            Di(e) && n.children)
          )
            for (var u = 0; u < n.children.length; u++)
              na(r, n.children[u], {
                ...
                Oi(e) &&
                  na(r, n.children[u], { "border-color": t.bordercolor });
          Oi(e) &&
            ((i["background-color"] = t.backgroundcolor),
            (i["border-color"] = t.bordercolor),
            (i["border-style"] = t.borderstyle)),
            (o.style = r.serializeStyle($c(xi(e), i))),
            r.setAttribs(n, $c(Si(e), o));
        })(t, r, u),
          (o = i.select("caption", r)[0]) && !u.caption && i.remove(o),
          !o &&
            u.caption &&
            (((o = i.create("caption")).innerHTML = Jc.ie
              ? "\xa0"
              : '<br data-mce-bogus="1"/>'),
            r.insertBefore(o, r.firstChild)),
          "" === u.align ? Nc(t, r) : Ac(t, r, u.align),
          t.focus(),
          t.addVisual();
      });
  }
  function Vi(n) {
    return function (e) {
      return Me.from(e.dom.getParent(e.selection.getStart(), n)).map(
        on.fromDom
      );
    };
  }
  ...
  function Yi(e, n, t, r, o) {
    ...
    return e.dom().addEventListener(n, i, o), { unbind: b(sa, e, n, i, o) };
  }
  function Ki(e, n, t) {
  ...
  var Xi,
                ...
                return (
                  ...
                  p(e.cells(), function (e) {
                    e.isNew() && u.push(e.element()),
                      wo(e.element(), "colspan", e.colspan(), 1),
                      wo(e.element(), "rowspan", e.rowspan(), 1),
                      Mn(n, e.element());
                  }),
                  n
                );
    ...
    Qi = function (e) {
      return g(e, function (e) {
        ...
        return (
          p(e.cells(), function (e) {
            var n = Tt(e.element());
            wo(n, "colspan", e.colspan(), 1),
              wo(n, "rowspan", e.rowspan(), 1),
              Mn(t, n);
          }),
          t
        );
    ...
    tu = { resolve: Eo("ephox-snooker").resolve },
    ru = function (e, n, t, r, o) {
      ...
      return (
        ...
        q(i, { "data-column": e, role: "presentation" }),
        i
      );
    },
    ou = function (e, n, t, r, o) {
      var i = on.fromTag("div");
      return (
        re(i, {
          position: "absolute",
        ...
        q(i, { "data-row": e, role: "presentation" }),
        i
      );
    },
    ...
    pu = {
      ...
      setCells: gu,
      mutateCell: function (e, n, t) {
        e.cells()[n] = t;
      },
      getCell: Po,
      getCellElement: function (e, n) {
        return Po(e, n).element();
      },
      mapCells: function (e, n) {
        var t = e.cells(),
          r = g(t, n);
    ...
    hu = function (e, n, t, r) {
      var o = (function (e, n) {
        ...
        c = Mo(u, r);
      return { colspan: D(i), rowspan: D(c) };
    },
    vu = function (o, i) {
      ...
      return g(o, function (e, r) {
        var n = x(e.cells(), function (e, n) {
          ...
          return (
            (function (e, n, t, r) {
              for (var o = e; o < e + t; o++)
                for (var i = n; i < n + r; i++) u[o][i] = !0;
            })(r, n, t.rowspan(), t.colspan()),
            [zn(e.element(), t.rowspan(), t.colspan(), e.isNew())]
          );
        });
    ...
    Su = function (e, n, t) {
      if (e.row() >= n.length || e.column() > pu.cellLength(n[0]))
        return Cu.error(
      ...
      var r = n.slice(e.row()),
        ...
        i = pu.cellLength(t[0]),
        u = t.length;
      return Cu.value({ rowDelta: D(r.length - u), colDelta: D(o.length - i) });
    },
    xu = function (e, n) {
      var t = pu.cellLength(e[0]),
        r = pu.cellLength(n[0]);
      return { rowDelta: D(0), colDelta: D(t - r) };
    },
    Ru = function (e, n, t) {
      var r = n.colDelta() < 0 ? Vo : o;
      return (n.rowDelta() < 0 ? qo : o)(
        r(e, Math.abs(n.colDelta()), t),
        Math.abs(n.rowDelta()),
        t
      );
    },
          ...
          for (
            ...
            for (var p = s; p < m; p++) {
              (i = n),
                ...
                (c = p),
                (l = a = void 0),
                (a = b(o, pu.getCell(i[u], c).element())),
                (l = i[u]),
                1 < i.length &&
                  1 < pu.cellLength(l) &&
                  ((0 < c && a(pu.getCellElement(l, c - 1))) ||
                    (c < l.cells().length - 1 &&
                      a(pu.getCellElement(l, c + 1))) ||
                    (0 < u && a(pu.getCellElement(i[u - 1], c))) ||
                    (u < i.length - 1 && a(pu.getCellElement(i[u + 1], c)))) &&
                  Ou(n, pu.getCellElement(n[g], p), o, r.cell);
    ...
    Nu = function (t, r, e, o, i) {
      var n = t.slice(0, r),
        u = t.slice(r),
        c = pu.mapCells(t[e], function (e, n) {
          return 0 < r &&
            r < t.length &&
            o(pu.getCellElement(t[r - 1], n), pu.getCellElement(t[r], n))
            ? pu.getCell(t[r], n)
            : Un(i(e.element(), o), !0);
        });
      return n.concat([c]).concat(u);
    },
    Iu = function (e, t, r, o, i) {
      return g(e, function (e) {
        var n =
          0 < t &&
          t < pu.cellLength(e) &&
          o(pu.getCellElement(e, t - 1), pu.getCellElement(e, t))
            ? pu.getCell(e, t)
            : Un(i(pu.getCellElement(e, r), o), !0);
        return pu.addCell(e, t, n);
      });
    },
    ku = function (e, r, o, i, u) {
      var c = o + 1;
      return g(e, function (e, n) {
        var t =
          n === r ? Un(u(pu.getCellElement(e, o), i), !0) : pu.getCell(e, o);
        return pu.addCell(e, c, t);
      });
    },
    Bu = function (e, n, t, r, o) {
      var i = n + 1,
        u = e.slice(0, i),
        c = e.slice(i),
    ...
    Fu = {
      getRawWidths: function (e, n, t) {
        return Zo(e, n, Jo, ei, t);
      },
      getPixelWidths: function (e, n, t) {
        return Zo(
          e,
          n,
          uo.getPixelWidth,
      ...
      getPercentageWidths: function (e, n, t) {
        return Zo(
          e,
          n,
          uo.getPercentageWidth,
          function (e) {
            return e.fold(
              function () {
    ...
    Uu = function (e, t) {
      ...
      return g(n, function (e) {
        ...
        return { element: e.element, width: D(n), colspan: e.colspan };
      });
    },
    qu = function (e, t) {
      var n = mt.justCells(e);
      return g(n, function (e) {
        ...
        return { element: e.element, height: D(n), rowspan: e.rowspan };
      });
    },
    Vu = function (e, t) {
      return g(e.all(), function (e, n) {
        return { element: e.element, height: D(t[n]) };
      });
    },
    Gu = function (n) {
      return uo.getRawWidth(n).fold(
        function () {
          var e = Pr(n);
          return ri(e);
        },
    ...
    Qu = function (n, t) {
      ...
      function o(e) {
        var n = r(e);
        return (
          i.get().isNone() && i.set(Me.some(n)),
          (u = Me.some({ item: e, replacement: n })),
          n
        );
      }
      var i = R(Me.none()),
    ...
    ec = function (t) {
      ...
      return {
        combine: function (n) {
          return (
            e.get().isNone() && e.set(Me.some(n)),
            function () {
              var e = t.cell({ element: D(n), colspan: D(1), rowspan: D(1) });
    ...
    mc = {
      ...
      insertColumnBefore: jo(
        function (e, n, t, r) {
          var o = n.column(),
            i = n.column(),
            u = Iu(e, i, o, t, r.getOrInit);
          return gi(u, n.row(), i);
        },
        zo,
        dc,
      ...
      splitCellIntoColumns: jo(
        function (e, n, t, r) {
          var o = ku(e, n.row(), n.column(), t, r.getOrInit);
        ...
        function (e, t, n, r) {
          var o,
            ...
            a =
              ...
              bu(c, i, !0)),
            l = Ln(t.row(), t.column());
          return Au(l, e, a, t.generators(), n).fold(
            function () {
      ...
      var o = function (e, t) {
        return (
          ...
          Dc.each(e, function (e) {
            ...
            e.menu ? (n.menu = o(e.menu)) : ((n.value = e.value), r && r(n)),
              t.push(n);
          }),
          t
        );
        ...
        fn(
          {
            ...
            cellspacing:
              u.getStyle(n, "border-spacing") || u.getAttrib(n, "cellspacing"),
            cellpadding:
              u.getAttrib(n, "cellpadding") || kc(e.dom, n, "padding"),
            border:
              ((r = u),
              (o = n),
              (i = ie(on.fromDom(o), "border-width")),
              Di(e) && i.isSome()
                ? i.getOr("")
                : r.getAttrib(o, "border") ||
                  kc(e.dom, o, "border-width") ||
                  kc(e.dom, o, "border")),
    ...
    Hc = function (e, n) {
      var t,
        ...
        l = n
          ? ((t = a),
            (r = k(u, "border-style").getOr("")),
            (o = k(u, "border-color").getOr("")),
            (i = k(u, "background-color").getOr("")),
            { borderstyle: r, bordercolor: f(o), backgroundcolor: f(i) })
          : {};
      function f(e) {
    ...
    Vc = function (n) {
      var e,
        t = [];
      if (
        ((t = n.dom.select("td[data-mce-selected],th[data-mce-selected]")),
        (e = n.dom.getParent(n.selection.getStart(), "td,th")),
        !t.length && e && t.push(e),
        (e = e || t[0]))
      ) {
        var r = Dc.map(t, function (e) {
          ...
          i = {
            type: "tabpanel",
            tabs: [
              { title: "General", name: "general", items: Uc(n) },
              _c("cell"),
            ],
          },
          u = {
            type: "panel",
            items: [{ type: "grid", columns: 2, items: Uc(n) }],
          };
    ...
    Kc = function (n) {
      var e,
        ...
        o = [];
      if (
        (e = r.getParent(n.selection.getStart(), "table")) &&
        ((t = r.getParent(n.selection.getStart(), "td,th")),
        Dc.each(e.rows, function (n) {
          Dc.each(n.cells, function (e) {
            if (
              (r.getAttrib(e, "data-mce-selected") || e === t) &&
              o.indexOf(n) < 0
            )
              return o.push(n), !1;
          });
        ...
        var i = Dc.map(o, function (e) {
          ...
          c = {
            type: "tabpanel",
            tabs: [
              { title: "General", name: "general", items: Yc(n) },
              _c("row"),
            ],
          },
          a = {
            type: "panel",
            items: [{ type: "grid", columns: 2, items: Yc(n) }],
          };
        n.windowManager.open({
    ...
    $c =
      ...
      function () {
        ...
        for (var t = {}, r = 0; r < e.length; r++) {
          var o = e[r];
          for (var i in o) Xc.call(o, i) && (t[i] = Xi(t[i], o[i]));
        }
        return t;
      }),
    ...
    Zc = function (n, e, t) {
      ...
      return (
        n.insertContent(u),
        Zn(gc(n), 'table[data-mce-id="__mce"]')
          .map(function (e) {
            return (
              Ei(n) && te(e, "width", oe(e, "width")),
              Y(e, "data-mce-id"),
              (function (n, e) {
                p(Be(e, "tr"), function (e) {
                  Ni(n, e.dom()),
                    p(Be(e, "th,td"), function (e) {
                      Ii(n, e.dom());
                    });
                });
              })(n, e),
    ...
    na = function (e, n, t, r) {
      if ("TD" === n.tagName || "TH" === n.tagName)
        _e(t) ? e.setStyle(n, t, r) : e.setStyle(n, t);
      else if (n.children)
        for (var o = 0; o < n.children.length; o++) na(e, n.children[o], t, r);
    },
    ta = function (e, n) {
      var t,
        r = e.dom,
        o = Hc(e, Oi(e));
      !1 === n
        ? (t = r.getParent(e.selection.getStart(), "table"))
          ? (o = Lc(e, t, Oi(e)))
          : Oi(e) &&
            ((o.borderstyle = ""),
            (o.bordercolor = ""),
      ...
      i &&
        o["class"] &&
        (o["class"] = o["class"].replace(/\s*mce\-item\-table\s*/g, ""));
      var u = { type: "grid", columns: 2, items: ea(e, i, n) },
        c = Oi(e)
          ? {
              type: "tabpanel",
              tabs: [
                { title: "General", name: "general", items: [u] },
                _c("table"),
              ],
            }
          : { type: "panel", items: [u] };
    ...
    ia = Dc.each,
    ua = {
      registerCommands: function (c, n, a, l, t) {
        function f(e) {
          return lt.table(e, s);
        }
        function i(e) {
          return { width: bi(e.dom()), height: bi(e.dom()) };
        }
        function r(o) {
              ...
              o(n, e).each(function (e) {
                !(function (e, n, t) {
                  ...
                  (n.width === r.width && n.height === r.height) ||
                    (ki(e, t.dom(), n.width, n.height),
                    Bi(e, t.dom(), r.width, r.height));
                })(c, t, n),
    ...
    ca = function (e) {
      ...
      return { parent: D(n), view: D(e), origin: D(lo(0, 0)) };
    },
    aa = function (e, n) {
      return { parent: D(n), view: D(e), origin: D(lo(0, 0)) };
    },
    ...
    fa = {
      create: function (e) {
        return {
          registry: I(e, function (e) {
            return { bind: e.bind, unbind: e.unbind };
          }),
          trigger: I(e, function (e) {
            return e.trigger;
          }),
        };
      },
    ...
    da = D(!0),
    ma = { resolve: Eo("ephox-dragster").resolve },
    ...
    va = ga({
      ...
      sink: function (e, n) {
        var t = (function (e) {
            var n = $c({ layerClass: ma.resolve("blocker") }, e),
              t = on.fromTag("div");
            U(t, "role", "presentation"),
              re(t, {
                position: "fixed",
                left: "0px",
                top: "0px",
  ...
  function ya() {
    var t = fa.create({ drag: la(["xDelta", "yDelta", "target"]) }),
      r = Me.none(),
      e = (function () {
        var t = fa.create({ drag: la(["xDelta", "yDelta"]) });
        return {
          mutate: function (e, n) {
            t.trigger.drag(e, n);
          },
  ...
  function Sa(o, n, i) {
    ...
    function a(e, n) {
      m.trigger.startAdjust(),
        t.assign(e),
        U(e, "data-initial-" + n, parseInt(oe(e, n), 10)),
        Ro(e, hl),
        te(e, "opacity", "0.2"),
        r.go(o.parent());
    }
        ...
        t.get().each(function (r) {
          u.each(function (t) {
            e(r, "data-row").each(function (e) {
              var n = c(r, "top");
              Y(r, "data-initial-top"),
                m.trigger.adjustHeight(t, n, parseInt(e, 10));
            }),
              e(r, "data-column").each(function (e) {
                var n = c(r, "left");
                Y(r, "data-initial-left"),
                  m.trigger.adjustWidth(t, n, parseInt(e, 10));
              }),
              au(o, t, i, n);
          });
        });
    ...
    var s = Ki(o.parent(), "mousedown", function (e) {
        du(e.target()) && a(e.target(), "top"),
          mu(e.target()) && a(e.target(), "left");
      }),
  ...
  function Aa(e, n, t) {
    return n(
      on.fromDom(t.startContainer),
      t.startOffset,
      on.fromDom(t.endContainer),
      t.endOffset
    );
  }
  function Ea(e, n) {
    return (function (e, n) {
      ...
      return t.collapsed
        ? n
            ...
            .map(function (e) {
              return Il.rtl(
                on.fromDom(e.endContainer),
                e.endOffset,
                on.fromDom(e.startContainer),
                e.startOffset
              );
            })
            .getOrThunk(function () {
              return Aa(0, Il.ltr, t);
            })
        : Aa(0, Il.ltr, t);
    })(
      0,
  ...
  function La(e, n) {
    var t = e.fold(Dl.before, _a, Dl.after),
      r = n.fold(Dl.before, _a, Dl.after);
    return El.relative(t, r);
  }
  function ja(e, n, t, r) {
    var o = _a(e, n),
      i = _a(t, r);
    return El.relative(o, i);
  }
  function za(e, n, t, r) {
  ...
  function Ua(u, e) {
    return Ea(u, e).match({
      ...
      rtl: function (e, n, t, r) {
        ...
        if (o.setBaseAndExtent) o.setBaseAndExtent(e.dom(), n, t.dom(), r);
        else if (o.extend)
          try {
  ...
  function qa(e) {
    ...
    return Ea(o, t).match({ ltr: n, rtl: n });
  }
  function Va(e) {
    var n = on.fromDom(e.anchorNode),
      t = on.fromDom(e.focusNode);
    return za(n, e.anchorOffset, t, e.focusOffset)
      ? Me.some(Tl.create(n, e.anchorOffset, t, e.focusOffset))
      : (function (e) {
          if (0 < e.rangeCount) {
  ...
  function Ya(e) {
    return (function (e) {
      return Me.from(e.getSelection())
        .filter(function (e) {
          return 0 < e.rangeCount;
        })
        .bind(Va);
    })(e).map(function (e) {
      return El.exact(e.start(), e.soffset(), e.finish(), e.foffset());
    });
  }
  function Ka(e, n) {
    return (function (e) {
  ...
  function Xa(e, n, t) {
    return (function (e, n, t) {
      ...
      return Pl(r, n, t).map(function (e) {
        return Tl.create(
          on.fromDom(e.startContainer),
          e.startOffset,
          on.fromDom(e.endContainer),
  ...
  function $a(e, n, t, r) {
    return Wl(e, n, xl(t), r);
  }
  function Ja(e, n, t, r) {
    return Wl(e, n, Rl(t), r);
  }
  function Qa(e, n) {
    var t = El.exact(n, 0, n, 0);
    return qa(t);
  }
  function Za(e, n) {
    return (function (e) {
  ...
  function tl(e, n) {
    return (function (e, n, t) {
      return Ql(e, n, nl(e), t);
    })(ef, e, n);
  }
  function rl(e, n) {
    return (function (e, n, t) {
      return Zl(e, n, nl(e), t);
    })(ef, e, n);
  }
  function ol(e) {
    return et(e, "tr");
  ...
  function ul(n, e, t, r) {
    return (function (e, n) {
      return Se(e, n)
        .filter(il)
        .orThunk(function () {
          return Se(e, n - 1).filter(il);
        });
    })(e, t).bind(function (e) {
      return r.traverse(e).fold(
        function () {
          return cf(e, r.gather, n).map(r.relative);
        },
        function (e) {
          return (function (r) {
            return ve(r).bind(function (n) {
              var t = Ce(n);
              return uf(t, r).map(function (e) {
                return of(n, t, r, e);
              });
            });
          })(e).map(function (e) {
            return Dl.on(e.parent(), e.index());
          });
        }
      );
    });
  ...
  function ll(n, e, t) {
    return (function (e, n, t) {
      ...
      return mf(n, e).exists(function (e) {
        return (function (e, n) {
          return (
            e.left() < n.left() ||
            Math.abs(n.right() - e.left()) < 1 ||
            e.left() > n.right()
          );
        })(t, e);
      });
  ...
  function fl(n, t, e) {
    var r = n.move(e, 5),
      o = vf(t, n, e, r, 100).getOr(r);
    return (function (e, n, t) {
      return e.point(n) > t.getInnerHeight()
        ? Me.some(e.point(n) - t.getInnerHeight())
        : e.point(n) < 0
        ? Me.some(-e.point(n))
        : Me.none();
    })(n, o, t).fold(
  ...
  var gl = function (n, t, e) {
      function r() {
        l.stop(), u.isOn() && (u.off(), i.trigger.stop());
      }
      var o = !1,
        i = fa.create({ start: la([]), stop: la([]) }),
        u = wa(),
        c = (function (t, r) {
          var o = null;
          return {
    ...
    hl = tu.resolve("resizer-bar-dragging"),
    vl = function (e, t) {
      var r = go.height,
        n = Sa(e, t, r),
        o = fa.create({
      ...
      return (
        u.on("init", function () {
          ...
          if (
            ...
            var t = vl(n, e);
            t.on(),
              t.events.startDrag.bind(function (e) {
    ...
    Sl = fn(fn({}, Cl), {
      none: function (e) {
        return void 0 === e && (e = undefined), Cl.none(e);
      },
    }),
    xl = function (n, e) {
      return Ra(n, e).fold(
    ...
    Tl = { create: B("start", "soffset", "finish", "foffset") },
    Ol = Sr([
      { before: ["element"] },
      { on: ["element", "offset"] },
      { after: ["element"] },
    ...
    El = {
      domRange: Al.domRange,
      relative: Al.relative,
      exact: Al.exact,
      exactFromRange: function (e) {
        return Al.exact(e.start(), e.soffset(), e.finish(), e.foffset());
      },
      getWin: function (e) {
        return (function (e) {
      ...
      return tn(n)
        ...
        : (function (n, e, t, r) {
            ...
            return bo(i, function (e) {
              return (
                o.selectNode(e.dom()),
                Na(o.getBoundingClientRect(), t, r) ? Bl(n, e, t, r) : Me.none()
              );
            });
          })(e, n, t, r);
    },
    Pl = document.caretPositionFromPoint
      ? function (t, e, n) {
          return Me.from(t.dom().caretPositionFromPoint(e, n)).bind(function (
            e
          ) {
    ...
    Ml = tinymce.util.Tools.resolve("tinymce.util.VK"),
    Wl = function (r, e, n, o, t) {
      return n.fold(
        Me.none,
        Me.none,
        function (e, n) {
    ...
    _l = ["table", "li", "dl"],
    Ll = {
      handle: function (n, t, r, o) {
        if (n.keyCode === Ml.TAB) {
          var i = gc(t),
            u = function (e) {
              var n = en(e);
              return kn(e, i) || l(_l, n);
            },
          ...
          if (e.collapsed) {
            ...
            lt.cell(c, u).each(function (e) {
              n.preventDefault(),
                (n.shiftKey ? Ja : $a)(t, u, e, r, o).each(function (e) {
    ...
    jl = { create: B("selection", "kill") },
    zl = function (e, n, t, r) {
      return { start: D(Dl.on(e, n)), finish: D(Dl.on(t, r)) };
    },
    Hl = {
      convertToRange: function (e, n) {
        var t = kl(e, n);
        return Tl.create(
          on.fromDom(t.startContainer),
          t.startOffset,
    ...
    Fl = function (t, e, r, n, o) {
      return kn(r, n)
        ? Me.none()
        : dr(r, n, e).bind(function (e) {
            var n = e.boxes().getOr([]);
            return 0 < n.length
              ? (o(t, n, e.start(), e.finish()),
                Me.some(jl.create(Me.some(Hl.makeSitus(r, 0, r, wt(r))), !0)))
              : Me.none();
          });
    },
    Ul = {
      sync: function (t, r, e, n, o, i, u) {
        return kn(e, o) && n === i
          ? Me.none()
          : et(e, "td,th", r).bind(function (n) {
      ...
      update: function (e, n, t, r, o) {
        return gr(
          ...
          return (
            o.clearBeforeUpdate(t),
            o.selectRange(t, e.boxes(), e.start(), e.finish()),
            e.boxes()
          );
        });
      },
    ...
    Yl = [
      { current: el, next: Vl, fallback: Me.none() },
      { current: Vl, next: Gl, fallback: Me.some(el) },
      { current: Gl, next: Gl, fallback: Me.some(Vl) },
    ],
    Kl = function (n, t, r, o, e) {
      return (
        void 0 === e && (e = Yl),
        y(e, function (e) {
          return e.current === r;
    ...
    Jl = function (n, e, t, r, o, i) {
      return Kl(n, e, r, o).bind(function (e) {
        return i(e.item())
          ? Me.none()
          : t(e.item())
          ? Me.some(e.item())
          : Jl(n, e.item(), t, e.mode(), o, i);
      });
    },
    Ql = function (e, n, t, r) {
      return Jl(e, n, t, Vl, Xl(), r);
    },
    Zl = function (e, n, t, r) {
      return Jl(e, n, t, Vl, $l(), r);
    },
    ef = $t(),
    nf = B("element", "offset"),
    tf =
      (B("element", "deltaOffset"),
          ...
          .bind(function (e) {
            return et(n, "td,th", u).map(function (n) {
              return kn(e, n)
                ? kn(r, e) && wt(e) === o
                  ? i(n)
                  : tf.none("in same cell")
                : fr.sharedOne(ol, [e, n]).fold(
                    function () {
                      return (function (e, n, t) {
                        var r = e.getRect(n),
                          o = e.getRect(t);
    ...
    of =
      (B("ancestor", "descendants", "element", "index"),
      B("parent", "children", "element", "index")),
    uf = function (e, n) {
      return C(e, b(kn, n));
    },
    cf = function (e, n, t) {
      return n(e, t).bind(function (e) {
        return tn(e) && 0 === ht(e).trim().length ? cf(e, n, t) : Me.some(e);
      });
    },
    af = function (e, n, t, r) {
      return (il(n)
        ? (function (e, n, t) {
            return t
              .traverse(n)
              .orThunk(function () {
                return cf(n, t.gather, e);
              })
              .map(t.relative);
          })(e, n, r)
        : ul(e, n, t, r)
      ).map(function (e) {
        return { start: D(e), finish: D(e) };
      });
    },
    lf = function (e) {
      return rf.cata(
        ...
        function (e) {
          return Me.some(nf(e, 0));
        },
        function (e) {
          return Me.some(nf(e, wt(e)));
        }
      );
    },
    ff = Xe(["left", "top", "right", "bottom"], []),
    sf = {
      nu: ff,
      moveUp: function (e, n) {
        return ff({
      ...
      moveBottomTo: function (e, n) {
        var t = e.bottom() - e.top();
        return ff({ left: e.left(), top: n - t, right: e.right(), bottom: n });
      },
      moveTopTo: function (e, n) {
        var t = e.bottom() - e.top();
        return ff({ left: e.left(), top: n, right: e.right(), bottom: n + t });
      },
      getTop: function (e) {
        return e.top();
      },
    ...
    df = function (e, n, t) {
      return nn(n)
        ...
        ? (function (e, n, t) {
            return 0 <= t && t < wt(n)
              ? e.getRangedRect(n, t, n, t + 1)
              : 0 < t
              ? e.getRangedRect(n, t - 1, n, t)
              : Me.none();
          })(e, n, t).map(cl)
        : Me.none();
    },
    mf = function (e, n) {
      return nn(n)
        ? al(e, n).map(cl)
        : tn(n)
        ? e.getRangedRect(n, 0, n, wt(n)).map(cl)
        : Me.none();
    },
    gf = Sr([{ none: [] }, { retry: ["caret"] }]),
    pf = {
      point: sf.getTop,
      adjuster: function (e, n, t, r, o) {
        ...
        return Math.abs(t.top() - r.top()) < 1
          ...
          ? gf.retry(i)
          : t.bottom() === o.top()
          ? gf.retry(sf.moveUp(o, 1))
          : ll(e, n, o)
          ? gf.retry(sf.translate(i, 5, 0))
          : gf.none();
      },
      move: sf.moveUp,
      gather: tl,
    ...
    hf = {
      point: sf.getBottom,
      adjuster: function (e, n, t, r, o) {
        var i = sf.moveDown(o, 5);
        return Math.abs(t.bottom() - r.bottom()) < 1
          ? gf.retry(i)
          : t.top() > o.bottom()
          ? gf.retry(i)
          : t.top() === o.bottom()
          ? gf.retry(sf.moveDown(o, 1))
          : ll(e, n, o)
          ? gf.retry(sf.translate(i, 5, 0))
          : gf.none();
      },
              ...
              function (n) {
                return mf(t, n)
                  .bind(function (e) {
                    return r
                      .adjuster(t, n, e, o, i)
                      .fold(Me.none, function (e) {
                        return vf(t, r, o, e, u - 1);
                      });
                  })
                  .orThunk(function () {
                    return Me.some(i);
    ...
    wf = me(),
    yf = function (r, o, i, u, c, a) {
      return 0 === a
        ? Me.none()
        : xf(r, o, i, u, c).bind(function (e) {
            var n = r.fromSitus(e),
              t = rf.verify(r, i, u, n.finish(), n.foffset(), c.failure, o);
            return rf.cata(
              t,
              function () {
                return Me.none();
              ...
              function (e) {
                return kn(i, e) && 0 === u
                  ? Cf(r, i, u, sf.moveUp, c)
                  : yf(r, o, e, 0, c, a - 1);
              },
              function (e) {
                return kn(i, e) && u === wt(e)
                  ? Cf(r, i, u, sf.moveDown, c)
                  : yf(r, o, e, wt(e), c, a - 1);
              }
            );
          });
    ...
    Cf = function (n, e, t, r, o) {
      return df(n, e, t).bind(function (e) {
        return Sf(n, o, r(e, bf.getJumpSize()));
      });
    },
    Sf = function (e, n, t) {
      return wf.browser.isChrome() ||
        wf.browser.isSafari() ||
        wf.browser.isFirefox() ||
        wf.browser.isEdge()
        ? n.otherRetry(e, t)
        : wf.browser.isIE()
        ? n.ieRetry(e, t)
    ...
    xf = function (n, e, t, r, o) {
      return df(n, t, r).bind(function (e) {
        return Sf(n, o, e);
      });
    },
    Rf = function (n, t, r) {
      return (function (o, i, u) {
        return o.getSelection().bind(function (r) {
          return af(i, r.finish(), r.foffset(), u).fold(
            function () {
              return Me.some(nf(r.finish(), r.foffset()));
            },
            function (e) {
              var n = o.fromSitus(e),
                t = rf.verify(
        ...
        return yf(n, t, e.element(), e.offset(), r, 20).map(n.fromSitus);
      });
    },
    Tf = me(),
    Of = function (e, n, t, r, o, i) {
      return Tf.browser.isIE()
        ? Me.none()
        : i(r, n).orThunk(function () {
            return dl(e, n, t, r, o).map(function (e) {
              var n = e.range();
              return jl.create(
                Me.some(
                  Hl.makeSitus(n.start(), n.soffset(), n.finish(), n.foffset())
                ),
                !0
              );
            });
    ...
    Df = function (e, n, t, r, o, i, u) {
      return dl(e, t, r, o, i).bind(function (e) {
        return Ul.detect(n, t, e.start(), e.finish(), u);
      });
    },
    Af = function (e, r) {
        ...
        return et(t, "table", r).bind(function (e) {
          ...
          return kn(t, n[0])
            ? (function (e, n, t) {
                ...
                var n = wt(e);
                return jl.create(Me.some(Hl.makeSitus(e, n, e, n)), !0);
              })
            : Me.none();
        });
      });
        ...
        return et(t, "table", r).bind(function (e) {
          ...
          return kn(t, n[n.length - 1])
            ? (function (e, n, t) {
                ...
                return jl.create(Me.some(Hl.makeSitus(e, 0, e, 0)), !0);
              })
            : Me.none();
        });
      });
  ...
  function If(i) {
    return {
      elementFromPoint: function (e, n) {
        return on.fromPoint(on.fromDom(i.document), e, n);
      },
      getRect: function (e) {
        return e.dom().getBoundingClientRect();
      },
      getRangedRect: function (e, n, t, r) {
        var o = El.exact(e, n, t, r);
        return Ka(i, o).map(_f);
      },
      getSelection: function () {
        return Ya(i).map(function (e) {
          return Hl.convertToRange(i, e);
        });
      },
      fromSitus: function (e) {
        var n = El.relative(e.start(), e.finish());
        return Hl.convertToRange(i, n);
      },
      situsFromPoint: function (e, n) {
        return Xa(i, e, n).map(function (e) {
          return zl(e.start(), e.soffset(), e.finish(), e.foffset());
        });
      },
      ...
      setSelection: function (e) {
        !(function (e, n, t, r, o) {
          var i = ja(n, t, r, o);
          Ua(e, i);
        })(i, e.start(), e.soffset(), e.finish(), e.foffset());
      },
  ...
  var Bf = {
      down: {
        ...
        gather: rl,
        relative: Dl.before,
        otherRetry: bf.tryDown,
        ieRetry: bf.ieTryDown,
        failure: rf.failedDown,
      },
      up: {
        traverse: we,
        gather: tl,
    ...
    Mf = Nf(40),
    Wf = {
      ltr: { isBackward: Nf(37), isForward: Nf(39) },
      rtl: { isBackward: Nf(39), isForward: Nf(37) },
      isUp: Pf,
      isDown: Mf,
    ...
    Lf = (me().browser.isSafari(), B("rows", "cols")),
    jf = me(),
    zf = {
      mouse: function (e, n, t, r) {
        var o = (function c(o, i, n, u) {
          ...
          return {
            mousedown: function (e) {
              u.clear(i), (r = ml(e.target(), n));
            },
            mouseover: function (e) {
              r.each(function (r) {
                u.clearBeforeUpdate(i),
                  ml(e.target(), n).each(function (t) {
                    dr(r, t, n).each(function (e) {
                      var n = e.boxes().getOr([]);
                      (1 < n.length || (1 === n.length && !kn(r, t))) &&
                        (u.selectRange(i, n, e.start(), e.finish()),
                        o.selectContents(t));
                    });
                  });
              });
        ...
        return {
          keydown: function (e, n, t, r, o, i) {
            var u = e.raw(),
              c = u.which,
              a = !0 === u.shiftKey;
            return mr(l, s.selectedSelector()).fold(
              function () {
                return Wf.isDown(c) && a
                  ? b(Df, m, l, f, Bf.down, r, n, s.selectRange)
                  : Wf.isUp(c) && a
                  ? b(Df, m, l, f, Bf.up, r, n, s.selectRange)
                  : Wf.isDown(c)
                  ? b(Of, m, f, Bf.down, r, n, Ef)
                  : Wf.isUp(c)
                  ? b(Of, m, f, Bf.up, r, n, Af)
                  : Me.none;
              },
              function (n) {
                function e(e) {
                  return function () {
                    return bo(e, function (e) {
                      return Ul.update(e.rows(), e.cols(), l, n, s);
                    }).fold(
                      function () {
                        return pr(
                          l,
                          ...
                          var n =
                            Wf.isDown(c) || i.isForward(c)
                              ? Dl.after
                              : Dl.before;
                          return (
                            m.setRelativeSelection(
                              Dl.on(e.first(), 0),
                              n(e.table())
                            ),
                            s.clear(l),
                      ...
                      function (e) {
                        return Me.some(jl.create(Me.none(), !0));
                      }
                    );
                  };
                }
          ...
          keyup: function (t, r, o, i, u) {
            return mr(l, s.selectedSelector()).fold(function () {
              var e = t.raw(),
                n = e.which;
              return !1 == (!0 === e.shiftKey)
                ? Me.none()
                : Wf.isNavigation(n)
                ? Ul.sync(l, f, r, o, i, u, s.selectRange)
                : Me.none();
            }, Me.none);
          },
        };
      },
      external: function (e, r, n, o) {
        var i = If(e);
        return function (e, t) {
          o.clearBeforeUpdate(r),
            dr(e, t, n).each(function (e) {
              var n = e.boxes().getOr([]);
              o.selectRange(r, n, e.start(), e.finish()),
                jf.deviceType.isTouch()
                  ? i.clearSelection()
                  : i.selectContents(t);
            });
        };
      ...
      byAttr: function (o, i, n) {
        ...
        return {
          ...
          selectRange: function (e, n, t, r) {
            c(e),
              p(n, u),
              U(t, o.firstSelected(), "1"),
              U(r, o.lastSelected(), "1"),
              i(n, t, r);
          },
          selectedSelector: o.selectedSelector,
          firstSelectedSelector: o.firstSelectedSelector,
          ...
          return {
            ...
            downOrRightCells: (function (e, t, n) {
              ...
              return x(o, function (e) {
                var n = e
                  .cells()
                  .slice(t[0].column() + t[0].colspan() - 1, +e.cells().length);
                return g(n, function (e) {
                  return e.element();
                });
              });
  ...
  function qf(w, y, e) {
    ...
    w.on("init", function (e) {
      var r = w.getWin(),
        ...
        n = pc(w),
        t = zf.mouse(r, o, n, x),
        c = zf.keyboard(r, o, n, x),
        i = zf.external(r, o, n, x);
      ...
      function u(e) {
        var n = v(e);
        if (n.raw().shiftKey && Wf.isNavigation(n.raw().which)) {
      ...
      function l(e) {
        ...
        var t = w.selection.getRng(),
          ...
          u = bc.directionAt(r).isRtl() ? Wf.rtl : Wf.ltr;
      ...
      w.on("mousedown", d),
        ...
        (S = Me.some(
          C({ mousedown: d, mouseover: m, mouseup: g, keyup: u, keydown: l })
        ));
    });
    return {
      clear: x.clear,
  ...
  var Vf = function (n) {
      return {
        get: function () {
          var e = gc(n);
          return hr(e, Cr.selectedSelector()).fold(
            function () {
              return n.selection.getStart() === undefined
                ? Rr.none()
                : Rr.single(n.selection);
            },
            function (e) {
  ...
  function $f(n) {
    var e = Vf(n),
      t = Gf(n, e),
      r = yl(n),
      o = qf(n, r.lazyResize, t),
      i = Tc(n, r.lazyWire),
      u = R(Me.none());
    ua.registerCommands(n, i, o, e, u), Nr.registerEvents(n, e, i, o);
    var c = Kf.addMenuItems(n, t);
    return (
      Yf.addButtons(n, t),
      Yf.addToolbars(n),
      n.on("PreInit", function () {
        n.serializer.addTempAttr(Cr.firstSelected()),
          n.serializer.addTempAttr(Cr.lastSelected());
      }),
      Cc(n) &&
        n.on("keydown", function (e) {
          Ll.handle(e, n, i, r.lazyWire);
        }),
