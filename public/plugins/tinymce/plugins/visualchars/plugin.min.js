...
!(function (r) {
  ...
  function y(n, e) {
    return (function (n, e, t) {
      var r = T(n, e).concat([t]);
      return p(n, e, r.join(" ")), !0;
    })(n, "class", e);
  }
  function b(n, e) {
    return (function (n, e, t) {
      ...
      return 0 < r.length ? p(n, e, r.join(" ")) : E(n, e), !1;
    })(n, "class", e);
  }
  function D(n) {
    0 ===
  ...
  function w(u, n) {
    var e = W.filterDescendants(F.fromDom(n), W.isMatch);
    v(e, function (n) {
      var e = n.dom().parentNode;
      if (_(e))
        !(function (n, e) {
          O(n) ? n.dom().classList.add(e) : y(n, e);
        })(F.fromDom(e), H.nbspClass);
      else {
        for (
          var t = W.replaceWithSpans(h(n)),
            r = u.dom.create("div", null, t),
            o = void 0;
          (o = r.lastChild);

        )
          u.dom.insertAfter(o, n.dom());
        u.dom.remove(n.dom());
      }
    });
  }
  function M(e, n) {
    var t = e.dom.select(H.selector, n);
    v(t, function (n) {
      _(n)
        ? (function (n, e) {
            O(n) ? n.dom().classList.remove(e) : b(n, e);
            D(n);
          })(F.fromDom(n), H.nbspClass)
        : e.dom.remove(n, !0);
    });
  }
  function S(t, r) {
  ...
  var k,
    ...
    I = function (n) {
      return null === n || n === undefined ? l : x(n);
    },
    L = N("string"),
    P = N("boolean"),
    B = N("function"),
    ...
    F = {
      ...
      fromPoint: function (n, e, t) {
        var r = n.dom();
        return I(r.elementFromPoint(e, t)).map(q);
      },
    },
    G = { "\xa0": "nbsp", "\xad": "shy" },
    H = {
    ...
    z = function (n, e) {
      var t = [],
        r = (function (n, e) {
          ...
          return r;
        })(n.dom().childNodes, F.fromDom);
      return (
        v(r, function (n) {
          e(n) && (t = t.concat([n])), (t = t.concat(z(n, e)));
        }),
        t
      );
    },
    W = {
      isMatch: function (n) {
        return j(n) && h(n) !== undefined && H.regExp.test(h(n));
      },
      filterDescendants: z,
      ...
      replaceWithSpans: function (n) {
        return n.replace(H.regExpGlobal, Y);
      },
    },
    K = w,
    X = M,
      ...
      return (
        ...
        (function (n, e) {
          n.ui.registry.addToggleButton("visualchars", {
            ...
            icon: "visualchars",
            onAction: function () {
              return n.execCommand("mceVisualChars");
            },
            onSetup: S(n, e),
          }),
            n.ui.registry.addToggleMenuItem("visualchars", {
