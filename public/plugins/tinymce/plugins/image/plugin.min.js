...
!(function (s) {
  ...
  function L(a) {
    return function () {
      ...
      for (var n = {}, r = 0; r < t.length; r++) {
        var i = t[r];
        for (var o in i) wt.call(i, o) && (n[o] = a(n[o], i[o]));
      }
      return n;
    };
  }
  ...
  function G(t) {
    H(t)
      ...
      : (function (t) {
          var e = zt.create("figure", { class: "image" });
          zt.insertAfter(e, t),
            e.appendChild(t),
            e.appendChild(
              zt.create("figcaption", { contentEditable: "true" }, "Caption")
            ),
  ...
  function Q(t, e) {
    ...
    return (
      B(n, "style", e.style),
      (!R(n) && "" === e.hspace) || J(n, e.hspace),
      (!F(n) && "" === e.vspace) || V(n, e.vspace),
      (!k(n) && "" === e.border) || X(n, e.border),
      (!(function (t) {
  ...
  function ot(e, t) {
    var n = (function (t, e) {
      var n = s.document.createElement("img");
      if ((Mt(t, _t(e, { caption: !1 }), n), B(n, "alt", e.alt), e.caption)) {
        var r = zt.create("figure", { class: "image" });
        return (
          r.appendChild(n),
          r.appendChild(
            zt.create("figcaption", { contentEditable: "true" }, "Caption")
  ...
  var lt = C.exports.boltExport,
    ...
    Ut = function (t) {
      return { title: "General", name: "general", items: N(t) };
    },
    xt = N,
    ...
    Mt = function (t, e, n) {
      ...
      tt(n, r, e, "caption", function (t, e, n) {
        ...
        tt(n, r, e, "alt", B),
        tt(n, r, e, "title", B),
        tt(n, r, e, "width", q(0, t)),
        tt(n, r, e, "height", q(0, t)),
        tt(n, r, e, "class", B),
        tt(
          n,
          r,
        ...
        tt(n, r, e, "hspace", et(J, t)),
        tt(n, r, e, "vspace", et(V, t)),
        tt(n, r, e, "border", et(X, t)),
        tt(n, r, e, "borderStyle", et(Z, t));
    },
  ...
  function Jt(a) {
    function e(t, e, n, r) {
      var i, o;
      (i = new s.XMLHttpRequest()).open("POST", a.url),
        (i.withCredentials = a.credentials),
        ...
        (i.onload = function () {
          ...
          i.status < 200 || 300 <= i.status
            ? n("HTTP Error: " + i.status)
            : (t = JSON.parse(i.responseText)) && "string" == typeof t.location
            ? e(
                (function (t, e) {
                  return t
                    ? t.replace(/\/$/, "") + "/" + e.replace(/^\//, "")
            ...
            : n("Invalid JSON: " + i.responseText);
        }),
        (o = new s.FormData()).append("file", t.blob(), t.filename()),
        i.send(o);
    }
    return (
      (a = Ht.extend({ credentials: !1, handler: e }, a)),
      {
        upload: function (t) {
          return !a.url &&
            (function (t) {
            ...
            ? It.reject("Upload url missing from the settings.")
            : (function (r, i) {
                return new It(function (t, e) {
                  try {
                    i(r, t, e, o);
    ...
    if (r !== undefined) {
      ...
      !(function (t, e, n) {
        t.hasDescription && T(n.alt) && (e.alt = n.alt),
          ...
          T(n["class"]) &&
            $t(t.classList, n["class"]).each(function (t) {
              e.classes = t.value;
            }),
          t.hasImageCaption && x(n.caption) && (e.caption = n.caption),
          t.hasAdvTab &&
          ...
          return t.hasAdvTab || t.hasUploadUrl || t.hasUploadHandler
            ? {
                ...
                tabs: v([
                  [Ut(t)],
                  t.hasAdvTab ? [ae(t)] : [],
                  t.hasUploadTab && (t.hasUploadUrl || t.hasUploadHandler)
                    ? [ue(t)]
                    : [],
                ]),
              }
            : { type: "panel", items: xt(t) };
        })(t),
        buttons: [
    ...
    return function (t) {
      for (
        ...
        void 0,
          (e = i.attr("class")) &&
            /\bimage\b/.test(e) &&
            (i.attr("contenteditable", o ? "false" : null),
            Ht.each(i.getAll("figcaption"), r));
      }
    };
  }
  var ae = function (t) {
    ...
    le = function (t) {
      t.on("PreInit", function () {
        t.parser.addNodeFilter("figure", oe(!0)),
          t.serializer.addNodeFilter("figure", oe(!1));
      });
    },
    se = function (e) {
