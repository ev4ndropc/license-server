...
!(function (c) {
    ...
    g =
      void 0 !== t
        ...
        : "undefined" != typeof WorkerGlobalScope &&
          c.self instanceof WorkerGlobalScope
        ? c.self
        : {},
    i = (function () {
      var u = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
        S = (g.Prism = {
            ...
            clone: function (e) {
              switch (S.util.type(e)) {
                case "Object":
                  var t = {};
                  for (var n in e)
                    e.hasOwnProperty(n) && (t[n] = S.util.clone(e[n]));
                  return t;
                case "Array":
                  return (
                    e.map &&
          ...
          highlightElement: function (e, t, n) {
            ...
            i &&
              ((a = (i.className.match(u) || [, ""])[1]), (r = S.languages[a])),
              (e.className =
          ...
          hooks: {
            ...
            run: function (e, t) {
              var n = S.hooks.all[e];
              if (n && n.length)
                for (var a = 0, r = void 0; (r = n[a++]); ) r(t);
            },
          },
        }),
            ...
            g.addEventListener(
              ...
              function (e) {
                var t = JSON.parse(e.data),
                  ...
                  a = t.code,
                  r = t.immediateClose;
                g.postMessage(S.highlight(a, S.languages[n], n)),
                  r && g.close();
              },
              !1
            ),
  ...
  void 0 !== n && (n.Prism = i),
    ...
    i.languages.insertBefore("csharp", "keyword", {
    ...
    i.languages.insertBefore("php", "operator", {
  ...
  function y(e) {
    ...
    return u.isCodeSample(t) ? w.some(t) : w.none();
  }
  var v,
    k = function (n) {
      function e() {
    ...
    w = {
      ...
      none: s,
      from: function (e) {
        return null === e || e === undefined ? f : k(e);
      },
    },
    x = y,
    S = function (t, n, a) {
      t.undoManager.transact(function () {
        ...
        return (
          ...
          e.fold(
            function () {
              t.insertContent(
                '<pre id="__new" class="language-' + n + '">' + a + "</pre>"
              ),
    ...
    W = function (t) {
      t.addCommand("codesample", function () {
        ...
        t.selection.isCollapsed() || u.isCodeSample(e)
          ? P(t)
    ...
    T = function (n) {
      n.ui.registry.addToggleButton("codesample", {
        icon: "code-sample",
          ...
          function t() {
            e.setActive(
              (function (e) {
                ...
                return e.dom.is(t, "pre.language-markup");
              })(n)
            );
          }
          return (
            n.on("NodeChange", t),
            function () {
              return n.off("NodeChange", t);
            }
          );
        },
      }),
        n.ui.registry.addMenuItem("codesample", {
          text: "Code sample...",
          icon: "code-sample",
          onAction: function () {
            return P(n);
