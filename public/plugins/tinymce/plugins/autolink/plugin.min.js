  ...
  var t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    r = function (t, e, n) {
      var i,
        ...
        g = y(t),
        h = k(t);
      if ("A" !== t.selection.getNode().tagName) {
        if ((i = t.selection.getRng(!0).cloneRange()).startOffset < 5) {
          ...
          if (((l = c.length), C(i, c, l), m(i, c, l), i.endOffset < 5)) return;
          (o = i.endOffset), (f = c);
        } else {
          if (3 !== (f = i.endContainer).nodeType && f.firstChild) {
            for (; 3 !== f.nodeType && f.firstChild; ) f = f.firstChild;
            3 === f.nodeType && (C(i, f, 0), m(i, f, f.nodeValue.length));
          }
        ...
        !(function (t, e) {
          return t === e || " " === t || 160 === t.charCodeAt(0);
        })(i.toString(), n)
          ? (0 === i.startOffset ? C(i, f, 0) : C(i, f, o), m(i, f, r))
          : (C(i, f, o), m(i, f, r), (o += 1)),
          "." === (s = i.toString()).charAt(s.length - 1) && m(i, f, r - 1),
          (d = (s = i.toString().trim()).match(g)) &&
            ...
            !1 !== h && t.dom.setAttrib(t.selection.getNode(), "target", h),
