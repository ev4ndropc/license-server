...
!(function (j) {
  ...
  function xe(e) {
    return (
      (e.nodeType !== Dt && e.nodeType !== _t) || 0 === e.childElementCount
    );
  }
  function ze(e, t) {
    return e.dom() === t.dom();
  ...
  var Pe,
    ...
    ct = {
      unknown: function () {
        return st({ current: undefined, version: et.unknown() });
      },
      nu: st,
      windows: $(ot),
      ios: $("iOS"),
      ...
      getPos: function (e, t, n) {
        ...
        if (((n = n || e), t)) {
          if (
            ...
            "static" === ve(yt.fromDom(e), "position")
          )
            return {
              x: (i =
          ...
          for (r = t.parentNode; r && r !== n && r.nodeType && !He(r, n); )
            (i -= r.scrollLeft || 0),
              ...
              (r = r.parentNode);
          a += (function (e) {
            return Ot.isFirefox() && "table" === ie(e)
              ? Oe(Re(e))
                  .filter(function (e) {
                    return "caption" === ie(e);
                  })
      ...
      : ((Ft =
        ...
        (tn.all = function () {
          var s = Array.prototype.slice.call(
            1 === arguments.length && Ft(arguments[0])
              ? arguments[0]
              : arguments
          );
        ...
        (tn.resolve = function (t) {
          return t && "object" == typeof t && t.constructor === tn
            ? t
            : new tn(function (e) {
                e(t);
              });
    ...
    try {
      ...
      if (e && ("object" == typeof e || "function" == typeof e)) {
        ...
        if ("function" == typeof t)
          return void sn(en(t, e), en(rn, this), en(on, this));
      }
  ...
  function gn(e, t) {
    return t
      ? !("array" !== t || !kn.isArray(e)) || typeof e === t
      : e !== undefined;
  }
  var pn = {
    ...
    kn = {
      ...
      toArray: function (e) {
        var t,
          n,
          r = e;
        if (!Sn(e)) for (r = [], t = 0, n = e.length; t < n; t++) r[t] = e[t];
        return r;
      },
      each: dn,
      map: function (n, r) {
        ...
        return e.replace(Zn, function (e, t) {
          return t
            ? 65535 <
              ...
              : er[t] || String.fromCharCode(t)
            : Pn[e] ||
                On[e] ||
                (function (e) {
                  var t;
                  return (
                    ((t = yt.fromTag("div").dom()).innerHTML = e),
    ...
    mr = function (e) {
      ...
      return ar[e]
        ...
        : ((u = "id accesskey class dir lang style tabindex title role"),
          ...
          cr(hr("a form meter progress dfn"), function (e) {
  ...
  function pr(i) {
    function e(e, t, n) {
      ...
      return (
        r
          ? (r = sr(r, /[, ]/, sr(r.toUpperCase(), /[, ]/)))
          : (r = ar[e]) ||
            ((r = sr(t, " ", sr(t.toUpperCase(), " "))),
            (r = lr(r, n)),
            (ar[e] = r)),
        r
      );
    ...
    (r = mr((i = i || {}).schema)),
      ...
      (t = gr(i.valid_styles)),
      (n = gr(i.invalid_styles, "map")),
      (c = gr(i.valid_classes, "map")),
      (o = e(
        "whitespace_elements",
    ...
    function C(e) {
      var a = /^(~)?(.+)$/;
      e &&
        ((ar.text_block_elements = ar.block_elements = null),
        cr(hr(e, ","), function (e) {
          var t = a.exec(e),
            n = "~" === t[1],
            r = n ? "span" : "div",
          ...
          if (
            ...
            var i = z[r];
            delete (i = lr({}, i)).removeEmptyAttrs,
    ...
    i.valid_elements
      ...
      : (cr(r, function (e, t) {
        ...
        "html5" !== i.schema &&
          cr(hr("strong/b em/i"), function (e) {
        ...
        cr(
          hr("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
          function (e) {
            z[e].paddEmpty = !0;
          }
        ),
      ...
      i.invalid_elements &&
        cr(fr(i.invalid_elements), function (e) {
          z[e] && delete z[e];
        }),
  ...
  function Cr(e, t) {
    ...
    if (
      ...
      e && zr.test(e.type) && e.pageX === undefined && e.clientX !== undefined)
    ) {
    ...
    return (
      ...
      !(r.stopImmediatePropagation = function () {
        ...
        ((r.isDefaultPrevented = Nr),
        (r.isPropagationStopped = Nr),
        (r.isImmediatePropagationStopped = Nr)),
  ...
  var xr = function (b, e) {
    ...
    kr =
      ((Tr.prototype.bind = function (e, t, n, r) {
        function o(e) {
          ...
          if (((s = this.events[r]), t)) {
            ...
            for (i = c.length; i--; )
              if ((o = s[(u = c[i])])) {
                ...
                (n && 0 !== o.length) ||
                  (delete s[u],
                  br(e, o.fakeName || u, o.nativeHandler, o.capture));
              }
          } else {
            for (u in s)
  ...
  try {
    uo.apply((oo = so.call(Yr.childNodes)), Yr.childNodes),
      oo[Yr.childNodes.length].nodeType;
  } catch (vN) {
    uo = {
      apply: oo.length
        ? function (e, t) {
  ...
  var Ao = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Yr) !== Ur && Fr(t),
      (n = n || []),
      !e || "string" != typeof e)
    )
      return n;
    ...
    if (qr && !r) {
      if ((o = No.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && Rr.getElementsByClassName)
            return uo.apply(n, t.getElementsByClassName(a)), n;
        }
  ...
  function Mo() {
    ...
    return function r(e, t) {
      return (
        n.push(e + " ") > Dr.cacheLength && delete r[n.shift()],
        (r[e + " "] = t)
      );
    };
  }
  ...
  for (Mr in ((Rr = Ao.support = {}),
  (Br = Ao.isXML = function (e) {
  ...
  (Fr = Ao.setDocument = function (e) {
    var t,
      ...
      n = s.defaultView;
    return s !== Ur && 9 === s.nodeType && s.documentElement
      ? ((jr = (Ur = s).documentElement),
        (qr = !Br(s)),
        n &&
          n !==
            (function r(e) {
        ...
        (Rr.attributes = !0),
        (Rr.getElementsByTagName = !0),
        (Rr.getElementsByClassName = Eo.test(s.getElementsByClassName)),
        (Rr.getById = !0),
        (Dr.find.ID = function (e, t) {
        ...
        (Dr.find.TAG = Rr.getElementsByTagName
          ? function (e, t) {
              if (typeof t.getElementsByTagName != no)
        ...
        (Dr.find.CLASS =
          Rr.getElementsByClassName &&
          function (e, t) {
            if (qr) return t.getElementsByClassName(e);
          }),
        (Wr = []),
        ($r = []),
        (Rr.disconnectedMatch = !0),
        ($r = $r.length && new RegExp($r.join("|"))),
        (Wr = Wr.length && new RegExp(Wr.join("|"))),
        (t = Eo.test(jr.compareDocumentPosition)),
        (Kr =
          t || Eo.test(jr.contains)
            ? function (e, t) {
                ...
                (1 &
                  (n =
                    (e.ownerDocument || e) === (t.ownerDocument || t)
                      ...
                      : 1) ||
                (!Rr.sortDetached && t.compareDocumentPosition(e) === n)
                  ? e === s || (e.ownerDocument === Yr && Kr(Yr, e))
                    ? -1
                    : t === s || (t.ownerDocument === Yr && Kr(Yr, t))
                    ? 1
                    : Vr
                    ? co.call(Vr, e) - co.call(Vr, t)
                    : 0
                  : 4 & n
                  ? -1
                  : 1)
  ...
  (Ao.matchesSelector = function (e, t) {
    if (
      ...
      (t = t.replace(yo, "='$1']")),
      Rr.matchesSelector && qr && (!Wr || !Wr.test(t)) && (!$r || !$r.test(t)))
    )
      try {
        var n = (void 0).call(e, t);
        if (
          n ||
          Rr.disconnectedMatch ||
  ...
  (Ao.attr = function (e, t) {
    ...
    var n = Dr.attrHandle[t.toLowerCase()],
      r =
        n && ro.call(Dr.attrHandle, t.toLowerCase()) ? n(e, t, !qr) : undefined;
    return r !== undefined
      ? r
      : Rr.attributes || !qr
      ? e.getAttribute(t)
  ...
  (Ao.uniqueSort = function (e) {
    var t,
      ...
      o = 0;
    if (
      ((Ir = !Rr.detectDuplicates),
      (Vr = !Rr.sortStable && e.slice(0)),
      e.sort(to),
      Ir)
    ) {
  ...
  ((Dr = Ao.selectors = {
    ...
    preFilter: {
      ATTR: function (e) {
        return (
          (e[1] = e[1].replace(To, Ar)),
          (e[3] = (e[3] || e[4] || e[5] || "").replace(To, Ar)),
          "~=" === e[2] && (e[3] = " " + e[3] + " "),
          e.slice(0, 4)
        );
      },
    ...
    filter: {
      ...
      CLASS: function (e) {
        ...
        return (
          t ||
          ((t = new RegExp("(^|" + lo + ")" + e + "(" + lo + "|$)")) &&
            Qr(e, function (e) {
              return t.test(
                ("string" == typeof e.className && e.className) ||
                  (typeof e.getAttribute != no && e.getAttribute("class")) ||
                  ""
              );
            }))
        );
        ...
        return 1 === m && 0 === g
          ...
          : function (e, t, n) {
              ...
              if (l) {
                ...
                } else if (d && (r = (e[Xr] || (e[Xr] = {}))[h]) && r[0] === Gr)
                  a = r[1];
                else
                  for (
                    ;
      ...
      PSEUDO: function (e, i) {
        var t,
          a =
            Dr.pseudos[e] ||
            Dr.setFilters[e.toLowerCase()] ||
            Ao.error("unsupported pseudo: " + e);
        return a[Xr]
          ? a(i)
          : 1 < a.length
          ? ((t = [e, e, "", i]),
            Dr.setFilters.hasOwnProperty(e.toLowerCase())
              ? Ro(function (e, t) {
    ...
    pseudos: {
      ...
      lang: Ro(function (n) {
        return (
          Co.test(n || "") || Ao.error("unsupported lang: " + n),
          (n = n.replace(To, Ar).toLowerCase()),
          function (e) {
            var t;
            do {
              if (
  ...
  { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
    Dr.pseudos[Mr] = _o(Mr);
  for (Mr in { submit: !0, reset: !0 }) Dr.pseudos[Mr] = Bo(Mr);
  function Po() {}
  function Lo(e) {
    ...
    return (
      ...
      Ro(function (e, t, n, r) {
        var o,
          ...
          d = p ? (y || (e ? m : c || v) ? [] : t) : f;
        if ((p && p(f, d, n, r), v))
          for (o = Fo(d, s), v(o, [], n, r), i = o.length; i--; )
            (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
        if (e) {
          if (y || m) {
            if (y) {
  ...
  (Po.prototype = Dr.filters = Dr.pseudos),
    (Dr.setFilters = new Po()),
    (Or = Ao.tokenize = function (e, t) {
      var n,
        r,
        o,
        i,
      ...
      for (a = e, u = [], s = Dr.preFilter; a; ) {
        for (i in ((n && !(r = po.exec(a))) ||
          (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
        (n = !1),
        (r = vo.exec(a)) &&
          ((n = r.shift()),
          o.push({ value: n, type: r[0].replace(go, " ") }),
          (a = a.slice(n.length))),
        Dr.filter))
          Dr.filter.hasOwnProperty(i) &&
            (!(r = wo[i].exec(a)) ||
              (s[i] && !(r = s[i](r))) ||
              ((n = r.shift()),
          ...
          (function a(p, v) {
            function e(e, t, n, r, o) {
              ...
              if (((s += c), y && c !== s)) {
                ...
                if (e) {
                  if (0 < s) for (; c--; ) l[c] || f[c] || (f[c] = io.call(r));
                  f = Fo(f);
                }
                uo.apply(r, f),
                  o &&
    ...
    (Pr = Ao.select = function (e, t, n, r) {
      ...
      if (((n = n || []), 1 === l.length)) {
        if (
          ...
          9 === t.nodeType &&
          qr &&
          Dr.relative[i[1].type]
        ) {
          if (!(t = (Dr.find.ID(a.matches[0].replace(To, Ar), t) || [])[0]))
            return n;
          c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
        }
        for (
          o = wo.needsContext.test(e) ? 0 : i.length;
          o-- && ((a = i[o]), !Dr.relative[(u = a.type)]);

        )
          if (
            (s = Dr.find[u]) &&
            (r = s(
              a.matches[0].replace(To, Ar),
              (So.test(i[0].type) && Ho(t.parentNode)) || t
            ))
          ) {
            if ((i.splice(o, 1), !(e = r.length && Lo(i))))
              return uo.apply(n, r), n;
            break;
          }
      }
      return (
        (c || Hr(e, l))(r, t, !qr, n, (So.test(e) && Ho(t.parentNode)) || t), n
      );
    }),
    (Rr.sortStable = Xr.split("").sort(to).join("") === Xr),
    (Rr.detectDuplicates = !!Ir),
    Fr(),
    (Rr.sortDetached = !0);
  function qo(e) {
    return void 0 !== e;
  ...
  var Zo = j.document,
    ...
    ii = function (e, t, n, r) {
      ...
      if ($o(t)) t = Wo(t, hi(e[0]));
        ...
        else for (o = 0; o < t.length; o++) ii(e, t[o], n, r);
        return e;
      }
    ...
    si = { for: "htmlFor", class: "className", readonly: "readOnly" },
    ci = { float: "cssFloat" },
    li = {},
    fi = {},
    di = /^\s*|\s*$/g,
  ...
  (Yo.fn = Yo.prototype = {
    ...
    add: function (e, t) {
      ...
      if (!1 !== t)
        for (
          n = vi.unique(this.toArray().concat(vi.makeArray(e))),
  ...
  function mi(e, t, n) {
    var r = [],
      o = e[t];
    for (
      "string" != typeof n && n instanceof vi && (n = n[0]);
      o && 9 !== o.nodeType;
  ...
  Jo(
    ...
    (Yo.fn.init.prototype = Yo.fn),
    (Yo.overrideDefaults = function (n) {
      var r,
        o = function (e, t) {
          return (
            (r = r || n()),
  ...
  function Ai(e, t) {
    Pi && D(e.dom().scrollIntoViewIfNeeded)
  ...
  var Ri,
    ...
    Li = function (e) {
      var t = e === undefined ? j.window : e,
        n = t.visualViewport;
      if (n !== undefined) return Mi(n.pageLeft, n.pageTop, n.width, n.height);
      var r = yt.fromDom(t.document),
        o = t.document.documentElement,
        i = ki(r),
        a = o.clientWidth,
        u = o.clientHeight;
      return Mi(i.left(), i.top(), a, u);
    },
    Vi = Mn.each,
    Ii = Mn.grep,
    Fi = Nn.ie,
  ...
  function Ki(a, u) {
      ...
      return n
        ...
        : ("float" ===
            (t = t.replace(/-(\D)/g, function (e, t) {
              return t.toUpperCase();
            })) && (t = Nn.browser.isIE() ? "styleFloat" : "cssFloat"),
    ...
    function y(e, n, r) {
      ...
      if (!t) return !1;
      if (Mn.isArray(t) && (t.length || 0 === t.length))
        return (
          (o = []),
          Vi(t, function (e, t) {
    ...
    function N(t, e, n) {
      return y(e, function (e) {
        return (
          Mn.is(e, "array") && (t = t.cloneNode(!0)),
          n &&
            Vi(Ii(e.childNodes), function (e) {
              t.appendChild(e);
            }),
    ...
    var T = {},
            ...
            if (2 !== l.status)
              if (3 !== l.status) {
                if (
                  ...
                  g.referrerPolicy &&
                    Tt(yt.fromDom(u), "referrerpolicy", g.referrerPolicy),
                  "onload" in u &&
                    !(
      ...
      F = {
        ...
        loadCSS: function (e) {
          var n;
          F === Ki.DOM || a !== j.document
            ? ((e = e || ""),
              (n = a.getElementsByTagName("head")[0]),
              Vi(e.split(","), function (e) {
                var t;
                (e = Mn._addCacheSuffix(e)),
                  M[e] ||
                    ((M[e] = !0),
        ...
        getOuterHTML: function (e) {
          ...
          return Ge.isElement(t)
            ? t.outerHTML
            : vi("<div></div>").append(vi(t).clone()).html();
        },
        ...
        split: function (e, t, n) {
          ...
          if (e && t)
            return (
              a.setStart(e.parentNode, Wi(e)),
              a.setEnd(t.parentNode, Wi(t)),
              (r = a.extractContents()),
              (a = S()).setStart(t.parentNode, Wi(t) + 1),
              a.setEnd(e.parentNode, Wi(e) + 1),
              (o = a.extractContents()),
              (i = e.parentNode).insertBefore(Xn.trimNode(F, r), e),
              n ? i.insertBefore(n, e) : i.insertBefore(t, e),
              i.insertBefore(Xn.trimNode(F, o), e),
              z(e),
              n || t
            );
        },
  ...
  var Xi = Ki,
    ...
    Ji = Mn.grep,
    Qi =
      ((Zi.prototype._setReferrerPolicy = function (e) {
  ...
  function Ma(e) {
    return (
      du(e) && (e = e.parentNode), fu(e) && e.hasAttribute("data-mce-caret")
    );
  }
  function Ra(e) {
  ...
  function Ba(e) {
    ...
    return (
      !(!e || !Ge.isText(t)) &&
      (t.data.charAt(e.offset()) === cu ||
        (e.isAtStart() && Ra(t.previousSibling)))
    );
  }
  function Oa(e) {
    var t = e.container();
    return (
      !(!e || !Ge.isText(t)) &&
      (t.data.charAt(e.offset() - 1) === cu ||
        (e.isAtEnd() && Ra(t.nextSibling)))
    );
  }
  function Ha(e, t, n) {
    var r, o;
  ...
  function La(e) {
    return (
      !xu(e) && (yu(e) ? !bu(e.parentNode) : Cu(e) || vu(e) || wu(e) || zu(e))
    );
  }
  function Va(e, t) {
    return (
  ...
  function ja(e, t) {
    return (
      ...
      (!(e.top > t.bottom) && Ua(t.top - e.bottom, e, t))
    );
  }
  function qa(e, t) {
    return (
      e.top > t.bottom || (!(e.bottom < t.top) && Ua(t.bottom - e.top, e, t))
    );
  }
  function $a(e, t, n) {
    ...
    Fu = function (e) {
      ...
      function t(e, t) {
        ...
        if (t < e.data.length) {
          ...
          if (
            Xa(e.data[t - 1]) &&
            (n.setStart(e, t), n.setEnd(e, t + 1), !Qa(n))
          )
            return r(eu(Iu(n), !1)), i;
        }
        0 < t &&
          (n.setStart(e, t - 1), n.setEnd(e, t), Qa(n) || r(eu(Iu(n), !1))),
          t < e.data.length &&
            (n.setStart(e, t), n.setEnd(e, t + 1), Qa(n) || r(eu(Iu(n), !0)));
      }
      var n,
        o,
        i = [];
      ...
      if (Au(e.container()))
        if (e.isAtEnd())
          (o = Lu(e.container(), e.offset())),
            Ou(o) && t(o, o.data.length),
            _u(o) && !Hu(o) && r(eu(Iu(o), !1));
        else {
          if (
            ((o = Lu(e.container(), e.offset())),
            Ou(o) && t(o, 0),
            ...
            return r(eu(Iu(o), !1)), i;
          (n = Lu(e.container(), e.offset() - 1)),
            _u(n) &&
              !Hu(n) &&
              ((!Ru(n) && !Ru(o) && _u(o)) || r(eu(Iu(n), !1))),
            _u(o) && r(eu(Iu(o), !0));
        }
      return i;
    };
  ...
  function qu(e) {
    return (
      (_s(e) ? "text()" : e.nodeName.toLowerCase()) +
      "[" +
      (function (e) {
        var r, t, n;
        return (
          (r = Ps(Hs(e))),
          (t = kn.findIndex(r, ju(e), e)),
          (r = r.slice(0, t + 1)),
          (n = kn.reduce(
            r,
            function (e, t, n) {
          ...
          (r = kn.filter(r, Ge.matchNodeNames([e.nodeName]))),
          (t = kn.findIndex(r, ju(e), e)) - n
        );
      })(e) +
      "]"
    );
  ...
  function $u(e, t) {
    ...
    return (
      ...
      _s(n)
        ? (o = (function (e, t) {
            for (; (e = e.previousSibling) && _s(e); ) t += e.data.length;
            return t;
          })(n, r))
        ...
        (r = kn.reduce(
          ...
          ? _s(r)
            ? (function (e, t) {
                ...
                return (
                  _s(e) && t > e.data.length && (t = e.data.length), Ds(e, t)
                );
              })(r, parseInt(o, 10))
            : ((o = "after" === o ? Os(r) + 1 : Os(r)), Ds(r.parentNode, o))
          : null)
      : null;
  }
  function Ku(e, t) {
  ...
  function Zu(e, t) {
    ...
    if (Da(e)) {
      if (
        (Ge.isText(e) && Ma(e) && (e = e.parentNode),
        (n = e.previousSibling),
        Ls(n))
      )
        return n;
  ...
  function es(e, t, n) {
    var r = n.getNode(),
      o = r ? r.nodeName : null,
      i = n.getRng();
    if (Ls(r) || "IMG" === o) return { name: o, index: Gu(n.dom, o, r) };
    var a = (function (e) {
      return (
        Zu(e.startContainer, e.startOffset) || Zu(e.endContainer, e.endOffset)
      );
    })(i);
    return a
      ? { name: (o = a.tagName), index: Gu(n.dom, o, a) }
      : (function (e, t, n, r) {
          var o = t.dom,
            i = {};
          return (
            (i.start = Yu(o, e, n, r, !0)),
            t.isCollapsed() || (i.end = Yu(o, e, n, r, !1)),
            i
          );
        })(e, n, t, i);
  }
  ...
  function ns(e, t) {
    var n = e.dom,
      ...
      a = e.getNode(),
      u = a.nodeName;
    if ("IMG" === u) return { name: u, index: Gu(n, u, a) };
    ...
    return Xu(n, r, l), e.moveToBookmark({ id: o, keep: 1 }), { id: o };
  }
  function rs(e) {
    ...
    var t,
      ...
      l = function () {
        t = pn.setInterval(function () {
          e()
            ? vi("div.mce-visual-caret", i).toggleClass(
                "mce-visual-caret-hidden"
              )
            : vi("div.mce-visual-caret", i).addClass("mce-visual-caret-hidden");
        }, 500);
      };
    return {
      show: function (t, e) {
        ...
        if (!a(e))
          return (
            (u = (function (e, t) {
              var n, r, o;
              if (
                ((r = e.ownerDocument.createTextNode(cu)),
                (o = e.parentNode),
                t)
              ) {
        ...
        var o = vi('<div class="mce-visual-caret" data-mce-bogus="all"></div>')
          .css(n)
          .appendTo(i)[0];
        return (
  ...
  function vs(e, t) {
    for (var n; (n = e(t)); ) if (!Gs(n)) return n;
    return null;
  }
  function ys(e, t, n, r, o) {
    ...
    if (ps(t)) {
      ...
      for (; (e = vs(i.prev, o)); ) if (n(e)) return e;
    }
    if (gs(t)) {
      if ((Ks(e) || Gs(e)) && n((e = vs(i.next, !0)))) return e;
      for (; (e = vs(i.next, o)); ) if (n(e)) return e;
    }
    return null;
  }
  function bs(e, t) {
  ...
  function Es(e, t, n) {
    ...
    if (Ge.isText(o)) {
      ...
      if (mu(o) && i >= o.data.length - 1)
        return 1 === e && (r = s(o)) ? Zs(r) : n;
  ...
  var Ms,
    ...
    js = function (e) {
      if (
        (Fs(e) &&
          Da(e) &&
          (_a(e) ? e.removeAttribute("data-mce-caret") : is(e)),
        Us(e))
      ) {
        var t = lu(
          (function (e) {
    ...
    Zs = d(xs, !0),
    ec = d(xs, !1);
  ((Rs = Ms = Ms || {})[(Rs.Backwards = -1)] = "Backwards"),
    (Rs[(Rs.Forwards = 1)] = "Forwards");
  function tc(e, t) {
  ...
  function fc(e, t) {
    return Pc.lastPositionIn(e).fold(
      function () {
        return !1;
      },
      function (e) {
  ...
  function wc(e, t, n, r, o, i) {
    var a, u, s;
    if (3 === n.nodeType) {
      if (-1 !== (u = Cc(o, i, n, r))) return { container: n, offset: u };
      s = n;
    }
    for (
      var c = new yi(n, e.getParent(n, e.isBlock) || t);
      (a = c[o ? "prev" : "next"]());

    )
      if (3 !== a.nodeType || qc(a.parentNode)) {
        if (e.isBlock(a) || jc.isEq(a, "BR")) break;
      } else if (-1 !== (u = Cc(o, i, (s = a))))
  ...
  function zc(t, e, n, r) {
    ...
    if ((o && e[0].wrapper && (o = $c(i, o, "ul,ol").reverse()[0] || o), !o))
      for (
        o = n;
        o[r] && !i.isBlock(o[r]) && ((o = o[r]), !jc.isEq(o, "br"));
  ...
  var Nc = Ge.isContentEditableFalse,
    ...
    Dc = function (e, t, n) {
      ...
      if (t.isEqual(Ds.after(n)) && n.lastChild) {
        if (
          ((u = Ds.after(n.lastChild)),
          ps(e) && Ac(n.lastChild) && kc(n.lastChild))
        )
          return Tc(n.lastChild) ? Ds.before(n.lastChild) : u;
      } else u = t;
      var s = u.container(),
        c = u.offset();
      if (Sc(s)) {
        ...
        if (ps(e) && 0 < c && ((o = tc(s, c - 1)), Ac(o)))
          return !Mc(o) && (i = ys(o, e, Rc, o))
            ? Sc(i)
              ? Ds(i, i.data.length)
              : Ds.after(i)
            : Sc(o)
            ? Ds(o, o.data.length)
            : Ds.before(o);
        if (gs(e) && c < s.childNodes.length && ((o = tc(s, c)), Ac(o)))
          return Tc(o)
            ? (function (e, t) {
                var n = t.nextSibling;
                return n && Ac(n)
      ...
      return ((gs(e) && u.isAtEnd()) || (ps(e) && u.isAtStart())) &&
        ((r = ys(r, e, $(!0), n, !0)), Rc(r, n))
        ? nc(e, r)
        : ((o = ys(r, e, Rc, n)),
          !(a = kn.last(
            y(
        ...
        if (
          ...
          return k.some(
            (function (e, t) {
              ...
              return (
                (n = e.createRng()),
                (r = Wu(e.getRoot(), t.start)),
                n.setStart(r.container(), r.offset()),
                (r = Wu(e.getRoot(), t.end)),
        ...
        if (
          ...
          return (function (r, e) {
            ...
            return Ya(t, n.or(t), function (e, t) {
              var n = r.createRng();
              return (
                n.setStart(lc(r, e.container()), e.offset()),
                n.setEnd(lc(r, t.container()), t.offset()),
                n
              );
            });
          })(n, t);
      ...
      moveStart: function (e, t, n) {
        ...
        if (
          (n.startContainer !== n.endContainer ||
            !pc(n.startContainer.childNodes[n.startOffset])) &&
          1 === u.nodeType
        )
          for (
            a < (i = u.childNodes).length
              ? ((u = i[a]), (r = new yi(u, e.getParent(u, e.isBlock))))
              : ((u = i[i.length - 1]),
                (r = new yi(u, e.getParent(u, e.isBlock))).next(!0)),
              o = r.current();
            o;
            o = r.next()
          )
            if (3 === o.nodeType && !Uc(o))
    ...
    Xc = function (e, t, n, r) {
      ...
      return (
        ...
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((i = xc(c, n, t, i, "previousSibling")),
          (u = xc(c, n, t, u, "nextSibling"))),
        (n[0].block || n[0].selector) &&
          ((i = zc(e, n, i, "previousSibling")),
          (u = zc(e, n, u, "nextSibling")),
          n[0].block &&
    ...
    return Se(n).fold(
      ...
      function (e) {
        return "br" === o ||
          ...
          : rs(n)
          ? "caret"
          : jc.isValid(t, r, o) && jc.isValid(t, ie(e), r)
          ? "valid"
          : "invalid-child";
      }
    );
      ...
      i =
        void 0 === o
          ? (function (e) {
              ...
              return (
                e + "_" + Math.floor(1e9 * Math.random()) + ++au + String(t)
              );
            })("mce-annotation")
          : o,
      a = (function h(e, t) {
  ...
  function ml(e, t, n) {
    ...
    if (
      ...
      r = Mn.trim(af.trimExternal(e.serializer, n.innerHTML));
  ...
  function gl(e) {
    ...
    return (
      (u = (e = e || {}).indent),
      (s = Ff(e.indent_before || "")),
      (c = Ff(e.indent_after || "")),
      (l = ir.getEncodeFunc(e.entity_encoding || "raw", e.entities)),
  ...
  function wl(e) {
    return Xf.range(
      e.start(),
      Cl(e.soffset(), e.start()),
      e.finish(),
      Cl(e.foffset(), e.finish())
    );
  }
  function xl(e, t) {
  ...
  function Nl(e) {
    return Xf.range(
      yt.fromDom(e.startContainer),
      e.startOffset,
      yt.fromDom(e.endContainer),
      e.endOffset
    );
  }
  function Sl(e) {
  ...
  function Hl(t, e) {
    return (function (e) {
      return e.collapsed
        ? k.from(Ka(e.startContainer, e.startOffset)).map(yt.fromDom)
        : k.none();
    })(e).bind(function (e) {
  ...
  function Ul(e, t) {
    e.dom.setHTML(e.getBody(), t),
      (function (r) {
        ud(r) &&
          Pc.firstPositionIn(r.getBody()).each(function (e) {
            var t = e.getNode(),
  ...
  function jl(t, n, r) {
    return (
      ...
      (r.set = !0),
      (r.content = Fl(n) ? "" : n),
      Fl(n) || r.no_events || (t.fire("BeforeSetContent", r), (n = r.content)),
      k.from(t.getBody()).fold($(n), function (e) {
        return Fl(n)
          ? (function (e, t, n, r) {
              vl(e.parser.getNodeFilters(), e.parser.getAttributeFilters(), n);
              var o = pl({ validate: e.validate }, e.schema).serialize(n);
              return (
                (r.content = Wn(yt.fromDom(t)) ? o : Mn.trim(o)),
                Ul(e, r.content),
              ...
              return (
                0 === n.length || /^\s+$/.test(n)
                  ? ((i = '<br data-mce-bogus="1">'),
                    ...
                    e.fire("SetContent", r))
                  : ("raw" !== r.format &&
                      (n = pl({ validate: e.validate }, e.schema).serialize(
  ...
  function Gl(e, t, n, r) {
    ...
    return Mn.extend(r, { plugins: s.join(" ") });
  }
            ...
            "string" == typeof e
              ? z(
                  ...
                  function (e) {
                    var t = e.split("=");
                    1 < t.length
                      ? (n[Mn.trim(t[0])] = Mn.trim(t[1]))
                      : (n[Mn.trim(t[0])] = Mn.trim(t[0]));
                  }
                )
              : (n = e),
            n
  ...
  var rf,
    of = fl,
    af = { trimExternal: dl, trimInternal: dl },
    uf = function (e) {
    ...
    qf = { create: be("start", "soffset", "finish", "foffset") },
    $f = jf([
      { before: ["element"] },
      { on: ["element", "offset"] },
      { after: ["element"] },
      ...
      e.on("init", function () {
        e.inline &&
          (function (e, t) {
            ...
            Xi.DOM.bind(j.document, "mouseup", n),
      ...
      e.removed ||
        (t
          ...
          : (function (t) {
              ...
              t.inline || (Nn.opera || Ll(n), t.getWin().focus()),
                (Nn.gecko || t.inline) && (Ll(n), Pl(t, r)),
                id(t);
            })(e));
    },
    ud = Il,
    ...
    xd = wd.isTouch(),
    zd = wd.isPhone(),
    Ed = ["lists", "autolink", "autosave"],
    Nd = { table_grid: !1, object_resizing: !1, resize: !1 },
    Sd = d(tf, "clientWidth"),
  ...
  var Ld,
    ...
    Id = {
      ...
      uploadError: function (e, t) {
        Od(e, ra.translate(["Failed to upload image: {0}", t]));
      },
      displayError: Od,
      initError: Vd,
    },
  ...
  function eh(o) {
    ...
    var f,
      ...
      g = [],
      p = function () {
        return (d = d || Jd(m, h)).findAll(o.getBody(), c).then(
          t(function (e) {
            return (
              (e = y(e, function (e) {
  ...
  function ih(e) {
    ...
    if (
      ...
      h.isValidChild(l, v.toLowerCase()) &&
        !(function (t, e, n) {
          return C(ch(yt.fromDom(n), yt.fromDom(e)), function (e) {
            return rh(t, e.dom());
          });
        })(m, p, g))
    ) {
      for (
        ...
        if (
          ((y = m),
          (b = g),
          Ge.isText(b) || (Ge.isElement(b) && !rh(y, b) && !Fc(b)))
        ) {
          if (oh(m, g)) {
      ...
      (function (e) {
        ...
        return Ge.isText(t)
          ? 0 === n
            ? k.some(yt.fromDom(t))
            : k.none()
          : k.from(t.childNodes[n]).map(yt.fromDom);
      })(e),
      (function (e) {
        ...
        return Ge.isText(t)
          ? n === t.data.length
            ? k.some(yt.fromDom(t))
            : k.none()
          : k.from(t.childNodes[n - 1]).map(yt.fromDom);
      })(e),
      function (e, t) {
        var n = g(hh(o), d(ze, e)),
          r = g(mh(o), d(ze, t));
  ...
  function ph(r) {
    ...
    "onselectionchange" in r.getDoc() ||
      ...
      r.on("SelectionChange", function () {
        ...
        !e ||
          (!Nn.range && r.selection.isCollapsed()) ||
          (sh(r) &&
  ...
  var Nh,
    ...
    Hh = wh(!0, zh),
    Ph = wh(!1, zh);
  ((kh = Sh = Sh || {})[(kh.Up = -1)] = "Up"), (kh[(kh.Down = 1)] = "Down");
  function Lh(o, i, a, e, u, t) {
    function n(e) {
      var t, n, r;
      for (r = Eh([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++)
        if (((n = r[t]), !a(n, s))) {
          if ((0 < l.length && i(n, kn.last(l)) && c++, (n.line = c), u(n)))
            return !0;
          l.push(n);
        }
    }
    var r,
      ...
      l = [];
    return (
      (s = kn.last(t.getClientRects())) &&
        (n((r = t.getNode())),
        (function (e, t, n, r) {
          for (; (r = ys(r, e, Va, t)); ) if (n(r)) return;
        })(o, e, n, r)),
      l
    );
  }
  ...
  function qh(e, o) {
    return kn.reduce(e, function (e, t) {
      var n, r;
      return (
        (n = Math.min(Fh(e, o), Uh(e, o))),
        (r = Math.min(Fh(t, o), Uh(t, o))),
        jh(o, t) ? t : jh(o, e) ? e : r === n && Xm(t.node) ? t : r < n ? t : e
      );
    });
  }
  function $h(e, t, n, r) {
    for (; (r = Ym(r, e, Va, t)); ) if (n(r)) return;
  }
  function Wh(e, t, n) {
    var r,
      o = Eh(
    ...
    return (r =
      ...
      qh(
        (function (e, r) {
          ...
          return (
            o.push(r),
            $h(Sh.Up, e, d(t, ja), r.node),
            $h(Sh.Down, e, d(t, qa), r.node),
            o
          );
        })(e, r),
        t
      ...
      ? (function (e, t) {
          return { node: e.node, before: Fh(e, t) < Uh(e, t) };
        })(r, t)
      : null;
  }
  function Kh(e) {
  ...
  function Yh(i, a) {
    return function (e) {
      if (
        ...
        var t = g(a.dom.getParents(e.target), Tu(Qm, Zm)).getOr(null);
        if (
          (function (e, t) {
            return Qm(t) && t !== e;
          })(a.getBody(), t)
  ...
  function Gh(r, o) {
    return function (e) {
      if (
        r.dragging &&
        (function (e, t, n) {
          return t !== n && !e.dom.isChildOf(t, n) && !Qm(t);
        })(
          o,
          (function (e) {
  ...
  function Jh(e) {
    ...
    (t = Xi.DOM),
      ...
      (i = (function (e, t) {
        return function () {
          e.dragging && t.fire("dragend"), eg(e);
        };
      })(u, e)),
      e.on("mousedown", n),
      e.on("mousemove", r),
  ...
  function em(e, t, n) {
    var r = Es(1, e.getBody(), t),
      ...
      i = o.getNode();
    if (rg(i)) return Qh(1, e, i, !o.isAtEnd(), !1);
    var a = o.getNode(!0);
    if (rg(a)) return Qh(1, e, a, !1, !1);
    var u = e.dom.getParent(o.getNode(), function (e) {
      return rg(e) || ng(e);
    });
    return rg(u) ? Qh(1, e, u, !1, n) : null;
  }
  function tm(e, t, n) {
    ...
    var v,
      ...
      s = function (e) {
        var t = g.schema.getShortEndedElements(),
          ...
          a = e.endOffset;
        return (
          kt(t, r.nodeName.toLowerCase())
            ? 0 === o
              ? n.setStartBefore(r)
              : n.setStartAfter(r)
            : n.setStart(r, o),
          kt(t, i.nodeName.toLowerCase())
            ? 0 === a
              ? n.setEndBefore(i)
              : n.setEndAfter(i)
            : n.setEnd(i, a),
      ...
      c = function (e, t) {
        ...
        if (
          ...
          return null;
        if (
          (u === a + 1 && i === e.endContainer && (n = i.childNodes[a]), !ag(n))
        )
          return null;
        if (
          ((l = f = n.cloneNode(!0)),
          ...
          return null;
        (r = wa(yt.fromDom(g.getBody()), "#" + b).fold(
          function () {
            return d([]);
          },
          function (e) {
        ...
        var m = yt.fromDom(n);
        return (
          z(ma(yt.fromDom(g.getBody()), "*[data-mce-selected]"), function (e) {
      ...
      l = function () {
        v &&
          ...
          wa(yt.fromDom(g.getBody()), "#" + b).each(_i),
          (v = null)),
          wa(yt.fromDom(g.getBody()), "#" + b).each(_i),
          (v = null);
      },
      ...
      Nn.ceFalse &&
        (function () {
          g.on("mouseup", function (e) {
            var t = o();
            t.collapsed && Md(g, e.clientX, e.clientY) && a(em(g, t, !1));
          }),
            g.on("click", function (e) {
              var t;
              (t = nm(g, e.target)) &&
                (ag(t) && (e.preventDefault(), g.focus()),
                ig(t) && g.dom.isChildOf(t, g.selection.getNode()) && l());
            }),
          ...
          function i(e, t) {
            ...
            return (
              !(!n || !g.dom.isChildOf(n, r) || !1 !== ag(nm(g, n))) ||
              (n &&
                !(function (e, t) {
                  return (
          ...
          (r = !1),
            ...
            n.on(
              ...
              function (e) {
                if (!r) {
                  var t = nm(n, e.target);
                  ag(t) && (e.preventDefault(), c(Zh(n, t)));
                }
              },
              !0
            ),
            g.on("mousedown", function (e) {
              ...
              if (
                ...
                !1 !== Md(g, e.clientX, e.clientY)
              )
                if ((t = nm(g, n)))
                  ag(t)
                    ? (e.preventDefault(), c(Zh(g, t)))
                    : (l(),
                      (ig(t) && e.shiftKey) ||
                        Gm(e.clientX, e.clientY, g.selection.getRng()) ||
                        (w(), g.selection.placeCaretAt(e.clientX, e.clientY)));
                else if (!1 === ms(n)) {
                  l(), w();
                  var r = Wh(y, e.clientX, e.clientY);
            ...
            g.on("keypress", function (e) {
              Th.modifierPressed(e) ||
                (e.keyCode, ag(g.selection.getNode()) && e.preventDefault());
            }),
        ...
        })(),
      {
        ...
        showBlockCaretContainer: function (e) {
          e.hasAttribute("data-mce-caret") &&
            (Pa(e), a(o()), g.selection.scrollIntoView(e[0]));
        },
        hideFakeCaret: w,
        destroy: function () {
          u.destroy(), (v = null);
  ...
  function cm(e) {
    var t = yt.fromTag(
      "body",
      hg.get().getOrThunk(function () {
        var e = j.document.implementation.createHTMLDocument("undo");
        return hg.set(k.some(e)), e;
      })
    );
    return (
      Aa(t, sm(e)),
      z(ma(t, "*[data-mce-bogus]"), Ni),
      (function (e) {
    ...
    var r = Je(k.none()),
      ...
      a = {
        ...
        beforeChange: function () {
          !(function (e, t, n) {
            lm(t) && n.set(k.some(Vs.getUndoBookmark(e.selection)));
          })(n, o, r);
        },
        add: function (e, t) {
          return (function (e, t, n, r, o, i, a) {
            var u = e.settings,
              s = mg(e);
            if (
              ((i = i || {}), (i = Mn.extend(i, s)), !1 === lm(r) || e.removed)
            )
              return null;
            var c = t.data[n.get()];
            if (
            ...
            (i.bookmark = Vs.getUndoBookmark(e.selection)),
        ...
        undo: function () {
          return (function (e, t, n, r) {
            var o;
            return (
              t.typing && (t.add(), (t.typing = !1), fm(t, !1, n)),
              0 < r.get() &&
                (r.set(r.get() - 1),
                (o = t.data[r.get()]),
                gg(e, o, !0),
        ...
        hasUndo: function () {
          return (function (e, t, n) {
            return (
              0 < n.get() || (t.typing && t.data[0] && !pg(mg(e), t.data[0]))
            );
          })(n, a, i);
        },
        hasRedo: function () {
        ...
        transact: function (e) {
          return (function (e, t, n) {
            return dm(e, t), e.beforeChange(), e.ignore(n), e.add();
          })(a, o, e);
        },
        ignore: function (e) {
          !(function (e, t) {
            ...
            if (!e.isDefaultPrevented())
              if ((33 <= t && t <= 36) || (37 <= t && t <= 40) || 45 === t)
                ...
                !(t < 16 || 20 < t) ||
                  ...
                  r.typing ||
                  n ||
                  (r.beforeChange(), fm(r, !0, o), r.add({}, e), a.set(!0));
              }
          }),
  ...
  function gm(t, e, n, r) {
    ...
    return (
      ...
      ((e = t.dom.getParent(e, function (e) {
        return !!mm(t, e, n) || e.parentNode === o || !!wg(t, e, n, r, !0);
      })),
      wg(t, e, n, r))
    );
  }
      ...
      if ("undefined" == typeof c.length) {
        for (a in c)
          if (c.hasOwnProperty(a)) {
            if (
              ((u =
                "attributes" === r ? e.getAttrib(t, a) : jc.getStyle(e, t, a)),
              o && !u && !n.exact)
            )
              return;
            if (
              (!o || n.exact) &&
              !Cg(u, jc.normalizeStyleValue(e, jc.replaceVars(c[a], i), a))
            )
              return;
          }
      } else
        for (s = 0; s < c.length; s++)
          if (
            "attributes" === r ? e.getAttrib(t, c[s]) : jc.getStyle(e, t, c[s])
          )
            return n;
    return n;
  }
    ...
    return (
      t === r && Ge.isText(t)
        ? 0 < n &&
          ...
          ((t = (r = ym(t, n)).previousSibling),
          n < o
            ? ((t = r = ym(r, (o -= n)).previousSibling),
        ...
        : (Ge.isText(t) &&
          ...
          Ge.isText(r) &&
            0 < o &&
            o < r.nodeValue.length &&
            (o = (r = ym(r, o).previousSibling).nodeValue.length)),
  ...
  function Em(e, t) {
    return (function (e, t) {
      var n = e.container(),
        r = e.offset();
      return (
        !1 === Ds.isTextPosition(e) &&
        n === t.parentNode &&
        r > Ds.before(t).offset()
      );
    })(t, e)
      ? Ds(t.container(), t.offset() - 1)
      : t;
  }
  function Nm(e) {
    return La(e.previousSibling)
      ? k.some(
          (function (e) {
      ...
      : e.previousSibling
      ? Pc.lastPositionIn(e.previousSibling)
      : k.none();
  }
  function Sm(e) {
    return La(e.nextSibling)
      ...
      : e.nextSibling
      ? Pc.firstPositionIn(e.nextSibling)
      : k.none();
  }
  function km(e, t) {
    return Nm(t)
      ...
      (function (e, t, n, r) {
        ...
        return (
          (function (e, t, n) {
            ...
            e.appendData(t.data), _i(yt.fromDom(t)), n && wm(e, r);
          })(r, o, a),
          n.container() === o ? Ds(r, i) : n
        );
      }).orThunk(function () {
        return (
          a &&
  ...
  function Hm(e) {
    ...
    return (
      me(t, { id: Ag, "data-mce-bogus": "1", "data-mce-type": "format-caret" }),
      e && Di(t, yt.fromText(Tg)),
      t
    );
  }
  function Pm(e, t, n) {
    ...
    var r = e.dom,
      o = e.selection;
    if (Bm(t)) kg(e, !1, yt.fromDom(t), n);
    else {
      var i = o.getRng(),
        a = r.getParent(t, r.isBlock),
        u = (function (e) {
          var t = Om(e);
          return t && t.nodeValue.charAt(0) === Tg && t.deleteData(0, 1), t;
        })(t);
      i.startContainer === u &&
        0 < i.startOffset &&
  ...
  function Fm(e, t) {
    ...
    return Im(n, n.ownerDocument.createTextNode(Tg));
  }
  function Um(t) {
    t.on("mouseup keydown", function (e) {
      !(function (e, t) {
        ...
        Lm(e, null, !1),
          (8 !== t && 46 !== t) ||
            !n.isCollapsed() ||
            n.getStart().innerHTML !== Tg ||
            Lm(e, os(r, n.getStart())),
          (37 !== t && 39 !== t) || Lm(e, os(r, n.getStart()));
      })(t, e.keyCode);
    });
  }
  function jm(e, t) {
  ...
  var qm,
    $m,
    Wm = d(Lh, Sh.Up, ja, qa),
    Km = d(Lh, Sh.Down, qa, ja),
    Xm = Ge.isContentEditableFalse,
    Ym = ys,
    Gm = function (t, n, e) {
    ...
    Jm = function (e, t) {
      return (function (e, t, n) {
        ...
        (function (e) {
          return e.inline ? Kh(e.getBody()) : { left: 0, top: 0 };
        })(e),
        (function (e) {
          var t = e.getBody();
          return e.inline
        ...
        (function (e, t) {
          ...
          var n = Kh(e.getContentAreaContainer()),
            r = (function (e) {
              var t = e.getBody(),
    ...
    Qm = Ge.isContentEditableFalse,
    Zm = Ge.isContentEditableTrue,
    eg = function (e) {
          ...
          n.on("drop", function (e) {
            var t =
              "undefined" != typeof e.clientX
                ...
                : null;
            (Qm(t) || Qm(n.dom.getContentEditableParent(t))) &&
              e.preventDefault();
          });
        })(e);
    },
    ng = Ge.isContentEditableTrue,
    rg = Ge.isContentEditableFalse,
    og = function (t) {
      var e = aa(function () {
        if (
          !t.removed &&
          ...
          var e = tm(t, t.selection.getRng(), !1);
          t.selection.setRng(e);
        }
      }, 0);
      t.on("focus", function () {
    ...
    ig = Ge.isContentEditableTrue,
    ag = Ge.isContentEditableFalse,
    ug = 0,
    sg = 2,
    cg = 1,
    lg = function (m, g) {
    ...
    fg = function (e) {
      return y(X(P(e.childNodes), om), function (e) {
        return 0 < e.length;
      });
    },
    dg = function (e, t) {
      var n = X(P(t.childNodes), om);
      return (
        (function (e, t) {
          var n = 0;
          z(e, function (e) {
    ...
    xg = {
      ...
      match: function (e, t, n, r) {
        ...
        return r
          ...
          : ((r = e.selection.getNode()),
            !!gm(e, r, t, n) ||
              !((o = e.selection.getStart()) === r || !gm(e, o, t, n)));
      },
        ...
        return (
          ...
          r.dom.getParent(
            ...
            function (e) {
              var t, n;
              for (t = 0; t < o.length; t++)
                (n = o[t]), !u[n] && wg(r, e, n, i) && ((u[n] = !0), a.push(n));
            },
            r.dom.getRoot()
          ),
          a
      ...
      matchesUnInheritedFormatSelector: mm,
    },
    zg = Ge.hasAttribute("data-mce-bookmark"),
    Eg = Ge.hasAttribute("data-mce-bogus"),
    Ng = Ge.hasAttributeValue("data-mce-bogus", "all"),
    Sg = function (e) {
      return (function (e) {
        var t,
          n = 0;
  ...
  ($m = function (e) {
    ...
    (t = Ge.matchNodeNames(["pre"])),
      r.collapsed ||
        ...
        Dg(
          Rg(Rg(n, t), function (e) {
            return (
              t(e.previousSibling) && -1 !== kn.indexOf(n, e.previousSibling)
            );
          }),
          function (e) {
            !(function (e, t) {
  ...
  function Og(e, t, n) {
    ...
    return (
      ...
      Ge.isText(r) &&
        n &&
        o >= r.nodeValue.length &&
        (r = new yi(r, e.getBody()).next() || r),
      Ge.isText(r) && !n && 0 === o && (r = new yi(r, e.getBody()).prev() || r),
      r
    );
  }
  function Hg(e, t, n, r) {
  ...
  function Lg(e, t, n, r) {
    return (
      !(t = jc.getNonWhiteSpaceSibling(t, n, r)) ||
      "BR" === t.nodeName ||
      e.isBlock(t)
    );
  }
  function Vg(e, r, o, i, a) {
    var t,
      n,
      u,
      s = e.dom;
    ...
    if ("all" !== r.remove)
      for (
        Jg(r.styles, function (e, t) {
          (e = jc.normalizeStyleValue(s, jc.replaceVars(e, o), t)),
            "number" == typeof t && ((t = e), (a = 0)),
            (!r.remove_similar && a && !Qg(jc.getStyle(s, a, t), e)) ||
              s.setStyle(i, t, ""),
            (u = 1);
        }),
          u &&
          ...
          Jg(r.attributes, function (e, t) {
            var n;
            if (
              ((e = jc.replaceVars(e, o)),
              "number" == typeof t && ((t = e), (a = 0)),
              r.remove_similar || !a || Qg(s.getAttrib(a, t), e))
            ) {
              if (
                "class" === t &&
                (e = s.getAttrib(i, t)) &&
                ((n = ""),
                Jg(e.split(/\s+/), function (e) {
                  /mce\-\w+/.test(e) && (n += (n ? " " : "") + e);
                }),
                n)
              )
              ...
              "class" === t && i.removeAttribute("className"),
                Gg.test(t) && i.removeAttribute("data-mce-" + t),
                i.removeAttribute(t);
            }
          }),
          Jg(r.classes, function (e) {
            (e = jc.replaceVars(e, o)),
    ...
    return "none" !== r.remove
      ? ((function (t, e, n) {
          ...
          n.block &&
            (a
              ? o === i.getRoot() &&
                ((n.list_block && Qg(e, n.list_block)) ||
                  Jg(Mn.grep(e.childNodes), function (e) {
                    jc.isValid(t, a, e.nodeName.toLowerCase())
                      ? r
                        ? r.appendChild(e)
                        : ((r = Hg(i, e, a)),
              ...
              : i.isBlock(e) &&
                !i.isBlock(o) &&
                (Lg(i, e, !1) ||
                  Lg(i, e.firstChild, !0, 1) ||
                  e.insertBefore(i.create("br"), e.firstChild),
                Lg(i, e, !0) ||
                  Lg(i, e.lastChild, !1, 1) ||
                  e.appendChild(i.create("br")))),
            (n.selector && n.inline && !Qg(n.inline, e)) || i.remove(e, 1);
        })(e, i, r),
        !0)
      : void 0;
  }
  ...
  function $g(e, t) {
    ...
    1 === t.nodeType &&
      ...
      ((n = jc.getTextDecoration(e, t.parentNode)),
  ...
  function Wg(t) {
    ...
    return Pc.fromPosition(!1, o, r)
      .map(function (e) {
        return !Cs(n, r, o) && Cs(n, e, o)
          ? (function (e, t, n, r) {
  ...
  var Xg = function (e, t) {
    ...
    Qg = jc.isEq,
    Zg = Vg,
    ep = function (a, n, u, e, r) {
      function i(e) {
        var t = (function (n, e, r, o, i) {
          var a;
          return (
            Jg(jc.getParents(n.dom, e.parentNode).reverse(), function (e) {
              var t;
              a ||
                "_start" === e.id ||
                "_end" === e.id ||
                ((t = xg.matchNode(n, e, r, o, i)) &&
                  !1 !== t.split &&
                  (a = e));
            }),
            a
      ...
      function s(e) {
        ...
        return (
          (function (e) {
            return (
              Fc(e) && Ge.isElement(e) && ("_start" === e.id || "_end" === e.id)
            );
          ...
          Jg(e, function (e) {
            g(e),
              Ge.isElement(e) &&
                ...
                e.parentNode &&
                "underline" === jc.getTextDecoration(h, e.parentNode) &&
                Vg(
                  a,
                  {
                    deep: !1,
      ...
      var o,
        ...
        g = function (e) {
          ...
          if (
            ...
            (t = Mn.grep(e.childNodes)),
            d && !i)
          )
            for (n = 0, r = l.length; n < r && !Vg(a, l[n], u, e, e); n++);
          if (f.deep && t.length) {
      ...
      if (e)
        ...
        !h.select("td[data-mce-selected],th[data-mce-selected]").length
          ...
          : ((o = Vs.getPersistentBookmark(a.selection, !0)),
            t(m.getRng()),
            m.moveToBookmark(o),
            f.inline &&
              xg.match(a, n, u, m.getStart()) &&
              jc.moveStart(h, m, m.getRng()),
            a.nodeChanged());
      else {
        e = m.getNode();
        for (
          var p = 0, v = l.length;
          p < v && (!l[p].ceFalseOverride || !Vg(a, l[p], u, e, e));
          p++
        );
      }
    },
    tp = Mn.each,
    np = function (e, t, n) {
      tp(e.childNodes, function (e) {
        Ig(e) && (t(e) && n(e), e.hasChildNodes() && np(e, t, n));
      });
    },
    rp = function (e, t) {
    ...
    op = function (n, e, r, o) {
      tp(e, function (t) {
        tp(n.dom.select(t.inline, o), function (e) {
          Ig(e) && Zg(n, t, r, e, t.exact ? e : null);
        }),
          (function (r, e, t) {
            if (e.clear_child_styles) {
              var n = e.links ? "*:not(a)" : "*";
              tp(r.select(n, t), function (n) {
                Ig(n) &&
                  tp(e.styles, function (e, t) {
                    r.setStyle(n, t, "");
                  });
              });
            }
    ...
    ip = function (e, t, n, r) {
      (t.styles.color || t.styles.textDecoration) &&
        (Mn.walk(r, d($g, e), "childNodes"), $g(e, r));
    },
    ap = function (e, t, n, r) {
      t.styles &&
        ...
        np(
          r,
          jg(e, "fontSize"),
          qg(e, "backgroundColor", jc.replaceVars(t.styles.backgroundColor, n))
        );
    },
    up = function (e, t, n, r) {
      ("sub" !== t.inline && "sup" !== t.inline) ||
        (np(r, jg(e, "fontSize"), qg(e, "fontSize", "")),
        e.remove(e.select("sup" === t.inline ? "sub" : "sup", r), !0));
    },
    sp = function (e, t, n, r) {
      r &&
        !1 !== t.merge_siblings &&
        ((r = Ug(e, jc.getNonWhiteSpaceSibling(r), r)),
        (r = Ug(e, r, jc.getNonWhiteSpaceSibling(r, !0))));
    },
    cp = function (t, n, r, o, i) {
      (xg.matchNode(t, i.parentNode, r, o) && Zg(t, n, o, i)) ||
        (n.merge_with_parents &&
          t.dom.getParent(i.parentNode, function (e) {
            if (xg.matchNode(t, e, r, o)) return Zg(t, n, o, i), !0;
          }));
    },
    lp = function (e) {
      ...
      function e(s, e, t, c) {
        ...
        (l = C.inline || C.block),
          ...
          Gc(s, e, function (e) {
            var a,
              u = function (e) {
                ...
                if (C.wrapper && xg.matchNode(m, e, g, p)) a = 0;
                else {
                  if (
                    h &&
                    !r &&
          ...
          !0 === C.links &&
            fp(d, function (e) {
              var t = function (e) {
                "A" === e.nodeName && v(e, C), fp(Mn.grep(e.childNodes), t);
              };
              t(e);
            }),
          fp(d, function (e) {
          ...
          if (r)
            ...
            !(function (e, t, n) {
              ...
              (a = (r = c.getRng()).startOffset),
                ...
                (o = os(e.getBody(), c.getStart())) && (i = Om(o));
              var l = /[^\s\u00a0\u00ad\u200b\ufeff]/;
              s &&
              0 < a &&
              a < s.length &&
            ...
            m.settings.forced_root_block ||
              ...
              dp(m, b[0].defaultBlock),
              m.selection.setRng(lp(m.selection.getRng())),
              (t = Vs.getPersistentBookmark(m.selection, !0)),
              e(i, Xc(m, a.getRng(), b)),
              C.styles && ip(i, C, p, u),
              a.moveToBookmark(t),
              jc.moveStart(i, a, a.getRng()),
              m.nodeChanged();
          }
          Xg(g, m);
        }
        ...
        Mn.each(u, function (t) {
          return r.formatter.matchNode(t, n, {}, e.similar)
            ? (-1 === o.indexOf(n) &&
              ...
              (a[n] = e.callbacks),
              !1)
            : !xg.matchesUnInheritedFormatSelector(r, t, n) && void 0;
        });
      });
      var s = gp(t.get(), a, e, u);
      t.set(G(G({}, i), s));
    },
    gp = function (e, n, r, o) {
  ...
  function vp(e, t) {
    function s(e) {
      ...
      return (
        ...
        (function (e, t) {
          t.classes.length && Mp.addClass(e, t.classes.join(" ")),
            Mp.setAttribs(e, t.attrs);
        })((t = Mp.create(r.name)), r),
        t
      );
    }
    var n,
      ...
      l = function (n, e, t) {
        ...
        if (
          (i = (function (e, t) {
            ...
            return (
              !(!o || !o.length) && (t && -1 !== Mn.inArray(o, t) ? t : o[0])
            );
          })(n, u))
        )
        ...
        return (
          ...
          t &&
            (r || (r = Mp.create("div")).appendChild(n),
    ...
    return e && e.length
      ? ((r = e[0]),
        (n = s(r)),
        (o = Mp.create("div")).appendChild(l(n, e.slice(1), r.siblings)),
        o)
      : "";
  }
  function yp(e) {
  ...
  function bp(e) {
    ...
    return (
      ...
      Um(e),
      {
        ...
        apply: d(hp.applyFormat, e),
        remove: d(ep, e),
        toggle: d(_p, e, t),
        match: d(xg.match, e),
        matchAll: d(xg.matchAll, e),
        matchNode: d(xg.matchNode, e),
        canApply: d(xg.canApply, e),
        formatChanged: d(Kg, e, n),
        getCssText: d(Dp, e),
      }
    );
  }
  ...
  function wp(e, t) {
    var n = xr();
    t.convert_fonts_to_spans && Cp(e, n, Mn.explode(t.font_size_legacy_values)),
      (function (e, n) {
  ...
  function xp(e, t, n, r) {
    (e.padd_empty_with_br || t.insert) && n[r.name]
      ? (r.empty().append(new ul("br", 1)).shortEnded = !0)
      : (r.empty().append(new ul("#text", 3)).value = "\xa0");
  }
  function zp(t, e, n, r) {
      ...
      e = {
        ...
        parse: function (e, a) {
          ...
          (a = a || {}),
            ...
            (_ = {}),
            (l = jp(
              Ip("script,style,head,html,body,title,meta,param"),
              A.getBlockElements()
            ));
          var m,
          ...
          t = of(
            {
              ...
              start: function (e, t, n) {
                ...
                if ((n = v ? A.getElementRule(e) : {})) {
                  ...
                  n.paddEmpty &&
                    ((function (e) {
                      return Vp(e, "#text") && "\xa0" === e.firstChild.value;
                    })(d) ||
                      zp(A, g, C, d)) &&
                    xp(T, a, l, d),
                    (d = d.parent);
            ...
            v &&
              ...
              (a.context
                ...
                : (function (e) {
                    ...
                    for (
                      d = Ip("tr,td,th,tbody,thead,tfoot,table"),
            ...
            for (d.body = 1, r = 0; r < f; r++)
              if (
                ...
                a === i &&
                  ...
                  (((l = new ul("#text", 3)).value = "\xa0"), o.replace(l));
              }
          }),
  ...
  function kp(a, u) {
    var s,
      ...
      e = ["data-mce-selected"];
    return (
      (s = u && u.dom ? u.dom : Xi.DOM),
      (c = u && u.schema ? u.schema : pr(a)),
      ...
      Op(l, a, s),
      {
        ...
        serialize: function (e, t) {
          ...
          return "tree" === n.format ? i : Sp(u, a, c, i, n);
        },
        addRules: function (e) {
  ...
  var Ap = Mn.each,
    ...
    Dp = function (n, e) {
      ...
      return "preview" in e && !1 === (u = e.preview)
        ...
        : ((t = e.block || e.inline || "span"),
          (r = (i = Rp(e.selector)).length
            ? (i[0].name || (i[0].name = t), (t = e.selector), vp(i, n))
            : vp([t], n)),
          (o = Mp.select(t, r)[0] || r.firstChild),
          Ap(e.styles, function (e, t) {
            (e = c(e)) && Mp.setStyle(o, t, e);
          }),
          Ap(e.attributes, function (e, t) {
            (e = c(e)) && Mp.setAttrib(o, t, e);
          }),
          Ap(e.classes, function (e) {
            (e = c(e)), Mp.hasClass(o, e) || Mp.addClass(o, e);
          }),
          n.fire("PreviewFormats"),
          Mp.setStyles(r, { position: "absolute", left: -65535 }),
          n.getBody().appendChild(r),
          (a = Mp.getStyle(n.getBody(), "fontSize", !0)),
          (a = /px$/.test(a) ? parseInt(a, 10) : 0),
          Ap(u.split(" "), function (e) {
            var t = Mp.getStyle(o, e, !0);
            if (
              !(
                ("background-color" === e &&
                  /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
                  ((t = Mp.getStyle(n.getBody(), e, !0)),
                  "#ffffff" === Mp.toHex(t).toLowerCase())) ||
                ("color" === e && "#000000" === Mp.toHex(t).toLowerCase())
              )
            ) {
    ...
    _p = function (e, t, n, r, o) {
      var i = t.get(n);
      !xg.match(e, n, r, o) || ("toggle" in i[0] && !i[0].toggle)
        ? hp.applyFormat(e, n, r, o)
        : ep(e, n, r, o);
    },
    Bp = function (e) {
    ...
    jp = Mn.extend;
  function qp(e) {
    return { getBookmark: d(Vc, e), moveToBookmark: d(Ic, e) };
  }
  (qp = qp || {}).isBookmarkNode = Fc;
  function $p(r, a) {
    var u,
      s,
      c,
    ...
    function e(e) {
      ...
      !(function (e, t) {
        if ("longpress" !== e.type && 0 !== e.type.indexOf("touch"))
          return M(e.target) && !Gm(e.clientX, e.clientY, t);
        var n = e.touches[0];
        return M(e.target) && !Gm(n.clientX, n.clientY, t);
    ...
    function _(e) {
      ...
      (t = e.screenX - d),
        ...
        (M(u) && !1 !== a.settings.resize_img_proportional
          ? !Th.modifierPressed(e)
          : Th.modifierPressed(e) || (M(u) && f[2] * f[3] != 0)) &&
          (k(t) > k(n)
            ? ((C = T(b * y)), (b = T(C / y)))
            : ((b = T(C / y)), (C = T(b * y)))),
    ...
    var B = function () {
        ...
        e("width", b),
          ...
          z.unbind(N, "mouseup", B),
          S !== N && (z.unbind(S, "mousemove", _), z.unbind(S, "mouseup", B)),
          z.remove(s),
          z.remove(c),
          O(u),
          gd(a, u, b, C),
  ...
  var Wp = qp,
    Kp = Ge.isContentEditableFalse,
    Xp = Ge.isContentEditableTrue;
  function Yp(e) {
  ...
  function Qp(e, t) {
    var n = (function (e, t) {
        var n = Re(e);
        if (0 === n.length || Gp(e)) return { element: e, offset: t };
        if (t < n.length && !Gp(n[t])) return { element: n[t], offset: 0 };
        var r = n[n.length - 1];
        return Gp(r)
          ? { element: e, offset: t }
          : "img" === ie(r)
  ...
  function iv(e, t, n, r, o) {
    ...
    a.top() < u.y()
      ? Ai(r.element, !1 !== o)
      : a.top() > u.bottom() && Ai(r.element, !0 === o);
  }
  function av(e, t, n) {
    return ev(e, d(ov), t, n);
  }
  function uv(e, t, n) {
    return tv(e, Zp(t), d(ov), n);
  }
  function sv(e, t, n) {
    return ev(e, d(iv, e), t, n);
  }
  function cv(e, t, n) {
    return tv(e, Zp(t), d(iv, e), n);
  }
  function lv(e) {
  ...
  function mv(e, t) {
    for (var n = e.rows(), r = 0; r < n.length; r++)
      for (var o = n[r].cells(), i = 0; i < o.length; i++)
        if (ze(o[i], t)) return k.some(Xv(i, r));
    return k.none();
  }
  ...
  function zv(e, t) {
    return (function (e, t) {
      ...
      return 0 < t.length ? fv([n]) : n;
    })(yt.fromDom(t.cloneContents()), wv(e, t));
  }
  function Ev(e, o) {
    return (function (e, t) {
      ...
      .bind(function (e) {
        var t = o[0],
          n = o[o.length - 1],
          r = Yv(e);
        return Jv(r, t, n).map(function (e) {
          return fv([Gv(e)]);
        });
      })
      .getOrThunk(xv);
  ...
  function Tv(e, t, n) {
    for (
      var r = new yi(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
      (t = r[n ? "prev" : "next"]());
  ...
  function Mv(e, t, n, r) {
    ...
    if (
      ...
      if (s && (a = o.childNodes[0 < i ? i - 1 : 0])) {
        ...
        if (u[a.nodeName] || kv(a)) return k.none();
      }
      if (o.hasChildNodes()) {
        if (
  ...
  function _v(e, t, n) {
    return Dv(e, t, !0, n, function (e, t) {
      return Math.min(
        (function (e) {
  ...
  function Bv(e, t, n) {
    return Dv(e, t, !1, n, function (e, t) {
      return 0 < t ? t - 1 : t;
    });
  }
  function Ov(e, t) {
  ...
  var Pv = (function bN(r, o) {
    ...
    Iv = function (e, t, n, r) {
      ...
      var a = ki(i).top(),
        u = Qp(yt.fromDom(n.startContainer), n.startOffset);
      t(i, a, u, r), u.cleanup();
    },
    Fv = function (e, t, n) {
    ...
    Uv = function (e, t, n) {
      !(function (e, t, n) {
        return e
          ...
          .isDefaultPrevented();
      })(e, t, n) && (e.inline ? uv : cv)(e, t, n);
    },
    jv = function (e, t, n) {
      (e.inline ? av : sv)(e, t, n);
    },
    qv = function (e, t, n) {
      var r,
        o,
        ...
        try {
          ...
          r = (function (e, n, t) {
            ...
            if (
              ...
              0 <
                (i = (i = Mn.toArray(o.getClientRects())).sort(function (e, t) {
                  return (
    ...
    Wv = be("element", "width", "rows"),
    Kv = be("element", "cells"),
    Xv = be("x", "y"),
    Yv = function (e) {
      var o = Wv(ka(e), 0, []);
      return (
        z(ma(e, "tr"), function (n, r) {
    ...
    Jv = function (n, e, r) {
      return mv(n, e).bind(function (t) {
        return mv(n, r).map(function (e) {
          return (function (e, t, n) {
            var r = t.x(),
              o = t.y(),
              i = n.x(),
              a = n.y(),
              u = o < a ? gv(e, r, o, i, a) : gv(e, r, a, i, o);
            return Wv(e.element(), hv(u), u);
          })(n, t, e);
        });
      });
    },
    ...
    ey = function (e) {
      return 1 < pv(e).length;
    },
    ty = bv,
    ny = function (e) {
      return bv(Qv(e.selection.getSel()), yt.fromDom(e.getBody()));
    },
    ry = function (e, t) {
      var n = ty(t, e);
      return 0 < n.length
        ? Ev(e, n)
        : (function (e, t) {
            return 0 < t.length && t[0].collapsed ? xv() : zv(e, t[0]);
          })(e, t);
    },
    oy = function (e, t) {
      if (
    ...
    iy = function (e, t) {
      ...
      return (
        Mv(e, n, !0, r).each(function (e) {
          (n && Uu.isAbove(o, e)) || r.setStart(e.container(), e.offset());
        }),
        n ||
          Mv(e, n, !1, r).each(function (e) {
    ...
    ay = function (e, t, n) {
      if (
        ...
        !(function (r, e) {
          ...
          var o = t.bind(ke).filter(zt).bind(Rv),
            i = n.bind(Te).filter(zt).bind(Rv);
  ...
  function sy(e) {
    return (
      !(!e || !e.ownerDocument) &&
      Bt(yt.fromDom(e.ownerDocument), yt.fromDom(e))
    );
  }
  function cy(u, s, e, c) {
    function t(e, t) {
    ...
    var n,
      ...
      m = function (e, t) {
        ...
        if (
          (function (e) {
            return (
              !!e && (!!uy(e) || (sy(e.startContainer) && sy(e.endContainer)))
            );
          })(e)
        ) {
          var o = uy(e) ? e : null;
      ...
      g = {
          ...
          return (function (e, t) {
            ...
            return t
              ? ((r = t.startContainer),
                ...
                3 === r.nodeType &&
                  3 === o.nodeType &&
                  ((r = r.length === i ? Ov(r.nextSibling, !0) : r.parentNode),
                  (o = 0 === a ? Ov(o.previousSibling, !1) : o.parentNode),
                  r && r === o))
                  ? r
                  : n && 3 === n.nodeType
                  ? n.parentNode
        ...
        getSelectedBlocks: function (e, t) {
          return (function (e, t, n, r) {
            ...
            if (
              ((i = e.getRoot()),
              (n = e.getParent(n || _v(i, t, t.collapsed), e.isBlock)),
              (r = e.getParent(r || Bv(i, t, t.collapsed), e.isBlock)),
              n && n !== i && a.push(n),
              n && r && n !== r)
            )
              for (var u = new yi((o = n), i); (o = u.next()) && o !== r; )
        ...
        placeCaretAt: function (e, t) {
          return m(qv(e, t, c.getDoc()));
        },
        getBoundingClientRect: function () {
          var e = h();
          return e.collapsed
            ? Ds.fromRangeStart(e).getClientRects()[0]
  ...
  function ly(e) {
    return Fy(e) && e.data[0] === cu;
  }
  function fy(e) {
    return Fy(e) && e.data[e.data.length - 1] === cu;
  }
  function dy(e) {
  ...
  function hy(e, t) {
    return e
      ? (function (e) {
          if (Fy(e.previousSibling))
            return (
              fy(e.previousSibling) || e.previousSibling.appendData(cu),
              e.previousSibling
            );
          if (Fy(e)) return ly(e) || e.insertData(0, cu), e;
          var t = dy(e);
      ...
      : (function (e) {
          if (Fy(e.nextSibling))
            return (
              ly(e.nextSibling) || e.nextSibling.insertData(0, cu),
              e.nextSibling
            );
          if (Fy(e)) return fy(e) || e.appendData(cu), e;
          var t = dy(e);
          return (
            e.nextSibling
  ...
  function my(e, t) {
    return Ge.isText(e.container()) ? hy(t, e.container()) : hy(t, e.getNode());
  }
  function gy(e, t) {
    var n = t.get();
  ...
  function py(e, t) {
    ...
    return e
      ...
      ? Ge.isText(n.previousSibling)
        ? Ds(n.previousSibling, n.previousSibling.data.length)
        : Ds.before(n)
      : Oa(t)
      ? Ds(n, r - 1)
      : t;
  ...
  function yy(e, t, n) {
    var r = Wy.normalizeForwards(n),
      o = vy(t, r.container());
    return Wy.findRootInline(e, o, r).fold(function () {
      return Pc.nextPosition(o, r)
        .bind(d(Wy.findRootInline, e, o))
        .map(function (e) {
          return Xy.before(e);
        });
    }, k.none);
  ...
  function Cy(e, t, n) {
    return Wy.findRootInline(e, t, n).filter(d(by, t));
  }
  function wy(e, t, n) {
    var r = Wy.normalizeBackwards(n);
    return Cy(e, t, r).bind(function (e) {
      return Pc.prevPosition(e, r).isNone() ? k.some(Xy.start(e)) : k.none();
    });
  }
  function xy(e, t, n) {
    var r = Wy.normalizeForwards(n);
    return Cy(e, t, r).bind(function (e) {
      return Pc.nextPosition(e, r).isNone() ? k.some(Xy.end(e)) : k.none();
    });
  }
  function zy(e, t, n) {
    var r = Wy.normalizeBackwards(n),
  ...
  function Ey(e) {
    return !1 === Wy.isRtl(Yy(e));
  }
  function Ny(e, t, n) {
    return Ky([yy, wy, xy, zy], [e, t, n]).filter(Ey);
  }
  function Sy(e) {
  ...
  function Ty(n, e, r, t, o, i) {
    return Ya(Wy.findRootInline(e, r, t), Wy.findRootInline(e, r, o), function (
      e,
      t
    ) {
      return e !== t && Wy.hasSameParentBlock(r, e, t)
        ? Xy.after(n ? e : t)
        : i;
    }).getOr(i);
  }
  function Ay(e, t) {
    return e.fold($(!0), function (e) {
      return !(function (e, t) {
        return Sy(e) === Sy(t) && Yy(e) === Yy(t);
      })(e, t);
    });
  }
  function My(e, t) {
    return e
      ? t.fold(q(k.some, Xy.start), k.none, q(k.some, Xy.after), k.none)
      : t.fold(k.none, q(k.some, Xy.before), k.none, q(k.some, Xy.end));
  }
  function Ry(e, t, n, r) {
    var o = Wy.normalizePosition(e, r),
      i = Ny(t, n, o);
    return Ny(t, n, o)
      .bind(d(My, e))
      .orThunk(function () {
        return (function (t, n, r, o, e) {
          var i = Wy.normalizePosition(t, e);
          return Pc.fromPosition(t, r, i)
            .map(d(Wy.normalizePosition, t))
            .fold(
              function () {
                return o.map(ky);
              },
              function (e) {
                return Ny(n, r, e).map(d(Ty, t, n, r, i, e)).filter(d(Ay, o));
              }
            )
            .filter(Ey);
        })(e, t, n, i, r);
  ...
  function _y(e, t, n) {
    var r = e ? 1 : -1;
    return (
      t.setRng(Ds(n.container(), n.offset() + r).toRange()),
  ...
  var Vy,
      ...
      return e.fold(
        ...
        function (e) {
          return Pc.lastPositionIn(e).map(function (e) {
            if (gy(e, n)) return Ds(n.get(), n.get().length - 1);
            qs.remove(n.get());
            var t = my(e, !1);
    ...
    Wy = {
      ...
      isRtl: function (e) {
        return (
          "rtl" === Xi.DOM.getStyle(e, "direction", !0) ||
          (function (e) {
            return $y.test(e);
          })(e.textContent)
        );
          ...
          return (
            ...
            (function (t, n, e) {
              var r = t.getBody(),
                ...
                i = d(Wy.isInlineTarget, t);
              return Jy(e, i, r, o).bind(function (e) {
                return Py(t, n, e);
              });
            })(e, t, n).isSome()
          );
            ...
            Oy(t) &&
              ...
              (function (e, t) {
                if (
                  ...
                  Ds.isTextPosition(n) &&
                    !1 === Wy.isAtZwsp(n) &&
                    (By(e, qs.removeAndReposition(t.get(), n)), t.set(null));
                }
              })(t, n),
              (function (n, r, o, e) {
  ...
  function rb(e, t, n, r) {
    for (
      var o, i, a, u, s, c, l = rc(n), f = r, d = [];
      f && ((s = l), (c = f), (o = t === Ms.Forwards ? s.next(c) : s.prev(c)));
      ...
      if (Ge.isBr(o.getNode(!1)))
        return t === Ms.Forwards
          ...
          : { positions: nb(t, d), breakType: Vy.Br, breakAt: k.some(o) };
      if (o.isVisible()) {
        if (e(f, o)) {
          var h =
            ((i = t),
            (a = f),
            (u = o),
            Ge.isBr(u.getNode(i === Ms.Forwards))
              ? Vy.Br
              : !1 === Cs(a, u)
              ? Vy.Block
              : Vy.Wrap);
          return { positions: nb(t, d), breakType: h, breakAt: k.some(o) };
        }
        d.push(o), (f = o);
      } else f = o;
    }
    return { positions: nb(t, d), breakType: Vy.Eol, breakAt: k.none() };
  }
  function ob(n, r, o, e) {
    return r(o, e)
    ...
    return b(
      ...
      function (e, o) {
        return e.fold(
          ...
          function (r) {
            return Ya(E(r.getClientRects()), E(o.getClientRects()), function (
              e,
              t
            ) {
  ...
  function ub(e, t, n, r) {
    ...
    if (!r.collapsed) {
      var a = yx(r);
      if (vx(a)) return Qh(e, t, a, e === Ms.Backwards, !0);
    }
    var u = (function (e) {
        return Ma(e.startContainer);
      })(r),
      s = Ss(e, t.getBody(), r);
    if (i(s)) return Zh(t, s.getNode(!o));
    var c = Wy.normalizePosition(o, n(s));
    if (!c) return u ? r : null;
    if (i(c)) return Qh(e, t, c.getNode(!o), o, !0);
    var l = n(c);
    return l && i(l) && As(c, l)
      ? Qh(e, t, l.getNode(!o), o, !0)
      : u
      ? tm(t, c.toRange(), !0)
      : null;
  }
  function sb(e, t, n, r) {
    ...
    if (
      ((d = yx(r)),
      (o = Ss(e, t.getBody(), r)),
      (i = n(t.getBody(), Vh(1), o)),
      (a = y(i, Ih(1))),
      (s = kn.last(o.getClientRects())),
      (Hh(o) || Bh(o)) && (d = o.getNode()),
      (Ph(o) || Oh(o)) && (d = o.getNode(!0)),
      !s)
    )
      return null;
    if (((c = s.left), (u = qh(a, c)) && vx(u.node)))
      return (
        (l = Math.abs(c - u.left)),
    ...
    if (d) {
      var h = (function (e, t, n, r) {
        ...
        l = o(
          (s =
            1 === e
              ? ((i = f.next), (a = qa), (u = ja), Ds.after(r))
              : ((i = f.prev), (a = ja), (u = qa), Ds.before(r)))
        );
        do {
          if (s.isVisible() && !u((c = o(s)), l)) {
            if (
              (0 < d.length && a(c, kn.last(d)) && h++,
              ((c = Ia(c)).position = s),
              (c.line = h),
              n(c))
            )
      ...
      if ((u = qh(y(h, Ih(1)), c))) return tm(t, u.position.toRange(), !0);
      if ((u = kn.last(y(h, Ih(0))))) return tm(t, u.position.toRange(), !0);
    }
  }
  function cb(e, t, n) {
    var r,
    ...
    if (n.collapsed && e.settings.forced_root_block) {
      ...
      (1 === t ? a(Ds.fromRangeStart(n)) : u(Ds.fromRangeStart(n))) ||
        ((o = (function (e) {
  ...
  function lb(t, n) {
    return function () {
      var e = (function (e, t) {
        ...
        return (n = ub(a, e, u, s)) ? n : (n = cb(e, a, s)) || null;
      })(t, n);
  ...
  function fb(t, n) {
    return function () {
      var e = (function (e, t) {
        ...
        return (n = sb(r, e, o, i)) ? n : (n = cb(e, r, i)) || null;
      })(t, n);
      return !!e && (t.selection.setRng(e), !0);
    };
  }
  function db(n, r) {
    return function () {
      var e = r
          ? Ds.fromRangeEnd(n.selection.getRng())
          : Ds.fromRangeStart(n.selection.getRng()),
        t = r ? mx(n.getBody(), e) : hx(n.getBody(), e);
  ...
  function mb(t, n) {
    return E(n.getClientRects())
      .bind(function (e) {
        return bx(t, e.left, e.top);
      })
      .bind(function (e) {
        return ab(
          (function (t) {
            return Pc.lastPositionIn(t)
              .map(function (e) {
                return hx(t, e).positions.concat(e);
              })
              .getOr([]);
          })(e),
          n
  ...
  function gb(t, n) {
    return N(n.getClientRects())
      ...
      .bind(function (e) {
        return ab(
          (function (t) {
            return Pc.firstPositionIn(t)
              .map(function (e) {
                return [e].concat(mx(t, e).positions);
              })
              .getOr([]);
          })(e),
          n
  ...
  function pb(e, t) {
    e.selection.setRng(t), jv(e, t);
  }
  function vb(e, t, n) {
    var r = e(t, n);
    return (function (e) {
      return e.breakType === Vy.Wrap && 0 === e.positions.length;
    })(r) ||
      (!Ge.isBr(n.getNode()) &&
        (function (e) {
          return e.breakType === Vy.Br && 1 === e.positions.length;
        })(r))
      ? !(function (t, n, e) {
          return e.breakAt
            .map(function (e) {
  ...
  function Cb(n, r, o) {
    ...
    e.fold(
      function () {
        return pb(n, o.toRange());
      },
      function (t) {
        return Pc.positionIn(i, n.getBody())
          .filter(function (e) {
            return e.isEqual(o);
          })
          .fold(
              ...
              return (function (n, r, o, e) {
                ...
                i
                  ? r.undoManager.transact(function () {
                      ...
                      me(e, gf(r)),
                        Di(e, yt.fromTag("br")),
                        n ? wi(yt.fromDom(o), e) : Ci(yt.fromDom(o), e);
                      var t = r.dom.createRng();
                      t.setStart(e.dom(), 0), t.setEnd(e.dom(), 0), pb(r, t);
                    })
                  : pb(r, e.toRange());
              })(r, n, t, o);
            }
    ...
    if (!t && wx(r, i)) {
      var u = (function (t, n, e) {
        return mb(n, e)
          .orThunk(function () {
            return E(e.getClientRects()).bind(function (e) {
              return ib(gx(t, Ds.before(n)), e.left);
            });
          })
          .getOr(Ds.before(n));
      })(a, n, i);
    ...
    if (t && xx(r, i)) {
      u = (function (t, n, e) {
        return gb(n, e)
          .orThunk(function () {
            return E(e.getClientRects()).bind(function (e) {
              return ib(px(t, Ds.after(n)), e.left);
            });
          })
          .getOr(Ds.after(n));
      })(a, n, i);
  ...
  function kb(e, t, n, r) {
    return "" === t
      ? (function (e, t) {
          var n = yt.fromTag("br");
          return Sb(e, n, t), Nb(n);
        })(e, r)
      : (function (e, t, n, r) {
          var o = yt.fromTag(n),
            i = yt.fromTag("br");
          return me(o, r), Di(o, i), Sb(e, o, t), Nb(i);
        })(e, r, t, n);
  }
  function Tb(e, t, n) {
    return t
  ...
  function Ab(t, n) {
    ...
    return (function (e, t) {
      var n = d(ze, t);
      return ba(yt.fromDom(e.container()), Vn, n).filter(Eb);
    })(o, r).exists(function () {
      if (Tb(r, n, o)) {
        var e = kb(r, i, a, n);
  ...
  function Mb(e, t) {
    return function () {
      return !!e.selection.isCollapsed() && Ab(e, t);
    };
  }
  function Rb(e, t) {
    return v(
  ...
  function Bb(t, n, e) {
    var r = _b(t, Ds.fromRangeStart(e)),
      o = r.bind(function (e) {
        return Pc.fromPosition(n, t, e.position()).bind(function (e) {
          return _b(t, e).map(function (e) {
            return (function (t, n, r) {
              return Ge.isBr(r.position().getNode()) && !1 === Sg(r.block())
                ? Pc.positionIn(!1, r.block().dom())
                    .bind(function (e) {
                      return e.isEqual(r.position())
                        ? Pc.fromPosition(n, t, e).bind(function (e) {
                            return _b(t, e);
                          })
                        : k.some(r);
                    })
    ...
    return Ya(r, o, Db).filter(function (e) {
      return (
        (function (e) {
  ...
  function Hb(e, t) {
    var n = lh(t, e);
    return g(n.reverse(), Sg).each(_i);
  }
  function Pb(e, t, n, r) {
    if (Sg(n)) return yg(n), Pc.firstPositionIn(n.dom());
    (function (e) {
      return (
        0 ===
        y(Ae(e), function (e) {
  ...
  function Lb(e, t, n) {
    if (Sg(n)) return _i(n), Sg(t) && yg(t), Pc.firstPositionIn(t.dom());
  ...
  function Fb(e, t, n) {
    return Ib(!0, t), Ib(!1, n), Vb(t, n).fold(d(Lb, e, t, n), d(Pb, e, t, n));
  }
  function Ub(e, t) {
    var n = yt.fromDom(t),
      r = d(ze, e);
  ...
  function jb(e, t) {
    ...
    return (
      !(function (e, t) {
        return Ub(e, t.startContainer) || Ub(e, t.endContainer);
      })(e, t) &&
      n &&
      r
    );
  ...
  function qb(e) {
    ...
    return jb(t, n)
      ...
      : (function (n, r) {
          var o = r.getRng();
          return Ya(
            Sx(n, yt.fromDom(o.startContainer)),
            Sx(n, yt.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === ze(e, t) &&
                (o.deleteContents(),
                Mx(n, !0, e, t).each(function (e) {
                  r.setRng(e.toRange());
                }),
                !0)
              );
  ...
  function Wb(e, t, n) {
    var r = y(lh(yt.fromDom(n.container()), t), Vn),
      o = E(r).getOr(t);
    return Pc.fromPosition(e, o.dom(), n).filter($b);
  }
  function Kb(e, t) {
    return ks(t).exists(_n) || Wb(!0, e, t).isSome();
  }
  function Xb(e, t) {
    return (
      (function (e) {
        return k.from(e.getNode(!0)).map(yt.fromDom);
      })(t).exists(_n) || Wb(!1, e, t).isSome()
    );
  }
  function Yb(e, t, n, r) {
    var o = r.getNode(!1 === t);
    return Sx(yt.fromDom(e), yt.fromDom(n.getNode()))
      .map(function (e) {
        return Sg(e) ? Ox.remove(e.dom()) : Ox.moveToElement(o);
      })
      .orThunk(function () {
        return k.some(Ox.moveToElement(o));
      });
  }
  function Gb(t, n, r) {
    ...
    return (function (e, t) {
      ...
      ? (function (e, t) {
          return e && Ge.isContentEditableFalse(t.nextSibling)
            ? k.some(Ox.moveToElement(t.nextSibling))
            : !1 === e && Ge.isContentEditableFalse(t.previousSibling)
            ? k.some(Ox.moveToElement(t.previousSibling))
            : k.none();
        })(e, n.getNode(!1 === e)).fold(function () {
          return Gb(t, e, n);
        }, k.some)
      : Gb(t, e, n).bind(function (e) {
          return (function (t, n, e) {
            return e.fold(
              function (e) {
                return k.some(Ox.remove(e));
              },
              function (e) {
                return k.some(Ox.moveToElement(e));
              },
              function (e) {
                return Cs(n, e, t) ? k.none() : k.some(Ox.moveToPosition(e));
              }
            );
          })(t, n, e);
        });
        ...
        function () {
          return (function (e, t, n) {
            var r = Es(t ? 1 : -1, e, n),
              ...
              i = yt.fromDom(e);
            return !1 === t && Ph(o)
              ? k.some(Ox.remove(o.getNode(!0)))
              : t && Hh(o)
              ? k.some(Ox.remove(o.getNode()))
              : !1 === t && Hh(o) && Xb(i, o)
              ? _x(i, o).map(function (e) {
                  return Ox.remove(e.getNode());
                })
              : t && Ph(o) && Kb(i, o)
              ? Bx(i, o).map(function (e) {
                  return Ox.remove(e.getNode());
                })
              : Jb(e, t, o);
        ...
        .fold(
          function () {
            return (
              ...
              })(yt.fromDom(e.getBody())),
              kg(e, t, yt.fromDom(e.selection.getNode())),
              kx(e),
              !0
            );
          },
  ...
  function nC(t, n) {
    return function (e) {
      return qy(n, e)
        .map(function (e) {
          return tb.setCaretPosition(t, e), !0;
        })
        .getOr(!1);
    };
  }
  function rC(e, t, n, r) {
    ...
    e.undoManager.ignore(function () {
      e.selection.setRng(
        ...
        Gy(i, o, Ds.fromRangeStart(e.selection.getRng())).map(Zy).map(nC(e, t));
    }),
      e.nodeChanged();
  }
  function oC(n, r, o, i) {
    var a = (function (e, t) {
      ...
      u = d(Wy.isInlineTarget, n),
      s = Gy(u, a, i);
    return s
      .bind(function (e) {
        return o
          ? e.fold($(k.some(Zy(e))), k.none, $(k.some(Qy(e))), k.none)
          : e.fold(k.none, $(k.some(Qy(e))), k.none, $(k.some(Zy(e))));
      })
      .map(nC(n, r))
      .getOrThunk(function () {
        ...
        return s.isSome() && e.isSome()
          ? Wy.findRootInline(u, a, i)
              .map(function (e) {
                return (
                  !!(function (o) {
                    return Ya(
                      Pc.firstPositionIn(o),
                      Pc.lastPositionIn(o),
                      function (e, t) {
                        var n = Wy.normalizePosition(!0, e),
                          r = Wy.normalizePosition(!1, t);
                        return Pc.nextPosition(o, n)
                          .map(function (e) {
                            return e.isEqual(r);
                          })
                          .getOr(!0);
          ...
          : e
              .bind(function (e) {
                return t.map(function (e) {
                  return o ? rC(n, r, i, e) : rC(n, r, e, i), !0;
                });
              })
              .getOr(!1);
      });
  ...
  function dC(e, n) {
    return lC(e.start(), n).bind(function (t) {
      return lC(e.end(), n).bind(function (e) {
        return (function (e, t) {
  ...
  function mC(n, e) {
    var t = cC(e.startContainer, n),
      r = cC(e.endContainer, n);
    return e.collapsed
      ? k.none()
      : Ya(t, r, sC).fold(
          function () {
            return t.fold(
              function () {
                return r.bind(function (t) {
                  return lC(t, n).bind(function (e) {
                    return E(hC(e)).map(function (e) {
                      return sC(e, t);
                    });
                  });
                });
          ...
          function (e) {
            return jx(n, e)
              ? k.none()
              : (function (t, e) {
                  return lC(t.start(), e).bind(function (e) {
                    return N(hC(e)).map(function (e) {
                      return sC(t.start(), e);
                    });
                  });
  ...
  function pC(e, t) {
    ...
    return (function (e, t) {
      var n = cC(e.startContainer, t),
        r = cC(e.endContainer, t);
      return Ya(n, r, sC)
        .filter(fC)
        .filter(function (e) {
          return jx(t, e);
  ...
  function yC(n) {
    return (function (n) {
      return Ya(
        vC(n.cells(), n.rng().start()),
        vC(n.cells(), n.rng().end()),
        function (e, t) {
      ...
      return e.length === t.length
        ? Ux.removeTable(n.table())
        : Ux.emptyCells(e);
    });
  }
  function bC(e, t) {
    return z(t, yg), e.selection.setCursorLocation(t[0].dom(), 0), !0;
  }
  function CC(e, t) {
    return kg(e, !1, t), !0;
  }
  function wC(t, e, n) {
    return (function (e, t) {
      return pC(e, t).bind(yC);
    })(e, n).map(function (e) {
      return e.fold(d(CC, t), d(bC, t));
    });
  }
  function xC(t, e, n, r) {
    return qx(e, r)
  ...
  function EC(t, n, r, o, i) {
    return Pc.navigate(r, t.getBody(), i)
      .bind(function (e) {
        return (function (e, n, r, o) {
          ...
          : (function (e, t, n) {
              return qx(e, yt.fromDom(n.getNode())).map(function (e) {
                return !1 === ze(e, t);
              });
            })(n, o, e);
      })
        ...
        return Sg(e)
          ...
          : (function (e, t, n, r, o) {
              return Pc.navigate(n, e.getBody(), o).bind(function (e) {
                return zC(t, yt.fromDom(e.getNode())).map(function (e) {
                  return !1 === ze(e, r);
                });
              });
            })(t, r, n, e, o);
    ...
    return qx(r, e).fold(
      ...
      function (e) {
        return (function (e, t, n, r) {
          ...
          return Sg(r) ? $x(e, r) : EC(e, n, t, r, o);
        })(t, n, r, e).getOr(!1);
      }
    );
  }
  ...
  function DC(e, t) {
    ...
    e.queryCommandState("InsertUnorderedList") ||
      ...
      z(Xx(e), function (e) {
        !(function (e, t, n, r, o, i) {
          var a = AC(n, yt.fromDom(i));
          if ("outdent" === t) {
            var u = Math.max(0, TC(i.style[a]) - r);
  ...
  function _C(e, t, n) {
    return Pc.navigateIgnore(e, t, n, Ch);
  }
  function BC(e, t) {
    return g(lh(yt.fromDom(t.container()), e), Vn);
  }
  function OC(e, n, r) {
    return _C(e, n.dom(), r).forall(function (t) {
      return BC(n, r).fold(
        function () {
  ...
  function HC(t, n, r) {
    return BC(n, r).fold(
      function () {
        return _C(t, n.dom(), r).forall(function (e) {
          return !1 === Cs(e, r, n.dom());
        });
      },
      function (e) {
        return _C(t, e.dom(), r).isNone();
      }
    );
  }
  function PC(e) {
  ...
  function $C(e, t, n) {
    return !1 === Ge.isText(t)
      ? n
      : e
      ? 1 === n && t.data.charAt(n - 1) === cu
        ? 0
        : n
      : n === t.data.length - 1 && t.data.charAt(n) === cu
      ? t.data.length
      : n;
  }
  function WC(e, t) {
  ...
  function GC(e, t) {
    ...
    "LI" !== d || h || (l = f),
      s &&
        ...
        !(function (e, t, n) {
          for (
            var r, o = new yi(t, n), i = e.getNonEmptyElements();
            (r = o.next());
  ...
  function QC(e, t) {
    sz(e.getBody(), t) || wi(yt.fromDom(t), yt.fromTag("br"));
    var n = yt.fromTag("br");
    wi(yt.fromDom(t), n),
      XC(e.dom, e.selection, n.dom()),
      YC(e.dom, e.selection, n.dom(), !1),
      e.undoManager.add();
  }
  function ZC(e) {
  ...
  function fw(e) {
    var t = mf(e),
      n = nz(e.dom, e.selection.getStart());
  ...
  function hw(n, r) {
    var e = r.container(),
      t = r.offset();
    return Ge.isText(e)
      ? (e.insertData(t, n), k.some(Uu(e, t + n.length)))
      : ks(r).map(function (e) {
          var t = yt.fromText(n);
  ...
  function gw(e, t) {
    var n = y(lh(yt.fromDom(t.container()), e), Vn);
    return E(n).getOr(e);
  }
  function pw(e, t) {
    return mw(t)
      ? Rh(t)
      : Rh(t) || Pc.prevPosition(gw(e, t).dom(), t).exists(Rh);
  }
  function vw(e, t) {
    return mw(t)
      ? Mh(t)
      : Mh(t) || Pc.nextPosition(gw(e, t).dom(), t).exists(Mh);
  }
  function yw(e) {
    return ks(e)
      .bind(function (e) {
  ...
  function Cw(e, t) {
    ...
    return !yw(n) && (Gx(e, n) || Qx(e, n) || Kb(e, n) || vw(e, n));
  }
  function ww(e, t) {
    return (
      (function (e, t) {
        return !yw(t) && (Yx(e, t) || Jx(e, t) || Xb(e, t) || pw(e, t));
      })(e, t) || Cw(e, t)
    );
  }
  function xw(e, t) {
    return Ah(e.charAt(t));
  }
  function zw(e) {
    var t = e.container();
    ...
    return k
      ...
      .bind(function (e) {
        ...
        return (function (e, t) {
          var n = t.data,
            r = Uu(t, 0);
          return !(!xw(n, 0) || ww(e, r)) && ((t.data = " " + n.slice(1)), !0);
        })(n, t) ||
          Ew(t) ||
          (function (e, t) {
            var n = t.data,
  ...
  function Sw(t) {
    ...
    t.selection.isCollapsed() &&
      Nw(e, Uu.fromRangeStart(t.selection.getRng())).each(function (e) {
  ...
  function kw(t, n) {
    return function (e) {
      return (function (e, t) {
        return !yw(t) && (bw(e, t) || pw(e, t) || vw(e, t));
      })(t, e)
        ? pz(n)
        : vz(n);
    };
  ...
  function Tw(e) {
    ...
    if (e.selection.isCollapsed()) {
      var r = d(Wy.isInlineTarget, e),
        o = Ds.fromRangeStart(e.selection.getRng());
      return Gy(r, e.getBody(), o)
        .bind(
          (function (t) {
            return function (e) {
              return e.fold(
  ...
  function Mw(e, t) {
    var n = (function (e) {
      return wa(yt.fromDom(e.getBody()), "*[data-mce-caret]").fold(
        $(null),
        function (e) {
          return e.dom();
        }
    ...
    if (n)
      return "compositionstart" === t.type
        ? (t.preventDefault(), t.stopPropagation(), void Aw(e, n))
        : void (_a(n) && (Aw(e, n), e.undoManager.add()));
  }
  function Rw(t) {
    !(function (e) {
      var t = aa(function () {
    ...
    return (
      ...
      Nn.windowsPhone ||
        a.on(
          ...
          function (e) {
            Th.modifierPressed(e) || l.normalize();
          },
          !0
        ),
      g &&
      ...
      3 <= e.detail &&
        (function (e) {
          ...
          if (Uu.isElementPosition(n)) {
            var o = n.container();
            _w(o) &&
              Pc.firstPositionIn(o).each(function (e) {
          ...
          if (Uu.isElementPosition(r)) {
            o = n.container();
            _w(o) &&
              Pc.lastPositionIn(o).each(function (e) {
                return t.setEnd(e.container(), e.offset());
              });
          }
          e.selection.setRng(lp(t));
        })(t);
    });
  }
  function Ow(e) {
  ...
  function Fw(e) {
    ...
    return e.inline
      ...
      : (function (e) {
          var t = kz.create("div");
          return kz.insertAfter(t, e), Iw(t);
        })(t);
  }
  function Uw(e) {
    return "-" === e.charAt(0);
  ...
  function qw(e, t) {
    ...
    !(function (e, t, n, r) {
      var o = t.settings,
        i = o.theme;
      if (K(i)) {
        if (!Uw(i) && !jd.urls.hasOwnProperty(i)) {
          var a = o.theme_url;
          a
      ...
      !(function (e, t) {
        ...
        (function (n, r) {
          A(n.plugins) && (n.plugins = n.plugins.join(" ")),
            Mn.each(n.external_plugins, function (e, t) {
    ...
    $w(n, "mce-content-readonly", t),
      t
        ...
        : ((e.readonly = !1),
          Kw(n, !0),
          (function (e) {
            z(ma(e, "*[" + Dz + '="true"]'), function (e) {
              pe(e, Dz), Kw(e, !0);
            });
          })(n),
          Ww(e, "StyleWithCSS", !1),
          Ww(e, "enableInlineTableEditing", !1),
          Ww(e, "enableObjectResizing", !1),
          sd(e) && e.focus(),
          (function (e) {
            e.selection.setRng(e.selection.getRng());
          })(e),
  ...
  function Gw(t) {
    t.parser.addAttributeFilter("contenteditable", function (e) {
      Yw(t) &&
        z(e, function (e) {
          e.attr(Dz, e.attr("contenteditable")),
            e.attr("contenteditable", "false");
        });
    }),
      t.serializer.addAttributeFilter(Dz, function (e) {
        Yw(t) &&
          z(e, function (e) {
            e.attr("contenteditable", e.attr(Dz));
          });
      }),
      t.serializer.addTempAttr(Dz);
  }
  function Jw(e, t, n, r) {
    var o = n[t.get()],
      i = n[r];
    ...
    o.deactivate(),
      o.editorReadOnly !== i.editorReadOnly && Xw(e, i.editorReadOnly),
      t.set(r),
      hd(e, r);
  }
  function Qw(t) {
  ...
  function ax(e, t, n) {
    ...
    if (
      ...
      p === v &&
        ...
        m.setRng(l)),
        m.isCollapsed() ||
          (e.selection.setRng(lp(e.selection.getRng())),
      ...
      if (((u = r.parse(t, y)), !0 === n.paste && Bz(e.schema, u) && Hz(g, i)))
        return (
          (l = Oz(o, g, e.selection.getRng(), u)),
      ...
      !(function (e, t) {
        ...
        (function (e, t) {
          k.from(e.getParent(t, "td,th")).map(yt.fromDom).each(bg);
  ...
  var hx = d(rb, Uu.isAbove, -1),
    mx = d(rb, Uu.isBelow, 1),
    gx = d(ob, -1, hx),
    px = d(ob, 1, mx),
    vx = Ge.isContentEditableFalse,
    yx = Wa,
    bx = d(
      hb,
      function (e) {
      ...
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t, n) {
            ...
            Ex(
              [
                { keyCode: Th.RIGHT, action: lb(e, !0) },
                { keyCode: Th.LEFT, action: lb(e, !1) },
                { keyCode: Th.UP, action: fb(e, !1) },
                { keyCode: Th.DOWN, action: fb(e, !0) },
                { keyCode: Th.RIGHT, action: xb(e, !0) },
                { keyCode: Th.LEFT, action: xb(e, !1) },
                { keyCode: Th.UP, action: zb(e, !1) },
                { keyCode: Th.DOWN, action: zb(e, !0) },
                { keyCode: Th.RIGHT, action: tb.move(e, t, !0) },
                { keyCode: Th.LEFT, action: tb.move(e, t, !1) },
                {
                  keyCode: Th.RIGHT,
                  ctrlKey: !r.isOSX(),
                  altKey: r.isOSX(),
                  action: tb.moveNextWord(e, t),
                },
                {
                  keyCode: Th.LEFT,
                  ctrlKey: !r.isOSX(),
                  altKey: r.isOSX(),
                  action: tb.movePrevWord(e, t),
                },
                { keyCode: Th.UP, action: Mb(e, !1) },
                { keyCode: Th.DOWN, action: Mb(e, !0) },
              ],
              n
            ).each(function (e) {
              n.preventDefault();
    ...
    Ax = function (e, t, n) {
      return n.collapsed ? Bb(e, t, n) : k.none();
    },
    Mx = function (e, t, n, r) {
    ...
    Rx = function (t, n) {
      var r = yt.fromDom(t.getBody()),
        e = Ax(r.dom(), n, t.selection.getRng()).bind(function (e) {
          return Mx(r, n, e.from().block(), e.to().block());
        });
      return (
        e.each(function (e) {
          t.selection.setRng(e.toRange());
    ...
    Dx = function (e, t) {
      return !e.selection.isCollapsed() && qb(e);
    },
    _x = d(Wb, !1),
    Bx = d(Wb, !0),
    Ox = jf([
    ...
    Px = function (e, t) {
      return e.selection.isCollapsed() ? Zb(e, t) : eC(e, t);
    },
    Lx = function (e) {
      var t,
        n = Hx(e.getBody(), e.selection.getNode());
      return (
        Ge.isContentEditableTrue(n) &&
          ...
          e.dom.setHTML(n, ""),
          n.appendChild(t),
          e.selection.setRng(Ds.before(t).toRange())),
        !0
      );
    },
    Vx = function (e, t) {
      return (function (e, t) {
        ...
        var r = t ? Ms.Forwards : Ms.Backwards,
          ...
          s = t ? Hh : Ph,
          c = Ss(r, e.getBody(), n),
          l = Wy.normalizePosition(t, u(c));
        if (!l) return !1;
        if (s(l)) return tC(e, n, c.getNode(), r, t, l);
        var f = u(l);
        return !!(f && s(f) && As(l, f)) && tC(e, n, c.getNode(), r, t, f);
      })(e, t);
    },
    Ix = function (e, t, n) {
      if (
    ...
    Fx = function (e, t) {
      return !!e.selection.isCollapsed() && uC(e, t);
    },
    Ux = jf([{ removeTable: ["element"] }, { emptyCells: ["cells"] }]),
    jx = function (e, t) {
      return dC(t, e).isSome();
    },
    qx = function (e, t) {
    ...
    $x = function (e, t) {
      return yg(t), e.selection.setCursorLocation(t.dom(), 0), k.some(!0);
    },
    Wx = function (e, t) {
      ...
      return e.selection.isCollapsed() && 0 === r.length
        ...
        : (function (e, t) {
            var n = yt.fromDom(e.getBody()),
              r = e.selection.getRng(),
              o = ny(e);
            return 0 !== o.length ? bC(e, o) : xC(e, n, r, t);
          })(e, n);
    },
    Kx = function (e, t) {
      return (
        ...
        (function (t, n) {
          ...
          return Pc.fromPosition(n, t.getBody(), e)
            .filter(function (e) {
              return n ? Dh(e) : _h(e);
            })
            .bind(function (e) {
    ...
    Qx = d(OC, !0),
    Zx = function (e, t, n) {
      if (e.selection.isCollapsed() && MC(e)) {
        var r = e.dom,
          o = e.selection.getRng(),
          i = Ds.fromRangeStart(o),
          a = r.getParent(o.startContainer, r.isBlock);
        if (null !== a && Yx(yt.fromDom(a), i)) return DC(e, "outdent"), !0;
      }
      return !1;
    },
    ez = function (t, n) {
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t, n) {
            Ex(
              [
                { keyCode: Th.BACKSPACE, action: zx(Zx, e, !1) },
                { keyCode: Th.BACKSPACE, action: zx(Px, e, !1) },
                { keyCode: Th.DELETE, action: zx(Px, e, !0) },
                { keyCode: Th.BACKSPACE, action: zx(Vx, e, !1) },
                { keyCode: Th.DELETE, action: zx(Vx, e, !0) },
                { keyCode: Th.BACKSPACE, action: zx(Ix, e, t, !1) },
                { keyCode: Th.DELETE, action: zx(Ix, e, t, !0) },
                { keyCode: Th.BACKSPACE, action: zx(Wx, e, !1) },
                { keyCode: Th.DELETE, action: zx(Wx, e, !0) },
                { keyCode: Th.BACKSPACE, action: zx(Kx, e, !1) },
                { keyCode: Th.DELETE, action: zx(Kx, e, !0) },
                { keyCode: Th.BACKSPACE, action: zx(Dx, e, !1) },
                { keyCode: Th.DELETE, action: zx(Dx, e, !0) },
                { keyCode: Th.BACKSPACE, action: zx(Rx, e, !1) },
                { keyCode: Th.DELETE, action: zx(Rx, e, !0) },
                { keyCode: Th.BACKSPACE, action: zx(Fx, e, !1) },
                { keyCode: Th.DELETE, action: zx(Fx, e, !0) },
              ],
              n
            ).each(function (e) {
              n.preventDefault();
        ...
        t.on("keyup", function (e) {
          !1 === e.isDefaultPrevented() &&
            (function (e, t) {
              Ex(
                [
                  { keyCode: Th.BACKSPACE, action: zx(Lx, e) },
                  { keyCode: Th.DELETE, action: zx(Lx, e) },
                ],
                t
              );
            })(t, e);
    ...
    az = function (e, t, n, r, o) {
      var i = e.dom,
        a = e.selection.getRng();
      if (n !== e.getBody()) {
        !(function (e) {
          return VC(e) && VC(e.parentNode);
        })(n) || (o = "LI");
        var u = o ? t(o) : i.create("BR");
        if (FC(n, r, !0) && FC(n, r, !1))
          LC(n, "LI") ? i.insertAfter(u, IC(n)) : i.replace(u, n);
        else if (FC(n, r, !0))
          LC(n, "LI")
            ? (i.insertAfter(u, IC(n)),
              u.appendChild(i.doc.createTextNode(" ")),
              u.appendChild(n))
            : n.parentNode.insertBefore(u, n);
        else if (FC(n, r, !1)) i.insertAfter(u, IC(n));
        else {
          n = IC(n);
          var s = a.cloneRange();
    ...
    uz = function (a, e) {
      ...
      function n(e) {
        ...
        if (jC(s, "TABLE") || jC(s, "HR")) return (v && !e) || (!v && e);
        var o = new yi(s, c);
        for (
          Ge.isText(s) &&
        ...
        (u = WC(y, s)) &&
          (((p && !l) || (!p && l)) &&
            (s = (function (e, t, n, r, o) {
              var i,
                ...
                d = e.dom,
                h = WC(d, r);
              if (!(a = d.getParent(r, d.isBlock)) || !qC(d, a)) {
                if (
                  ((l =
                    (a = a || h) === e.getBody() ||
                    (function (e) {
          ...
          /^(LI|DT|DD)$/.test(m) && y.isEmpty(c)
            ...
            : (p && c === a.getBody()) ||
              ((p = p || "P"),
              Ma(c)
                ? ((f = Pa(c)), y.isEmpty(c) && UC(c), tz(a, f))
                : n()
                ? r()
                : n(!0)
                ...
                : ((o = (function (e) {
                    ...
                    return (
                      t.setStart(
                        e.startContainer,
                        $C(!0, e.startContainer, e.startOffset)
                      ),
                      t.setEnd(
                        e.endContainer,
                        $C(!1, e.endContainer, e.endOffset)
                      ),
                      t
                    );
                  ...
                  y.isEmpty(c) && UC(c),
                  f.normalize(),
                  y.isEmpty(f) ? (y.remove(f), r()) : tz(a, f)),
              y.setAttrib(f, "id", ""),
    ...
    cz = function (e, t) {
      var n = (function (e) {
        var t = d(Wy.isInlineTarget, e),
          n = Ds.fromRangeStart(e.selection.getRng());
        return Gy(t, e.getBody(), n).filter(ew);
      })(e);
      n.isSome() ? n.each(d(tw, e)) : GC(e, t);
    },
    lz = function (e) {
      return nw(e, pf(e));
    },
    ...
    hz = function (e, t) {
      return Ky(
        [
          dw([rw], dz.none()),
          dw([aw("summary", !0)], dz.br()),
          dw([uw(!0), sw(!1), lw], dz.br()),
          dw([uw(!0), sw(!1)], dz.block()),
          dw([uw(!0), sw(!0), lw], dz.block()),
          dw([uw(!0), sw(!0)], dz.br()),
          dw([iw(!0), lw], dz.br()),
          dw([iw(!0)], dz.block()),
    ...
    yz = function (t) {
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t) {
            Ex([{ keyCode: Th.SPACEBAR, action: zx(Tw, e) }], t).each(function (
              e
            ) {
              t.preventDefault();
            });
    ...
    bz = function (e) {
      e.on("keyup compositionstart", d(Mw, e));
    },
    Cz = oe().browser,
    wz = function (t) {
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t) {
            Ex(
              [
                { keyCode: Th.END, action: db(e, !0) },
                { keyCode: Th.HOME, action: db(e, !1) },
              ],
              t
            ).each(function (e) {
              t.preventDefault();
    ...
    xz = function (e) {
      var t = tb.setupSelectedState(e);
      bz(e), Nx(e, t), ez(e, t), gz(e), yz(e), Rw(e), wz(e);
    },
    zz = Xi.DOM,
    Ez = function (t, e) {
      var n,
      ...
      o.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.inline &&
          (t.on("remove", function () {
            var e = this.getBody();
            zz.removeClass(e, "mce-content-body"),
              zz.removeClass(e, "mce-edit-focus"),
              zz.setAttrib(e, "contentEditable", null);
          }),
          zz.addClass(i, "mce-content-body"),
        ...
        t.readonly ||
          (t.inline &&
            "static" === zz.getStyle(n, "position", !0) &&
            ...
            e.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (e) {
              for (
                ...
                (t = e[n]).isEmpty(r) &&
                  ...
                  (t.append(new ul("br", 1)).shortEnded = !0);
            }),
            e
          );
        })(t)),
        (t.serializer = Tp(o, t)),
        (t.selection = cy(t.dom, t.getWin(), t.serializer, t)),
        (t.annotator = nl(t)),
        (t.formatter = bp(t)),
        (t.undoManager = hm(t)),
        (t._nodeChangeDispatcher = new gh(t)),
        (t._selectionOverrides = rm(t)),
        Ow(t),
        Bw(t),
        xz(t),
        fh(t),
        ...
        o.browser_spellcheck ||
          o.gecko_spellcheck ||
          ((a.body.spellcheck = !1), zz.setAttrib(n, "spellcheck", "false")),
        (t.quirks = Dw(t)),
        t.fire("PostRender");
      var u = Vf(t);
      u !== undefined && (n.dir = u),
        ...
        0 < t.contentStyles.length &&
          ((r = ""),
          Mn.each(t.contentStyles, function (e) {
            r += e + "\r\n";
          }),
          t.dom.addStyle(r)),
        (function (e) {
          return e.inline ? zz.styleSheetLoader : e.dom.styleSheetLoader;
        })(t).loadAll(
          t.contentCSS,
          function (e) {
            Hw(t);
    ...
    Sz = function (e, t) {
      var n = Pw(e, t);
      t.editorContainer &&
        ((Nz.get(t.editorContainer).style.display = e.orgDisplay),
        (e.hidden = Nz.isHidden(t.editorContainer))),
        (e.getElement().style.display = "none"),
        Nz.setAttrib(e.id, "aria-hidden", "true"),
        n || Ez(e);
    },
    kz = Xi.DOM,
    Tz = function (t, n, e) {
      ...
      if (((e = Mn.trim(e)), r && -1 === Mn.inArray(n, e))) {
        if (
          (Mn.each(Ud.dependencies(e), function (e) {
            Tz(t, n, e);
          }),
          t.plugins[e])
        )
    ...
    Rz = function (t) {
      ...
      ra.setCode(Bf(t));
      var r = function () {
        Mz.unbind(j.window, "ready", r), t.render();
      };
      if (kr.Event.domLoaded) {
        if (t.getElement() && Nn.contentEditable) {
          ...
          var o = t.getElement().form || Mz.getParent(n, "form");
          o &&
            ((t.formElement = o),
            e.hidden_input &&
              !Ge.isTextareaOrInput(t.getElement()) &&
              (Mz.insertAfter(
                Mz.create("input", { type: "hidden", name: n }),
                n
              ),
              (t.hasHiddenInput = !0)),
            ...
            Mz.bind(o, "submit reset", t.formEventDelegate),
            t.on("reset", function () {
              t.resetContent();
            }),
            !e.submit_patch ||
            ...
            "xml" === e.encoding &&
              t.on("GetContent", function (e) {
                e.save && (e.content = Mz.encode(e.content));
              }),
      ...
      } else Mz.bind(j.window, "ready", r);
    },
    Dz = "data-mce-contenteditable",
    _z = ["design", "readonly"],
    Bz = function (e, t) {
      var n = t.firstChild,
        r = t.lastChild;
    ...
    Oz = function (e, o, i, t) {
      ...
      var r = (function (e, t, n) {
        ...
        a = nx(o, i.startContainer),
        u = tx(Zw(r.firstChild)),
        s = o.getRoot();
      return n(1)
        ? ox(a, u, s)
        : n(2)
        ? (function (e, t, n, r) {
            return r.insertAfter(t.reverse(), e), rx(t[0], n);
          })(a, u, s, o)
        : (function (t, e, n, r) {
            var o = (function (e, t) {
                var n = t.cloneRange(),
    ...
    Pz = Ge.matchNodeNames(["td", "th"]),
    Lz = function (e, t) {
      var n = (function (e) {
        var t;
        return "string" != typeof e
          ? ((t = Mn.extend({ paste: e.paste, data: { paste: e.paste } }, e)),
            { content: e.content, details: t })
          : { content: e, details: {} };
      })(t);
      ax(e, n.content, n.details);
    },
    Vz = function (e) {
      Zx(e, !1) ||
        Px(e, !1) ||
    ...
    qz = Mn.inArray,
    $z =
      ((Wz.prototype.execCommand = function (t, n, r, e) {
        var o,
          i,
          a = !1,
          u = this;
        if (!u.editor.removed) {
          ...
          if (
            (Uz(this.editor.plugins, function (e) {
      ...
      (Wz.prototype.queryCommandState = function (e) {
        var t;
      ...
      (Wz.prototype.queryCommandValue = function (e) {
        var t;
        if (!this.editor.quirks.isHidden() && !this.editor.removed) {
      ...
      (Wz.prototype.addCommands = function (e, n) {
        var r = this;
        (n = n || "exec"),
          Uz(e, function (t, e) {
            Uz(e.toLowerCase().split(","), function (e) {
              r.commands[n][e] = t;
            });
          });
      }),
      (Wz.prototype.addCommand = function (e, o, i) {
        var a = this;
        (e = e.toLowerCase()),
      ...
      (Wz.prototype.queryCommandSupported = function (e) {
      ...
      (Wz.prototype.addQueryStateHandler = function (e, t, n) {
        var r = this;
        (e = e.toLowerCase()),
      ...
      (Wz.prototype.addQueryValueHandler = function (e, t, n) {
        var r = this;
        (e = e.toLowerCase()),
      ...
      (Wz.prototype.hasCustomCommand = function (e) {
        return (e = e.toLowerCase()), !!this.commands.exec[e];
      }),
      (Wz.prototype.execNativeCommand = function (e, t, n) {
        return (
          t === undefined && (t = !1),
          n === undefined && (n = null),
      ...
      (Wz.prototype.isFormatMatch = function (e) {
        return this.editor.formatter.match(e);
      }),
      (Wz.prototype.toggleFormat = function (e, t) {
        this.editor.formatter.toggle(e, t ? { value: t } : undefined),
          this.editor.nodeChanged();
      }),
      (Wz.prototype.storeSelection = function (e) {
        this.selectionBookmark = this.editor.selection.getBookmark(e);
      }),
      (Wz.prototype.restoreSelection = function () {
        this.editor.selection.moveToBookmark(this.selectionBookmark);
      }),
      (Wz.prototype.setupCommands = function (i) {
        var a = this;
        function e(n) {
          return function () {
        ...
        this.addCommands({
          ...
          "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone": function (
            ...
            var t = e.substring(7);
            "full" === t && (t = "justify"),
              Uz("left,center,right,justify".split(","), function (e) {
          ...
          FontSize: function (e, t, n) {
            !(function (e, t) {
              e.formatter.toggle("fontsize", { value: fx(e, t) }),
                e.nodeChanged();
            })(i, n);
          },
              ...
              return (function (t) {
                return lx(t).fold(
                  function () {
                    return cx(t)
                      .map(function (e) {
                        return Fz.getFontFamily(t.getBody(), e);
                      })
                      .getOr("");
                  },
                  function (e) {
              ...
              return (function (t) {
                return lx(t).fold(
                  function () {
                    return cx(t)
                      .map(function (e) {
                        return Fz.getFontSize(t.getBody(), e);
                      })
                      .getOr("");
                  },
                  function (e) {
  ...
  var Kz = Mn.makeMap(
    ...
    Xz =
      ((Yz.isNative = function (e) {
        return !!Kz[e.toLowerCase()];
      }),
      (Yz.prototype.fire = function (e, t) {
        var n, r, o, i;
        if (
          ((e = e.toLowerCase()),
          ((t = t || {}).type = e),
      ...
      (Yz.prototype.on = function (e, t, n, r) {
        var o, i, a;
        if ((!1 === t && (t = c), t)) {
          var u = { func: t };
          for (
            r && Mn.extend(u, r), a = (i = e.toLowerCase().split(" ")).length;
            a--;
      ...
      (Yz.prototype.once = function (e, t, n) {
        return this.on(e, t, n, { once: !0 });
      }),
      (Yz.prototype.has = function (e) {
        return (
          (e = e.toLowerCase()),
  ...
  function Gz(n) {
    return (
      n._eventDispatcher ||
        (n._eventDispatcher = new Xz({
          scope: n,
          toggleEvent: function (e, t) {
            Xz.isNative(e) && n.toggleNativeEvent && n.toggleNativeEvent(e, t);
          },
        })),
      n._eventDispatcher
    );
  ...
  function Jz(e, t) {
    return "selectionchange" === t
      ...
      ? (e.eventRoot || (e.eventRoot = nE.select(e.settings.event_root)[0]),
        e.eventRoot)
      : e.getBody();
  }
  function Qz(e, t, n) {
    !(function (e) {
      return !e.hidden && !Yw(e);
    })(e)
      ? Yw(e) &&
        (function (e) {
          var t = e.target;
  ...
  function Zz(i, a) {
    ...
    if ((i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed))
      if (((e = Jz(i, a)), i.settings.event_root)) {
        if (
          (eE ||
            ((eE = {}),
            i.editorManager.on("removeEditor", function () {
              var e;
              if (!i.editorManager.activeEditor && eE) {
                for (e in eE) i.dom.unbind(Jz(i, e));
                eE = null;
              }
            })),
          eE[a])
        ...
        (t = function (e) {
          for (
            ...
            var o = n[r].getBody();
            (o !== t && !nE.isChildOf(t, o)) || Qz(n[r], a, e);
          }
        }),
          (eE[a] = t),
          nE.bind(e, a, t);
  ...
  var eE,
    tE = {
      ...
      on: function (e, t, n) {
        return Gz(this).on(e, t, n);
      },
      off: function (e, t) {
        return Gz(this).off(e, t);
      },
      once: function (e, t) {
        return Gz(this).once(e, t);
      },
      hasEventListeners: function (e) {
        return Gz(this).has(e);
      },
    },
    nE = Xi.DOM,
    rE = G(G({}, tE), {
      ...
      toggleNativeEvent: function (e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(Jz(n, e), e, n.delegates[e]),
      ...
      unbindAllNativeEvents: function () {
        var e,
          ...
          r = t.dom;
        if (t.delegates) {
          for (e in t.delegates) t.dom.unbind(Jz(t, e), e, t.delegates[e]);
          delete t.delegates;
        }
        !t.inline &&
          n &&
    ...
    uE = Mn.makeMap("alt,ctrl,shift,meta,access"),
    sE =
      ((cE.prototype.add = function (e, n, r, o) {
        var t,
          i = this;
        return (
          "string" == typeof (t = r)
      ...
      (cE.prototype.parseShortcut = function (e) {
        var t,
          n,
          r = {};
        for (n in (oE(iE(e.toLowerCase(), "+"), function (e) {
          e in uE
            ? (r[e] = !0)
            : /^[0-9]{2,}$/.test(e)
        ...
        return (
          (r.id = t.join(",")),
          r.access && ((r.alt = !0), Nn.mac ? (r.ctrl = !0) : (r.shift = !0)),
          r.meta && (Nn.mac ? (r.meta = !0) : ((r.ctrl = !0), (r.meta = !1))),
          r
        );
      }),
      (cE.prototype.createShortcut = function (e, t, n, r) {
        var o;
        return (
          ((o = Mn.map(iE(e, ">"), this.parseShortcut))[
            o.length - 1
          ] = Mn.extend(o[o.length - 1], { func: n, scope: r || this.editor })),
          Mn.extend(o[0], {
      ...
      (cE.prototype.hasModifier = function (e) {
        return e.altKey || e.ctrlKey || e.metaKey;
      }),
      (cE.prototype.isFunctionKey = function (e) {
        return "keydown" === e.type && 112 <= e.keyCode && e.keyCode <= 123;
      }),
      (cE.prototype.matchShortcut = function (e, t) {
        return (
          !!t &&
          t.ctrl === e.ctrlKey &&
          t.meta === e.metaKey &&
      ...
      (cE.prototype.executeShortcutAction = function (e) {
  ...
  var lE = Mn.each,
    fE = Mn.trim,
    dE = "source protocol authority userInfo user password host port relative path directory file query anchor".split(
      " "
    ),
    hE = { ftp: 21, http: 80, https: 443, mailto: 25 },
    mE =
      ((gE.parseDataUri = function (e) {
        var t,
          n = decodeURIComponent(e).split(","),
          r = /data:([^;]+)/.exec(n[0]);
        return r && (t = r[1]), { type: t, data: n[1] };
      }),
      (gE.getDocumentBaseUrl = function (e) {
        var t;
        return (
          (t =
      ...
      (gE.prototype.setPath = function (e) {
        var t = /^(.*?)\/?(\w+)?$/.exec(e);
        (this.path = t[0]),
          (this.directory = t[1]),
          (this.file = t[2]),
      ...
      (gE.prototype.toRelative = function (e) {
        var t;
        if ("./" === e) return e;
        var n = new gE(e, { base_uri: this });
        if (
      ...
      (gE.prototype.toAbsolute = function (e, t) {
        var n = new gE(e, { base_uri: this });
        return n.getURI(t && this.isSameOrigin(n));
      }),
      (gE.prototype.isSameOrigin = function (e) {
      ...
      (gE.prototype.toRelPath = function (e, t) {
        var n,
          r,
          o,
          i = 0,
      ...
      (gE.prototype.toAbsPath = function (e, t) {
        var n,
          r,
          o,
          i = 0,
    ...
    if (/^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e)) r.source = e;
      ...
      if (
        ...
        var i = this.settings.base_uri
          ...
          : new gE(j.document.location.href).directory;
  ...
  var vE = Xi.DOM,
    ...
    xE =
      ...
      (zE.prototype.focus = function (e) {
        ad(this, e);
      }),
      (zE.prototype.hasFocus = function () {
        return ud(this);
      }),
      (zE.prototype.execCallback = function (e) {
        for (var t = [], n = 1; n < arguments.length; n++)
          t[n - 1] = arguments[n];
        var r,
          o = this.settings[e];
      ...
      (zE.prototype.getParam = function (e, t, n) {
        return ef(this, e, t, n);
      }),
      (zE.prototype.nodeChanged = function (e) {
        this._nodeChangeDispatcher.nodeChanged(e);
      }),
      (zE.prototype.addCommand = function (e, t, n) {
        this.editorCommands.addCommand(e, t, n);
      }),
      (zE.prototype.addQueryStateHandler = function (e, t, n) {
        this.editorCommands.addQueryStateHandler(e, t, n);
      }),
      (zE.prototype.addQueryValueHandler = function (e, t, n) {
        this.editorCommands.addQueryValueHandler(e, t, n);
      }),
      (zE.prototype.addShortcut = function (e, t, n, r) {
        this.shortcuts.add(e, t, n, r);
      }),
      (zE.prototype.execCommand = function (e, t, n, r) {
        return this.editorCommands.execCommand(e, t, n, r);
      }),
      (zE.prototype.queryCommandState = function (e) {
        return this.editorCommands.queryCommandState(e);
      }),
      (zE.prototype.queryCommandValue = function (e) {
        return this.editorCommands.queryCommandValue(e);
      }),
      (zE.prototype.queryCommandSupported = function (e) {
      ...
      (zE.prototype.show = function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (vE.show(this.getContainer()), vE.hide(this.id)),
          this.load(),
          this.fire("show"));
      }),
      (zE.prototype.hide = function () {
        var e = this,
          t = e.getDoc();
        e.hidden ||
          (wE && t && !e.inline && t.execCommand("SelectAll"),
          e.save(),
          e.inline
            ? ((e.getBody().contentEditable = "false"),
              e === e.editorManager.focusedEditor &&
                (e.editorManager.focusedEditor = null))
            : (vE.hide(e.getContainer()),
              vE.setStyle(e.id, "display", e.orgDisplay)),
          (e.hidden = !0),
          e.fire("hide"));
      }),
      (zE.prototype.isHidden = function () {
        return !!this.hidden;
      }),
      (zE.prototype.setProgressState = function (e, t) {
        this.fire("ProgressState", { state: e, time: t });
      }),
      (zE.prototype.load = function (e) {
        var t,
          n = this.getElement();
          ...
          return (
            ...
            Ge.isTextareaOrInput(o)
              ...
              : ((!e.is_removing && r.inline) || (o.innerHTML = t),
                (n = vE.getParent(r.id, "form")) &&
                  bE(n.elements, function (e) {
      ...
      (zE.prototype.setContent = function (e, t) {
        return jl(this, e, t);
      }),
      (zE.prototype.getContent = function (e) {
        return (function (t, n) {
          return (
            void 0 === n && (n = {}),
            k
              .from(t.getBody())
              .fold($("tree" === n.format ? new ul("body", 11) : ""), function (
                e
              ) {
                return ml(t, n, e);
              })
      ...
      (zE.prototype.insertContent = function (e, t) {
        t && (e = yE({ content: e }, t)),
          this.execCommand("mceInsertContent", !1, e);
      }),
      (zE.prototype.resetContent = function (e) {
        e === undefined
          ? jl(this, this.startContent, { format: "raw" })
          : jl(this, e),
          this.undoManager.reset(),
          this.setDirty(!1),
          this.nodeChanged();
      }),
      (zE.prototype.isDirty = function () {
        return !this.isNotDirty;
      }),
      (zE.prototype.setDirty = function (e) {
      ...
      (zE.prototype.getContainer = function () {
        return (
          this.container ||
            (this.container = vE.get(
              this.editorContainer || this.id + "_parent"
            )),
          this.container
        );
      }),
      (zE.prototype.getContentAreaContainer = function () {
        return this.contentAreaContainer;
      }),
      (zE.prototype.getElement = function () {
        return (
          this.targetElm || (this.targetElm = vE.get(this.id)), this.targetElm
        );
      }),
      (zE.prototype.getWin = function () {
        var e;
        return (
          this.contentWindow ||
      ...
      (zE.prototype.getBody = function () {
        var e = this.getDoc();
        return this.bodyElement || (e ? e.body : null);
      }),
      (zE.prototype.convertURL = function (e, t, n) {
        var r = this.settings;
      ...
      (zE.prototype.addVisual = function (e) {
        var n,
          r = this,
          o = r.settings,
          i = r.dom;
        (e = e || r.getBody()),
          ...
          bE(i.select("table,a", e), function (e) {
            var t;
            switch (e.nodeName) {
              case "TABLE":
                return (
      ...
      (zE.prototype.destroy = function (e) {
        Wl(this, e);
      }),
      (zE.prototype.uploadImages = function (e) {
        return this.editorUpload.uploadImages(e);
      }),
      (zE.prototype._scanForImages = function () {
        return this.editorUpload.scanForImages();
      }),
      (zE.prototype.addButton = function () {
        throw new Error(
  ...
  function zE(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      yE(this, rE),
      (this.settings = Ql(this, e, this.documentBaseUrl, n.defaultSettings, t)),
      ...
      this.settings.referrer_policy &&
        ...
        Xi.DOM.styleSheetLoader._setReferrerPolicy(
          this.settings.referrer_policy
        )),
      (ga.languageLoad = this.settings.language_load),
      (ga.baseURL = n.baseURL),
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new mE(this.settings.document_base_url, {
        base_uri: this.baseUri,
      })),
      (this.baseURI = this.baseUri),
      (this.inline = !!this.settings.inline),
      (this.shortcuts = new sE(this)),
      (this.editorCommands = new $z(this)),
      this.settings.cache_suffix &&
        (Nn.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, "")),
      (this.ui = { registry: pE() });
    var o = Qw(this);
    (this.mode = o),
      (this.setMode = o.set),
      ...
      (this.$ = vi.overrideDefaults(function () {
        return {
  ...
  function NE(e) {
    e !== BE &&
      (e
        ? vi(window).on("resize scroll", EE)
        : vi(window).off("resize scroll", EE),
      (BE = e));
  }
  function SE(t) {
    var e = HE;
    delete OE[t.id];
    for (var n = 0; n < OE.length; n++)
      if (OE[n] === t) {
        OE.splice(n, 1);
        break;
      }
    return (
      ...
      LE.activeEditor === t && (LE.activeEditor = 0 < HE.length ? HE[0] : null),
      LE.focusedEditor === t && (LE.focusedEditor = null),
      e.length !== HE.length
    );
  }
  var kE,
    ...
    OE = [],
    HE = [],
    PE = "CSS1Compat" !== j.document.compatMode,
    LE = G(G({}, tE), {
      baseURI: null,
      baseURL: null,
      defaultSettings: {},
      ...
      setup: function () {
        var e,
          t,
          n = "";
        (t = mE.getDocumentBaseUrl(j.document.location)),
          /^[^:]+:\/\/\/?[^\/]+\//.test(t) &&
            ((t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
            /[\/\\]$/.test(t) || (t += "/"));
        ...
        (this.baseURL = new mE(t).toAbsolute(e)),
          (this.documentBaseURL = t),
          (this.baseURI = new mE(this.baseURL)),
          (this.suffix = n),
          nd(this);
      },
      ...
      init: function (r) {
        ...
        function c(e) {
          ...
          return (
            t ||
              ((t = (t = e.name) && !AE.get(t) ? e.name : AE.uniqueId()),
              e.setAttribute("id", t)),
            t
          );
        }
            ...
            AE.unbind(window, "ready", e),
              ...
              (o = vi.unique(
                (function (t) {
                  var e,
                    n = [];
                  if (Nn.browser.isIE() && Nn.browser.version.major < 11)
                    return (
                      Id.initError(
                  ...
                  if (t.types)
                    return (
                      RE(t.types, function (e) {
                        n = n.concat(AE.select(e.selector));
                      }),
                      n
                    );
                  if (t.selector) return AE.select(t.selector);
                  ...
                  switch (t.mode) {
                    case "exact":
                      0 < (e = t.elements || "").length &&
                        RE(ME(e), function (t) {
                          ...
                          (e = AE.get(t))
                            ? n.push(e)
                            : RE(j.document.forms, function (e) {
                                RE(e.elements, function (e) {
                                  e.name === t &&
                                    ((t = "mce_editor_" + _E++),
                                    AE.setAttrib(e, "id", t),
                                    n.push(e));
                    ...
                    case "specific_textareas":
                      RE(AE.select("textarea"), function (e) {
              ...
              r.types
                ? RE(r.types, function (t) {
                    Mn.each(o, function (e) {
                      return (
                        !AE.is(e, t.selector) || (n(c(e), DE({}, r, t), e), !1)
                      );
                    });
                  })
                : (Mn.each(o, function (e) {
      ...
      createEditor: function (e, t) {
        return this.add(new xE(e, t, this));
      },
      remove: function (e) {
        var t,
          n,
        ...
        if (e) {
          if (!K(e))
            return (
              ...
              M(r.get(n.id))
                ? null
                : (SE(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === HE.length &&
                    window.removeEventListener("beforeunload", kE),
                  n.remove(),
                  NE(0 < HE.length),
                  n)
            );
          RE(AE.select(e), function (e) {
            (n = r.get(e.id)) && r.remove(n);
          });
        } else for (t = HE.length - 1; 0 <= t; t--) r.remove(HE[t]);
      },
      execCommand: function (e, t, n) {
        var r = this.get(n);
        switch (e) {
          case "mceAddEditor":
            return this.get(n) || new xE(n, this.settings, this).render(), !0;
      ...
      _setBaseUrl: function (e) {
        (this.baseURL = new mE(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new mE(this.baseURL));
      },
  ...
  function VE(n) {
    return {
      ...
      normalize: function (t) {
        return iy(n, t).fold($(!1), function (e) {
          return (
  ...
  LE.setup(),
    ((TE = VE = VE || {}).compareRanges = dh),
    (TE.getCaretRangeFromPoint = qv),
    (TE.getSelectedNode = Wa),
    (TE.getNode = Ka);
  function IE(e, t, n) {
    var r, o, i, a, u, s;
    return (
  ...
  var UE,
    ...
    KE =
      ...
      (jE = {}),
      {
        ...
        add: function (e, t) {
          jE[e] !== undefined && (jE[e](t), delete jE[e]),
            (UE[e] = Zt.resolve(t));
        },
      }),
    XE = Math.min,
    ...
    QE = {
      inflate: function (e, t, n) {
        return JE(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n);
      },
      relativePosition: IE,
      ...
      intersect: function (e, t) {
        ...
        return (
          (n = YE(e.x, t.x)),
          (r = YE(e.y, t.y)),
          (o = XE(e.x + e.w, t.x + t.w)),
          (i = XE(e.y + e.h, t.y + t.h)),
          o - n < 0 || i - r < 0 ? null : JE(n, r, o - n, i - r)
        );
      },
      ...
      fromClientRect: function (e) {
        return JE(e.left, e.top, e.width, e.height);
      },
    },
    ZE = Mn.each,
    eN = Mn.extend;
  FE.extend = qE = function (n) {
    function r() {
      var e, t, n;
      if (
        !$E &&
    ...
    ($E = !1),
    n.Mixins &&
      (ZE(n.Mixins, function (e) {
        for (var t in e) "init" !== t && (n[t] = e[t]);
      }),
      u.Mixins && (n.Mixins = u.Mixins.concat(n.Mixins))),
    n.Methods &&
      ZE(n.Methods.split(","), function (e) {
        n[e] = t;
      }),
    n.Properties &&
      ZE(n.Properties.split(","), function (e) {
        var t = "_" + e;
        n[e] = function (e) {
    ...
    n.Statics &&
      ZE(n.Statics, function (e, t) {
        r[t] = e;
      }),
    n.Defaults && u.Defaults && (n.Defaults = eN({}, u.Defaults, n.Defaults)),
    n))
      "function" == typeof (a = n[i]) && u[i] ? (o[i] = e(i, a)) : (o[i] = a);
    return (r.prototype = o), ((r.constructor = r).extend = qE), r;
  };
  var tN = Math.min,
    nN = Math.max,
    rN = Math.round,
    ...
    aN = G(G({}, tE), {
      send: function (e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ""),
          aN.fire("beforeInitialize", { settings: e }),
          ...
          if (
            ...
            (t = aN.fire("beforeSend", { xhr: t, settings: e }).xhr).send(
              e.data
            ),
            !e.async)
          )
    ...
    uN = Mn.extend,
    sN =
      ((cN.sendRPC = function (e) {
        return new cN().send(e);
      }),
      (cN.prototype.send = function (e) {
        var n = e.error,
          r = e.success,
          o = uN(this.settings, e);
        (o.success = function (e, t) {
          void 0 === (e = oN.parse(e)) && (e = { error: "JSON Parse error." }),
            e.error
